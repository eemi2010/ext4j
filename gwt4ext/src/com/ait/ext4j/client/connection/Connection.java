...
public class Connection extends JsObject {
    ...
    public native void abort() /*-{
		var conn = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		conn.abort();
    }-*/;
    ...
    public native double request(RequestParam param) /*-{
		var conn = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var paramJS = param.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native void addListener(ConnectionListener listener)/*-{
		...
		conn
				.addListener(
						...
						function(conn, options) {
							return listener.@com.ait.ext4j.client.connection.ConnectionListener::doBeforeRequest(Lcom/ait/ext4j/client/connection/Connection;)(connJ);
						});
		...
		conn
				.addListener(
						...
						function(conn, response, options) {
							return listener.@com.ait.ext4j.client.connection.ConnectionListener::onRequestComplete(Lcom/ait/ext4j/client/connection/Connection;Ljava/lang/String;)(connJ, response.responseText);
						});
		...
		conn
				.addListener(
						'requestexception',
						function(conn, response, options) {
							return listener.@com.ait.ext4j.client.connection.ConnectionListener::onRequestComplete(Lcom/ait/ext4j/client/connection/Connection;Ljava/lang/String;)(connJ, response.status, response.responseText);
						});
    }-*/;
}
