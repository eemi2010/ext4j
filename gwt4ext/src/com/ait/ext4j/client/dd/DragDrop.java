...
public class DragDrop extends JsObject {
    ...
    private static native void init() /*-{
		...
		$wnd.Ext.dd.DragDrop.prototype.startDrag = function(x, y) {
			var ddJ = this.ddJ;
			if (ddJ != null)
				ddJ.@com.ait.ext4j.client.dd.DragDrop::startDrag(II)(x,y);
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.endDrag = function(e) {
			...
			if (ddJ != null) {
				...
				ddJ.@com.ait.ext4j.client.dd.DragDrop::endDrag(Lcom/ait/ext4j/client/core/EventObject;)(e);
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDrag = function(e) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				ddJ.@com.ait.ext4j.client.dd.DragDrop::onDrag(Lcom/ait/ext4j/client/core/EventObject;)(e);
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragDrop = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragDrop(Lcom/ait/ext4j/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.ext4j.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragDrop(Lcom/ait/ext4j/client/core/EventObject;[Lcom/ait/ext4j/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragEnter = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragEnter(Lcom/ait/ext4j/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.ext4j.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragEnter(Lcom/ait/ext4j/client/core/EventObject;[Lcom/ait/ext4j/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragOut = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragOut(Lcom/ait/ext4j/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.ext4j.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragOut(Lcom/ait/ext4j/client/core/EventObject;[Lcom/ait/ext4j/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragOver = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragOver(Lcom/ait/ext4j/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.ext4j.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.ext4j.client.dd.DragDrop::onDragOver(Lcom/ait/ext4j/client/core/EventObject;[Lcom/ait/ext4j/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onInvalidDrop = function(e) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				ddJ.@com.ait.ext4j.client.dd.DragDrop::onInvalidDrop(Lcom/ait/ext4j/client/core/EventObject;)(e);
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onMouseDown = function(e) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				ddJ.@com.ait.ext4j.client.dd.DragDrop::onMouseDown(Lcom/ait/ext4j/client/core/EventObject;)(e);
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onMouseUp = function(e) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				ddJ.@com.ait.ext4j.client.dd.DragDrop::onMouseUp(Lcom/ait/ext4j/client/core/EventObject;)(e);
			}
		}
    }-*/;
    ...
    public native boolean isAvailable() /*-{
		var dd = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		return dd.available;
    }-*/;
    ...
    private native JavaScriptObject doGetGroups() /*-{
		...
		var group;
		var arr = @com.ait.ext4j.client.core.JsoHelper::createJavaScriptArray()();
		for (group in groups) {
			arr.push(group);
		}
		return arr;
    ...
    public native void init(String id, String sGroup, DragDropConfig config) /*-{
		var dd = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var cfg = config.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native Paddings getPadding() /*-{
		...
		return @com.ait.ext4j.client.core.Paddings::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(padding);
    }-*/;
