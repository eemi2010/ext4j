...
public class DragSource extends DDProxy {
    ...
    public native StatusProxy getProxy() /*-{
		var ds = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var proxy = ds.getProxy();
		return @com.ait.ext4j.client.dd.StatusProxy::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(proxy);
    }-*/;
