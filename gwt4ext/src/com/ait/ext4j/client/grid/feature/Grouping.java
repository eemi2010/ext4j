...
import com.ait.ext4j.client.events.grid.GroupExpandHandler;
import com.ait.ext4j.client.events.grid.GroupInteractionHandler;
...
public class Grouping extends Feature {
    ...
    public native void collapse(ExtElement group)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		jso.collapse(group.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void expand(ExtElement group)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		jso.expand(group.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void addExpandHandler(GroupExpandHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::GROUP_EXPAND,
							$entry(function(v, node, group) {
								var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
								handler.@com.ait.ext4j.client.events.grid.GroupExpandHandler::onEvent(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(view,node,group);
							}));
		}
			...
			component
					.addListener(
							...
							$entry(function(v, node, group, e) {
								...
								handler.@com.ait.ext4j.client.events.grid.GroupInteractionHandler::onEvent(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Lcom/ait/ext4j/client/core/EventObject;)(view,node,group,event);
							}));
		}
