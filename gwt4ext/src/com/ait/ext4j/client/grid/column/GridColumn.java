...
public class GridColumn extends BaseConfig {
    ...
    private native JavaScriptObject createRenderer(GridColumnRenderer renderer)/*-{
		return function(value, metaData, rec, rowIndex, colIndex, store, view) {
			...
			var cellMetaData = @com.ait.ext4j.client.grid.column.CellMetaData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(metaData);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var s = @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
			var dataView = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(view);
			return renderer.@com.ait.ext4j.client.grid.column.GridColumnRenderer::onRender(Ljava/lang/String;Lcom/ait/ext4j/client/grid/column/CellMetaData;Lcom/ait/ext4j/client/data/BaseModel;IILcom/ait/ext4j/client/data/Store;Lcom/ait/ext4j/client/ui/DataView;)(valueToProcess,cellMetaData,model,rowIndex,colIndex,s,dataView);
		};
    }-*/;
    ...
    private native JavaScriptObject createSummaryRenderer(GridColumnSummaryRenderer renderer)/*-{
		return function(value, data, field) {
			...
			return renderer.@com.ait.ext4j.client.grid.column.GridColumnSummaryRenderer::onRender(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(valueToProcess, data, field);
		};
    }-*/;
