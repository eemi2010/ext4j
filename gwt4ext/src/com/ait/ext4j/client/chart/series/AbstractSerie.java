...
import com.ait.ext4j.client.chart.HighLighter;
import com.ait.ext4j.client.chart.laf.ChartTooltip;
import com.ait.ext4j.client.chart.laf.Label;
import com.ait.ext4j.client.chart.laf.Style;
import com.ait.ext4j.client.chart.marker.MarkerConfig;
import com.ait.ext4j.client.chart.series.renderers.SeriesRenderer;
...
import com.ait.ext4j.client.ui.ToolTip;
...
public abstract class AbstractSerie extends JsObject {
    ...
    public final native void setRenderer(SeriesRenderer renderer)/*-{
		...
		jso.renderer = function(sprite, record, attr, index, store) {
			...
			var s = @com.ait.ext4j.client.draw.Sprite::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sprite);
			var st = @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
			return renderer.@com.ait.ext4j.client.chart.series.renderers.SeriesRenderer::onRender(Lcom/ait/ext4j/client/draw/Sprite;Lcom/ait/ext4j/client/data/BaseModel;Lcom/ait/ext4j/client/chart/laf/BarAttribute;ILcom/ait/ext4j/client/data/Store;)(s,model,attr, index,st);
		};
    }-*/;
