...
import com.ait.ext4j.client.connection.Connection;
import com.ait.ext4j.client.connection.UrlParam;
...
import com.ait.ext4j.client.events.form.SubmitHandler;
...
public class Form extends JsObject {
    ...
    public native void checkDirty() /*-{
		var form = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		form.checkDirty();
    }-*/;
    ...
    public native FieldBase findField(String id)/*-{
		...
		return fieldJS != null ? @com.ait.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(fieldJS)
				: null;
    }-*/;
    ...
    public native void loadRecord(BaseModel record) /*-{
		var form = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var recordJS = record.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    private native JavaScriptObject _getSubmitCallback(SubmitHandler handler)/*-{
		return {
			success : function(f, a) {
				var form = @com.ait.ext4j.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ait.ext4j.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ait.ext4j.client.events.form.SubmitHandler::onSuccess(Lcom/ait/ext4j/client/ui/Form;Lcom/ait/ext4j/client/form/Action;)(form,action);
			},
			failure : function(f, a) {
				var form = @com.ait.ext4j.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ait.ext4j.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ait.ext4j.client.events.form.SubmitHandler::onFailure(Lcom/ait/ext4j/client/ui/Form;Lcom/ait/ext4j/client/form/Action;)(form,action);
			}
		};
    }-*/;
