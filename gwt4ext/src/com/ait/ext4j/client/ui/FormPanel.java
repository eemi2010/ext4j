...
import com.ait.ext4j.client.tip.QuickTips;
...
public class FormPanel extends Panel {
    ...
    private static native void doInit()/*-{
		...
		@com.ait.ext4j.client.ui.FormPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void startMonitoring() /*-{
		var formPanel = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
     ...
     * {@link #addFormListener(com.ait.ext4j.client.ui.form.event.FormListener)}
     * instead.
     * 
    ...
    public native Form getForm() /*-{
		...
		return @com.ait.ext4j.client.ui.Form::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(formJS);
    }-*/;
     ...
     * {@link com.ait.ext4j.client.ui.MessageBox#wait(long)}. You can target a
    ...
    /**
     * By default wait messages are displayed with
     * {@link com.ait.ext4j.client.ui.MessageBox#wait(long)}. You can mask the
