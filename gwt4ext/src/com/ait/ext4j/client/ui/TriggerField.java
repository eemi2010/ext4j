...
import com.ait.ext4j.client.core.CompositeElement;
import com.ait.ext4j.client.core.EventObject;
import com.ait.ext4j.client.core.ExtElement;
import com.ait.ext4j.client.util.ClickRepeater;
...
public abstract class TriggerField extends TextField {
    ...
    private native void setup(TriggerField triggerField, JavaScriptObject jsObj) /*-{
		jsObj.onTriggerClick = function(event) {
			...
			triggerField.@com.ait.ext4j.client.ui.TriggerField::onTriggerClick(Lcom/ait/ext4j/client/core/EventObject;)(e);
		}
    }-*/;
    ...
    public native CompositeElement getTriggerEl() /*-{
		...
		return @com.ait.ext4j.client.core.CompositeElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
