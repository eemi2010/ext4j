...
import com.ait.ext4j.client.events.grid.BeforeContainerActionHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerClickHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerContextMenuHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerDoubleClickHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerKeyDownHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerMouseDownHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerMouseOutHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerMouseOverHandler;
import com.ait.ext4j.client.events.grid.BeforeContainerMouseUpHandler;
import com.ait.ext4j.client.events.grid.BeforeDeselectHandler;
import com.ait.ext4j.client.events.grid.BeforeItemActionHandler;
import com.ait.ext4j.client.events.grid.BeforeItemClickHandler;
import com.ait.ext4j.client.events.grid.BeforeItemContextMenuHandler;
import com.ait.ext4j.client.events.grid.BeforeItemDoubleClickHandler;
import com.ait.ext4j.client.events.grid.BeforeItemKeyDownHandler;
import com.ait.ext4j.client.events.grid.BeforeItemMouseDownHandler;
import com.ait.ext4j.client.events.grid.BeforeItemMouseEnterHandler;
import com.ait.ext4j.client.events.grid.BeforeItemMouseLeaveHandler;
import com.ait.ext4j.client.events.grid.BeforeItemMouseUpHandler;
import com.ait.ext4j.client.events.grid.BeforeSelectHandler;
import com.ait.ext4j.client.events.grid.BeforeSelectionHandler;
...
import com.ait.ext4j.client.events.grid.ColumnHideHandler;
import com.ait.ext4j.client.events.grid.ColumnMoveHandler;
import com.ait.ext4j.client.events.grid.ColumnResizeHandler;
import com.ait.ext4j.client.events.grid.ColumnShowHandler;
import com.ait.ext4j.client.events.grid.ColumnsChangedHandler;
import com.ait.ext4j.client.events.grid.ContainerClickHandler;
import com.ait.ext4j.client.events.grid.ContainerContextMenuHandler;
import com.ait.ext4j.client.events.grid.ContainerDoubleClickHandler;
import com.ait.ext4j.client.events.grid.ContainerKeyDownHandler;
import com.ait.ext4j.client.events.grid.ContainerMouseDownHandler;
import com.ait.ext4j.client.events.grid.ContainerMouseOutHandler;
import com.ait.ext4j.client.events.grid.ContainerMouseOverHandler;
import com.ait.ext4j.client.events.grid.ContainerMouseUpHandler;
import com.ait.ext4j.client.events.grid.DeselectHandler;
import com.ait.ext4j.client.events.grid.FilterChangeHandler;
import com.ait.ext4j.client.events.grid.GroupChangeHandler;
import com.ait.ext4j.client.events.grid.HeaderClickHandler;
import com.ait.ext4j.client.events.grid.HeaderContextMenuHandler;
import com.ait.ext4j.client.events.grid.HeaderTriggerClickHandler;
import com.ait.ext4j.client.events.grid.SelectHandler;
import com.ait.ext4j.client.events.grid.SelectionChangeHandler;
import com.ait.ext4j.client.events.grid.SortChangeHandler;
import com.ait.ext4j.client.events.grid.ViewReadyHandler;
import com.ait.ext4j.client.events.view.ItemClickHandler;
import com.ait.ext4j.client.events.view.ItemContextMenuHandler;
import com.ait.ext4j.client.events.view.ItemDoubleClickHandler;
import com.ait.ext4j.client.events.view.ItemKeyDownHandler;
import com.ait.ext4j.client.events.view.ItemMouseDownHandler;
import com.ait.ext4j.client.events.view.ItemMouseEnterHandler;
import com.ait.ext4j.client.events.view.ItemMouseLeaveHandler;
import com.ait.ext4j.client.events.view.ItemMouseUpHandler;
import com.ait.ext4j.client.grid.HeaderContainer;
import com.ait.ext4j.client.grid.VerticalScroller;
import com.ait.ext4j.client.grid.ViewConfig;
import com.ait.ext4j.client.grid.column.GridColumn;
import com.ait.ext4j.client.grid.feature.Feature;
import com.ait.ext4j.client.laf.Scroll;
...
public class TablePanel extends Panel {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.Panel::configPrototype = c.initialConfig;
    }-*/;
    ...
    private native Store _getStore()/*-{
		var grid = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var obj = grid.getStore();
		var store = @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return store;
    }-*/;
    ...
    public native SelectionModel getSelectionModel()/*-{
		...
		return @com.ait.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native TableView getView()/*-{
		...
		return @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerClickHandler(BeforeContainerClickHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerClickHandler::onBeforeContainerClick(Lcom/ait/ext4j/client/events/grid/BeforeContainerClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerContextMenuHandler(BeforeContainerContextMenuHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerContextMenuEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerContextMenuHandler::onBeforeContainerContextMenu(Lcom/ait/ext4j/client/events/grid/BeforeContainerContextMenuEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerDoubleClickHandler(BeforeContainerDoubleClickHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerDoubleClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerDoubleClickHandler::onBeforeContainerDoubleClick(Lcom/ait/ext4j/client/events/grid/BeforeContainerDoubleClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerKeyDownHandler(BeforeContainerKeyDownHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerKeyDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerKeyDownHandler::onBeforeContainerKeyDown(Lcom/ait/ext4j/client/events/grid/BeforeContainerKeyDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerMouseDownHandler(BeforeContainerMouseDownHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerMouseDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerMouseDownHandler::onBeforeContainerMouseDown(Lcom/ait/ext4j/client/events/grid/BeforeContainerMouseDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerMouseOutHandler(BeforeContainerMouseOutHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerMouseOutEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerMouseOutHandler::onBeforeContainerMouseOut(Lcom/ait/ext4j/client/events/grid/BeforeContainerMouseOutEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerMouseOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerMouseOverHandler(BeforeContainerMouseOverHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerMouseOverEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerMouseOverHandler::onBeforeContainerMouseOver(Lcom/ait/ext4j/client/events/grid/BeforeContainerMouseOverEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerMouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeContainerMouseUpHandler(BeforeContainerMouseUpHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.BeforeContainerMouseUpEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.BeforeContainerMouseUpHandler::onBeforeContainerMouseUp(Lcom/ait/ext4j/client/events/grid/BeforeContainerMouseUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeContainerMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeDeselectHandler(BeforeDeselectHandler handler)/*-{
		...
		var fn = function(sm, rec, index, e) {
			var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeDeselectEvent::new(Lcom/ait/ext4j/client/selection/RowSelectionModel;Lcom/ait/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(rowModel, model, index, e);
			handler.@com.ait.ext4j.client.events.grid.BeforeDeselectHandler::onBeforeDeselect(Lcom/ait/ext4j/client/events/grid/BeforeDeselectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeDeselectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemClickHandler(BeforeItemClickHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemClickHandler::onBeforeItemClick(Lcom/ait/ext4j/client/events/grid/BeforeItemClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemContextMenuHandler(BeforeItemContextMenuHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemContextMenuEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemContextMenuHandler::onBeforeItemContextMenu(Lcom/ait/ext4j/client/events/grid/BeforeItemContextMenuEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemDoubleClickHandler(BeforeItemDoubleClickHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemDoubleClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemDoubleClickHandler::onBeforeItemDoubleClick(Lcom/ait/ext4j/client/events/grid/BeforeItemDoubleClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemKeyDownHandler(BeforeItemKeyDownHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemKeyDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemKeyDownHandler::onBeforeItemKeyDown(Lcom/ait/ext4j/client/events/grid/BeforeItemKeyDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemMouseDownHandler(BeforeItemMouseDownHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemMouseDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemMouseDownHandler::onBeforeItemMouseDown(Lcom/ait/ext4j/client/events/grid/BeforeItemMouseDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemMouseEnterHandler(BeforeItemMouseEnterHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemMouseEnterEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemMouseEnterHandler::onBeforeItemMouseEnter(Lcom/ait/ext4j/client/events/grid/BeforeItemMouseEnterEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemMouseEnterEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemMouseLeaveHandler(BeforeItemMouseLeaveHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemMouseLeaveEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemMouseLeaveHandler::onBeforeItemMouseLeave(Lcom/ait/ext4j/client/events/grid/BeforeItemMouseLeaveEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemMouseLeaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeItemMouseUpHandler(BeforeItemMouseUpHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeItemMouseUpEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.grid.BeforeItemMouseUpHandler::onBeforeItemMouseUp(Lcom/ait/ext4j/client/events/grid/BeforeItemMouseUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeItemMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeSelectHandler(BeforeSelectHandler handler)/*-{
		...
		var fn = function(sm, rec, index, e) {
			var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.BeforeSelectEvent::new(Lcom/ait/ext4j/client/selection/RowSelectionModel;Lcom/ait/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(rowModel, model, index, e);
			handler.@com.ait.ext4j.client.events.grid.BeforeSelectHandler::onBeforeSelect(Lcom/ait/ext4j/client/events/grid/BeforeSelectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.BeforeSelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnHideHandler(ColumnHideHandler handler)/*-{
		...
		var fn = function(ct, c, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.grid.ColumnHideEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,e);
			handler.@com.ait.ext4j.client.events.grid.ColumnHideHandler::onColumnHide(Lcom/ait/ext4j/client/events/grid/ColumnHideEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ColumnHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnMoveHandler(ColumnMoveHandler handler)/*-{
		...
		var fn = function(ct, c, fromIndex, toIndex, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.grid.ColumnMoveEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;IILcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,fromIndex, toIndex,e);
			handler.@com.ait.ext4j.client.events.grid.ColumnMoveHandler::onColumnMove(Lcom/ait/ext4j/client/events/grid/ColumnMoveEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ColumnMoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnResizeHandler(ColumnResizeHandler handler)/*-{
		...
		var fn = function(ct, c, width, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.grid.ColumnResizeEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;DLcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,width,e);
			handler.@com.ait.ext4j.client.events.grid.ColumnResizeHandler::onColumnResize(Lcom/ait/ext4j/client/events/grid/ColumnResizeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ColumnResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnsChangedHandler(ColumnsChangedHandler handler)/*-{
		...
		var fn = function(ct, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var event = @com.ait.ext4j.client.events.grid.ColumnsChangedEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,e);
			handler.@com.ait.ext4j.client.events.grid.ColumnsChangedHandler::onColumnsChanged(Lcom/ait/ext4j/client/events/grid/ColumnsChangedEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ColumnsChangedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnShowHandler(ColumnShowHandler handler)/*-{
		...
		var fn = function(ct, c, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.grid.ColumnShowEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,e);
			handler.@com.ait.ext4j.client.events.grid.ColumnShowHandler::onColumnShow(Lcom/ait/ext4j/client/events/grid/ColumnShowEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ColumnShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerClickHandler(ContainerClickHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerClickHandler::onContainerClick(Lcom/ait/ext4j/client/events/grid/ContainerClickEvent;)(event);

		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerContextMenuHandler(ContainerContextMenuHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerContextMenuEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerContextMenuHandler::onContainerContextMenu(Lcom/ait/ext4j/client/events/grid/ContainerContextMenuEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerDoubleClickHandler(ContainerDoubleClickHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerDoubleClickEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerDoubleClickHandler::onContainerDoubleClick(Lcom/ait/ext4j/client/events/grid/ContainerDoubleClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerKeyDownHandler(ContainerKeyDownHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerKeyDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerKeyDownHandler::onContainerKeyDown(Lcom/ait/ext4j/client/events/grid/ContainerKeyDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerMouseDownHandler(ContainerMouseDownHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerMouseDownEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerMouseDownHandler::onContainerMouseDown(Lcom/ait/ext4j/client/events/grid/ContainerMouseDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerMouseOutHandler(ContainerMouseOutHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerMouseOutEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerMouseOutHandler::onContainerMouseOut(Lcom/ait/ext4j/client/events/grid/ContainerMouseOutEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerMouseOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerMouseOverHandler(ContainerMouseOverHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerMouseOverEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerMouseOverHandler::onContainerMouseOver(Lcom/ait/ext4j/client/events/grid/ContainerMouseOverEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerMouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addContainerMouseUpHandler(ContainerMouseUpHandler handler)/*-{
		...
		var fn = function(v, e) {
			var view = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var event = @com.ait.ext4j.client.events.grid.ContainerMouseUpEvent::new(Lcom/ait/ext4j/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;)(view,e)
			handler.@com.ait.ext4j.client.events.grid.ContainerMouseUpHandler::onContainerMouseUp(Lcom/ait/ext4j/client/events/grid/ContainerMouseUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ContainerMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDeselectHandler(DeselectHandler handler)/*-{
		...
		var fn = function(sm, rec, index, e) {
			var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.DeselectEvent::new(Lcom/ait/ext4j/client/selection/RowSelectionModel;Lcom/ait/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(rowModel, model, index, e);
			handler.@com.ait.ext4j.client.events.grid.DeselectHandler::onDeselect(Lcom/ait/ext4j/client/events/grid/DeselectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.DeselectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addFilterChangeHandler(FilterChangeHandler handler)/*-{
		...
		var fn = function(st, f, e) {
			var store = @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var filters = @com.ait.ext4j.client.util.Filter::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.grid.FilterChangeEvent::new(Lcom/ait/ext4j/client/data/Store;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(store,filters,e);
			handler.@com.ait.ext4j.client.events.grid.FilterChangeHandler::onFilterChange(Lcom/ait/ext4j/client/events/grid/FilterChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.FilterChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addGroupChangeHandler(GroupChangeHandler handler)/*-{
		...
		var fn = function(st, f, e) {
			var store = @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var groupers = @com.ait.ext4j.client.util.Grouper::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.grid.GroupChangeEvent::new(Lcom/ait/ext4j/client/data/Store;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(store,filters,e);
			handler.@com.ait.ext4j.client.events.grid.GroupChangeHandler::onGroupChange(Lcom/ait/ext4j/client/events/grid/GroupChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.GroupChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(sm, rec, index, e) {
			var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.SelectEvent::new(Lcom/ait/ext4j/client/selection/RowSelectionModel;Lcom/ait/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(rowModel, model, index, e);
			handler.@com.ait.ext4j.client.events.grid.SelectHandler::onSelect(Lcom/ait/ext4j/client/events/grid/SelectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.SelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSelectionChangeHandler(SelectionChangeHandler handler)/*-{
		...
		var fn = function(sm, rec, e) {
			var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var model = @com.ait.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.grid.SelectionChangeEvent::new(Lcom/ait/ext4j/client/selection/RowSelectionModel;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(rowModel,model,e);
			handler.@com.ait.ext4j.client.events.grid.SelectionChangeHandler::onSelectionChange(Lcom/ait/ext4j/client/events/grid/SelectionChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.SelectionChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHeaderClickHandler(HeaderClickHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ait.ext4j.client.events.grid.HeaderClickEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ait.ext4j.client.events.grid.HeaderClickHandler::onHeaderClick(Lcom/ait/ext4j/client/events/grid/HeaderClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.HeaderClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHeaderContextMenuHandler(HeaderContextMenuHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ait.ext4j.client.events.grid.HeaderContextMenuEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ait.ext4j.client.events.grid.HeaderContextMenuHandler::onHeaderContextMenu(Lcom/ait/ext4j/client/events/grid/HeaderContextMenuEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.HeaderContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHeaderTriggerClickHandler(HeaderTriggerClickHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ait.ext4j.client.events.grid.HeaderTriggerClickEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ait.ext4j.client.events.grid.HeaderTriggerClickHandler::onHeaderTriggerClick(Lcom/ait/ext4j/client/events/grid/HeaderTriggerClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.HeaderTriggerClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemClickHandler(ItemClickHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemClickEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemClickHandler::onItemClick(Lcom/ait/ext4j/client/events/view/ItemClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemContextMenuHandler(ItemContextMenuHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemContextMenuEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemContextMenuHandler::onItemContextMenu(Lcom/ait/ext4j/client/events/view/ItemContextMenuEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemDoubleClickHandler(ItemDoubleClickHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemDoubleClickEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemDoubleClickHandler::onItemDoubleClick(Lcom/ait/ext4j/client/events/view/ItemDoubleClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemKeyDownHandler(ItemKeyDownHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemKeyDownEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemKeyDownHandler::onItemKeyDown(Lcom/ait/ext4j/client/events/view/ItemKeyDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemMouseDownHandler(ItemMouseDownHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemMouseDownEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemMouseDownHandler::onItemMouseDown(Lcom/ait/ext4j/client/events/view/ItemMouseDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemMouseEnterHandler(ItemMouseEnterHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemMouseEnterEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemMouseEnterHandler::onItemMouseEnter(Lcom/ait/ext4j/client/events/view/ItemMouseEnterEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemMouseEnterEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemMouseLeaveHandler(ItemMouseLeaveHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemMouseLeaveEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemMouseLeaveHandler::onItemMouseLeave(Lcom/ait/ext4j/client/events/view/ItemMouseLeaveEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemMouseLeaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemMouseUpHandler(ItemMouseUpHandler handler)/*-{
		...
		var fn = function(v, rec, item, index, e) {
			var view = @com.ait.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ait.ext4j.client.events.view.ItemMouseUpEvent::new(Lcom/ait/ext4j/client/ui/TableView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(view,model,item,index,e);
			handler.@com.ait.ext4j.client.events.view.ItemMouseUpHandler::onItemMouseUp(Lcom/ait/ext4j/client/events/view/ItemMouseUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.view.ItemMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSortChangeHandler(SortChangeHandler handler)/*-{
		...
		var fn = function(ct, c, direction, e) {
			var headerCt = @com.ait.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ait.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.grid.SortChangeEvent::new(Lcom/ait/ext4j/client/grid/HeaderContainer;Lcom/ait/ext4j/client/grid/column/GridColumn;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,direction,e);
			handler.@com.ait.ext4j.client.events.grid.SortChangeHandler::onSortChange(Lcom/ait/ext4j/client/events/grid/SortChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.SortChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addViewReadyHandler(ViewReadyHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.TablePanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.grid.ViewReadyEvent::new(Lcom/ait/ext4j/client/ui/TablePanel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.grid.ViewReadyHandler::onViewReady(Lcom/ait/ext4j/client/events/grid/ViewReadyEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.grid.ViewReadyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    private native void _addBeforeContainerActionHandlerHandler(String event, BeforeContainerActionHandler handler)/*-{
		...
		component
				.addListener(
						event,
						$entry(function(v, e) {
							var cmp = @com.ait.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
							var event = @com.ait.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.ait.ext4j.client.events.grid.BeforeContainerActionHandler::onAction(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/core/EventObject;)(cmp,event);
						}));
    }-*/;
		...
		component
				.addListener(
						...
						$entry(function(rm, rec, index) {
							var rowModel = @com.ait.ext4j.client.selection.RowSelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rm);
							var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
							return handler.@com.ait.ext4j.client.events.grid.BeforeSelectionHandler::onAction(Lcom/ait/ext4j/client/selection/RowSelectionModel;Lcom/ait/ext4j/client/data/BaseModel;I)(rowModel,record,index);
						}));
    }-*/;
		...
		component
				.addListener(
						...
						$entry(function(v, rec, item, index, e) {
							...
							var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
							var event = @com.ait.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.ait.ext4j.client.events.grid.BeforeItemActionHandler::onAction(Lcom/ait/ext4j/client/ui/DataView;Lcom/ait/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/ait/ext4j/client/core/EventObject;)(cmp,model,item,index, event);
						}));
    }-*/;
