...
import com.ait.ext4j.client.events.tab.BeforeTabChangeHandler;
import com.ait.ext4j.client.events.tab.TabPanelBeforeTabChangeHandler;
import com.ait.ext4j.client.tab.TabBar;
...
public class TabPanel extends Panel {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.TabPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native TabBar getTabBar() /*-{
		var tabPanel = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var tab = tabPanel.getTabBar();
		if (!tab) {
			return null;
		}
		return @com.ait.ext4j.client.tab.TabBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tab);
    ...
    public native HandlerRegistration addTabChangeHandler(com.ait.ext4j.client.events.tab.TabChangeHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(tp, oc, nc, e) {
			var panel = @com.ait.ext4j.client.ui.TabPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tp);
			var oldCard = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oc);
			var newCard = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(nc);
			var event = @com.ait.ext4j.client.events.tab.TabChangeEvent::new(Lcom/ait/ext4j/client/ui/TabPanel;Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,oldCard,newCard,e);
			handler.@com.ait.ext4j.client.events.tab.TabChangeHandler::onTabChange(Lcom/ait/ext4j/client/events/tab/TabChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.tab.TabChangeEvent::EVENT_NAME;
    ...
    public native void addBeforeTabChangeHandler(TabPanelBeforeTabChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::TAB_CHANGE,
							$entry(function(p, newCard, oldCard) {
								var oldComp = null;
								var tabPanel = @com.ait.ext4j.client.ui.TabPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								var newComp = @com.ait.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(newCard);
								if (oldCard) {
									oldComp = @com.ait.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(oldCard);
								}
								return handler.@com.ait.ext4j.client.events.tab.TabPanelBeforeTabChangeHandler::onEvent(Lcom/ait/ext4j/client/ui/TabPanel;Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/core/Component;)(tabPanel,newComp,oldComp);
							}));
		}
    ...
    public native HandlerRegistration addBeforeTabChangeHandler(BeforeTabChangeHandler handler)/*-{
		...
		var fn = function(tp, oc, nc, e) {
			...
			var oldCard = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oc);
			var newCard = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(nc);
			var event = @com.ait.ext4j.client.events.tab.BeforeTabChangeEvent::new(Lcom/ait/ext4j/client/ui/TabPanel;Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,oldCard,newCard,e);
			handler.@com.ait.ext4j.client.events.tab.BeforeTabChangeHandler::onBeforeTabChange(Lcom/ait/ext4j/client/events/tab/BeforeTabChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.tab.BeforeTabChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
