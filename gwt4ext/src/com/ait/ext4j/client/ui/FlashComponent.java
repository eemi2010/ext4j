...
import com.ait.ext4j.client.events.flash.FailureHandler;
import com.ait.ext4j.client.events.flash.SuccessHandler;
...
public class FlashComponent extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.FlashComponent::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addFailureHandler(FailureHandler handler)/*-{
		...
		var fn = function(cmp, e) {
			var component = @com.ait.ext4j.client.ui.FlashComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.flash.FailureEvent::new(Lcom/ait/ext4j/client/ui/FlashComponent;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.ext4j.client.events.flash.FailureHandler::onFailure(Lcom/ait/ext4j/client/events/flash/FailureEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.flash.FailureEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addSuccessHandler(SuccessHandler handler)/*-{
		...
		var fn = function(cmp, e) {
			var component = @com.ait.ext4j.client.ui.FlashComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.flash.SuccessEvent::new(Lcom/ait/ext4j/client/ui/FlashComponent;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.ext4j.client.events.flash.SuccessHandler::onSuccess(Lcom/ait/ext4j/client/events/flash/SuccessEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.flash.SuccessEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
