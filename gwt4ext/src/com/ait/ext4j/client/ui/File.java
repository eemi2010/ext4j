...
public class File extends TriggerField {
    ...
    private static native void init()/*-{
		...
		@com.ait.ext4j.client.ui.File::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native ExtElement getFileInputEl() /*-{
		...
		return @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
    }-*/;
    ...
    public native Button getButton() /*-{
		var field = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var el = field.button;
		return @com.ait.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
    }-*/;
    ...
    public native HandlerRegistration addFileChangeHandler(
                    com.ait.ext4j.client.events.form.FileChangeHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(f, value, e) {
			var file = @com.ait.ext4j.client.ui.File::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ait.ext4j.client.events.form.FileChangeEvent::new(Lcom/ait/ext4j/client/ui/File;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(file,value,e);
			handler.@com.ait.ext4j.client.events.form.FileChangeHandler::onFileChange(Lcom/ait/ext4j/client/events/form/FileChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.FileChangeEvent::EVENT_NAME;
