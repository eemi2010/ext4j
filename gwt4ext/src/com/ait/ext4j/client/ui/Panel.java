...
import com.ait.ext4j.client.core.Margins;
import com.ait.ext4j.client.core.Paddings;
import com.ait.ext4j.client.core.config.Direction;
...
import com.ait.ext4j.client.events.panel.BeforeCloseHandler;
import com.ait.ext4j.client.events.panel.BeforeCollapseHandler;
import com.ait.ext4j.client.events.panel.BeforeExpandHandler;
import com.ait.ext4j.client.events.panel.CollapseHandler;
import com.ait.ext4j.client.events.panel.FloatHandler;
import com.ait.ext4j.client.events.panel.IconChangeHandler;
import com.ait.ext4j.client.events.panel.IconClsChangeHandler;
import com.ait.ext4j.client.events.panel.PanelBeforeCloseHandler;
import com.ait.ext4j.client.events.panel.PanelBeforeCollapseHandler;
import com.ait.ext4j.client.events.panel.PanelBeforeExpandHandler;
import com.ait.ext4j.client.events.panel.TitleChangeHandler;
import com.ait.ext4j.client.events.panel.UnFloatHandler;
import com.ait.ext4j.client.fx.Fx;
...
public class Panel extends Container {
    ...
    private native void setDestroy()/*-{
	    this.@com.ait.ext4j.client.core.Component::addListener(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)('beforedestroy',
		    function() {
    			if (this.header) {
    ...
    private native void addButtonPreCreate(JavaScriptObject componentJS) /*-{
		...
		if (!config.buttons) {
			config.buttons = @com.ait.ext4j.client.core.JsoHelper::createJavaScriptArray()();
		}
    ...
    public native PanelHeader getHeader() /*-{
		...
		return el == null || el === undefined ? null
				: @com.ait.ext4j.client.ui.PanelHeader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
    }-*/;
    ...
    public native void addBeforeCloseHandler(PanelBeforeCloseHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::BEFORE_CLOSE,
							$entry(function(p) {
								var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								return handler.@com.ait.ext4j.client.events.panel.PanelBeforeCloseHandler::onEvent(Lcom/ait/ext4j/client/ui/Panel;)(panel);
							}));
		}
    ...
    public native HandlerRegistration addBeforeCloseHandler(BeforeCloseHandler handler)/*-{
		...
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.BeforeCloseEvent::new(Lcom/ait/ext4j/client/ui/Panel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.BeforeCloseHandler::onBeforeClose(Lcom/ait/ext4j/client/events/panel/BeforeCloseEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.BeforeCloseEvent::EVENT_NAME;
    ...
    public native void addBeforeCollapseHandler(PanelBeforeCollapseHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::BEFORE_COLLAPSE,
							$entry(function(p, direction, animate) {
								var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								return handler.@com.ait.ext4j.client.events.panel.PanelBeforeCollapseHandler::onEvent(Lcom/ait/ext4j/client/ui/Panel;Ljava/lang/String;Z)(panel,direction, animate);
							}));
		}
    ...
    public native HandlerRegistration addBeforeCollapseHandler(BeforeCollapseHandler handler)/*-{
		...
		var fn = function(p, direction, animate, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.BeforeCollapseEvent::new(Lcom/ait/ext4j/client/ui/Panel;Ljava/lang/String;ZLcom/google/gwt/core/client/JavaScriptObject;)(panel,direction,animate,e);
			handler.@com.ait.ext4j.client.events.panel.BeforeCollapseHandler::onBeforeCollapse(Lcom/ait/ext4j/client/events/panel/BeforeCollapseEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.BeforeCollapseEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeExpandHandler(PanelBeforeExpandHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::BEFORE_EXPAND,
							$entry(function(p, animate) {
								var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								return handler.@com.ait.ext4j.client.events.panel.PanelBeforeExpandHandler::onEvent(Lcom/ait/ext4j/client/ui/Panel;Z)(panel,animate);
							}));
		}
    ...
    public native HandlerRegistration addBeforeExpandHandler(BeforeExpandHandler handler)/*-{
		...
		var fn = function(p, animate, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.BeforeExpandEvent::new(Lcom/ait/ext4j/client/ui/Panel;ZLcom/google/gwt/core/client/JavaScriptObject;)(panel,animate,e);
			handler.@com.ait.ext4j.client.events.panel.BeforeExpandHandler::onBeforeExpand(Lcom/ait/ext4j/client/events/panel/BeforeExpandEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.BeforeExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCloseHandler(com.ait.ext4j.client.events.panel.CloseHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.CloseEvent::new(Lcom/ait/ext4j/client/ui/Panel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.CloseHandler::onClose(Lcom/ait/ext4j/client/events/panel/CloseEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.CloseEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCollapseHandler(CollapseHandler handler)/*-{
		...
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.CollapseEvent::new(Lcom/ait/ext4j/client/ui/Panel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.CollapseHandler::onCollapse(Lcom/ait/ext4j/client/events/panel/CollapseEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.CollapseEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
     ...
     *            , the handler that will handle the event
     */
    public native HandlerRegistration addExpandHandler(com.ait.ext4j.client.events.panel.ExpandHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.ExpandEvent::new(Lcom/ait/ext4j/client/ui/Panel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.ExpandHandler::onExpand(Lcom/ait/ext4j/client/events/panel/ExpandEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.ExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addFloatHandler(FloatHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(e) {
			var event = @com.ait.ext4j.client.events.panel.FloatEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			handler.@com.ait.ext4j.client.events.panel.FloatHandler::onFloat(Lcom/ait/ext4j/client/events/panel/FloatEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.FloatEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addIconChangeHandler(IconChangeHandler handler)/*-{
		...
		var fn = function(p, newIcon, oldIcon, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.IconChangeEvent::new(Lcom/ait/ext4j/client/ui/Panel;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(panel, newIcon, oldIcon, e);
			handler.@com.ait.ext4j.client.events.panel.IconChangeHandler::onIconChange(Lcom/ait/ext4j/client/events/panel/IconChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.IconChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addIconClsChangeHandler(IconClsChangeHandler handler)/*-{
		...
		var fn = function(p, newIconCls, oldIconCls, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.IconClsChangeEvent::new(Lcom/ait/ext4j/client/ui/Panel;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(panel, newIconCls, oldIconCls, e);
			handler.@com.ait.ext4j.client.events.panel.IconClsChangeHandler::onIconClsChange(Lcom/ait/ext4j/client/events/panel/IconClsChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.IconClsChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addTitleChangeHandler(TitleChangeHandler handler)/*-{
		...
		var fn = function(p, newTitle, oldTitle, e) {
			var panel = @com.ait.ext4j.client.ui.Panel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.TitleChangeEvent::new(Lcom/ait/ext4j/client/ui/Panel;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(panel, newTitle, oldTitle,e);
			handler.@com.ait.ext4j.client.events.panel.TitleChangeHandler::onTitleChange(Lcom/ait/ext4j/client/events/panel/TitleChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.TitleChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addUnFloatHandler(UnFloatHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(e) {
			var event = @com.ait.ext4j.client.events.panel.UnFloatEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			handler.@com.ait.ext4j.client.events.panel.UnFloatHandler::onUnFloat(Lcom/ait/ext4j/client/events/panel/UnFloatEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.UnFloatEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
