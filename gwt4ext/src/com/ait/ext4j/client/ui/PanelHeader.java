...
import com.ait.ext4j.client.events.panel.HeaderClickHandler;
import com.ait.ext4j.client.events.panel.HeaderDoubleClickHandler;
...
public class PanelHeader extends Container {
    ...
    public native void addTool(Tool value)/*-{
		...
		component
				.addTool(value.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()());
    ...
    public native List<Tool> getTools()/*-{
		...
		return @com.ait.ext4j.client.ui.Tool::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addHeaderClickHandler(HeaderClickHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.PanelHeader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.HeaderClickEvent::new(Lcom/ait/ext4j/client/ui/PanelHeader;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.HeaderClickHandler::onHeaderClick(Lcom/ait/ext4j/client/events/panel/HeaderClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.HeaderClickEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addHeaderDoubleClickHandler(HeaderDoubleClickHandler handler)/*-{
		...
		var fn = function(p, e) {
			var panel = @com.ait.ext4j.client.ui.PanelHeader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.HeaderDoubleClickEvent::new(Lcom/ait/ext4j/client/ui/PanelHeader;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ait.ext4j.client.events.panel.HeaderDoubleClickHandler::onHeaderDoubleClick(Lcom/ait/ext4j/client/events/panel/HeaderDoubleClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.HeaderDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
