...
public class RadioGroup extends CheckboxGroup {
    ...
    private static native void doInit()/*-{
		...
		@com.ait.ext4j.client.ui.RadioGroup::configPrototype = c.initialConfig;
    }-*/;
    ...
    public RadioGroup(JavaScriptObject obj) {
        super(obj);
    }
    ...
    public static RadioGroup cast(Component component) {
        return new RadioGroup(component.getOrCreateJsObj());
    }
