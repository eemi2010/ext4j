...
import com.ait.ext4j.client.events.menu.BeforeCheckChangeHandler;
import com.ait.ext4j.client.events.menu.BeforeItemCheckChangeHandler;
import com.ait.ext4j.client.events.menu.CheckChangeHandler;
...
public class MenuCheckItem extends MenuItem {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.MenuCheckItem::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void addBeforeCheckChangeHandler(BeforeItemCheckChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::BEFORE_CHECK_CHANGE,
							$entry(function(m, checked) {
								var menu = @com.ait.ext4j.client.ui.MenuCheckItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
								return handler.@com.ait.ext4j.client.events.menu.BeforeItemCheckChangeHandler::onEvent(Lcom/ait/ext4j/client/ui/MenuCheckItem;Z)(menu, checked);
							}));
		}
    ...
    public native HandlerRegistration addBeforeCheckChangeHandler(BeforeCheckChangeHandler handler)/*-{
		...
		var fn = function(m, checked, e) {
			var menu = @com.ait.ext4j.client.ui.MenuCheckItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.ext4j.client.events.menu.BeforeCheckChangeEvent::new(Lcom/ait/ext4j/client/ui/MenuCheckItem;ZLcom/google/gwt/core/client/JavaScriptObject;)(menu,checked,e);
			handler.@com.ait.ext4j.client.events.menu.BeforeCheckChangeHandler::onBeforeCheckChange(Lcom/ait/ext4j/client/events/menu/BeforeCheckChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.menu.BeforeCheckChangeEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addCheckChangeHandler(CheckChangeHandler handler)/*-{
		...
		var fn = function(m, checked, e) {
			var menu = @com.ait.ext4j.client.ui.MenuCheckItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.ext4j.client.events.menu.CheckChangeEvent::new(Lcom/ait/ext4j/client/ui/MenuCheckItem;ZLcom/google/gwt/core/client/JavaScriptObject;)(menu,checked,e);
			handler.@com.ait.ext4j.client.events.menu.CheckChangeHandler::onCheckChange(Lcom/ait/ext4j/client/events/menu/CheckChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.menu.CheckChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
