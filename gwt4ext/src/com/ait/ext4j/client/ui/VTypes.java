 ...
 * extended.
 * 
 * @see com.ait.ext4j.client.ui.TextField#setVtype(VTypes)
 */
public class VTypes {
    ...
    public static native void setAlphaMask(RegExp alphaMask)/*-{
		var re = alphaMask.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public static native void setAlphanumMask(RegExp alphanumMask)/*-{
		var re = alphanumMask.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public static native void setEmailMask(RegExp emailMask)/*-{
		var re = emailMask.@com.ait.ext4j.client.core.JsObject::getJsObj()();
