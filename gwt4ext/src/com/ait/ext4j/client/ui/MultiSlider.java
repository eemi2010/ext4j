...
import com.ait.ext4j.client.events.slider.BeforeChangeHandler;
import com.ait.ext4j.client.events.slider.ChangeCompleteHandler;
import com.ait.ext4j.client.events.slider.ChangeHandler;
import com.ait.ext4j.client.events.slider.DragEndHandler;
import com.ait.ext4j.client.events.slider.DragStartHandler;
import com.ait.ext4j.client.events.slider.SliderBeforeChangeHandler;
import com.ait.ext4j.client.field.FieldBase;
import com.ait.ext4j.client.slider.SliderTip;
import com.ait.ext4j.client.slider.Thumb;
import com.ait.ext4j.client.slider.TipTextRenderer;
...
public class MultiSlider extends FieldBase {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.MultiSlider::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addDragStartHandler(DragStartHandler handler)/*-{
		...
		var fn = function(slider, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.ext4j.client.events.slider.DragStartEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.ext4j.client.events.slider.DragStartHandler::onDragStart(Lcom/ait/ext4j/client/events/slider/DragStartEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.DragStartEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addDragEndHandler(DragEndHandler handler)/*-{
		...
		var fn = function(slider, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.ext4j.client.events.slider.DragEndEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.ext4j.client.events.slider.DragEndHandler::onDragEnd(Lcom/ait/ext4j/client/events/slider/DragEndEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.DragEndEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDragHandler(com.ait.ext4j.client.events.slider.DragHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(slider, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.ext4j.client.events.slider.DragEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.ext4j.client.events.slider.DragHandler::onDrag(Lcom/ait/ext4j/client/events/slider/DragEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.DragEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(slider, newValue, t, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var thumb = @com.ait.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.ext4j.client.events.slider.ChangeEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;DLcom/ait/ext4j/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ait.ext4j.client.events.slider.ChangeHandler::onChange(Lcom/ait/ext4j/client/events/slider/ChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeCompleteHandler handler)/*-{
		...
		var fn = function(slider, newValue, t, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var thumb = @com.ait.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.ext4j.client.events.slider.ChangeCompleteEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;DLcom/ait/ext4j/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ait.ext4j.client.events.slider.ChangeCompleteHandler::onChangeComplete(Lcom/ait/ext4j/client/events/slider/ChangeCompleteEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.ChangeCompleteEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
			...
			component
					.addListener(
							...
							$entry(function(m, newValue, oldValue) {
								var mutil = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
								return handler.@com.ait.ext4j.client.events.slider.SliderBeforeChangeHandler::onEvent(Lcom/ait/ext4j/client/ui/MultiSlider;DD)(multi, oldValue, newValue);
							}));
		}
    ...
    public native HandlerRegistration addBeforeChangeHandler(BeforeChangeHandler handler)/*-{
		...
		var fn = function(slider, oldValue, newValue, e) {
			var component = @com.ait.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.ext4j.client.events.slider.BeforeChangeEvent::new(Lcom/ait/ext4j/client/ui/MultiSlider;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,oldValue,newValue,e);
			handler.@com.ait.ext4j.client.events.slider.BeforeChangeHandler::onBeforeChange(Lcom/ait/ext4j/client/events/slider/BeforeChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.slider.BeforeChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    private native JavaScriptObject _getTipText(TipTextRenderer renderer)/*-{
		return function(t) {
			var thumb = @com.ait.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			return renderer.@com.ait.ext4j.client.slider.TipTextRenderer::getValue(Lcom/ait/ext4j/client/slider/Thumb;)(thumb);
		};
    }-*/;
