...
import com.ait.ext4j.client.events.datepicker.SelectHandler;
...
/**
 * This class is used by the com.ait.ext4j.client.form.field.Date field to
...
public class DatePicker extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.DatePicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native DatePicker showNextYear() /*-{
		var datePicker = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(cmp, date, e) {
			var datePicker = @com.ait.ext4j.client.ui.DatePicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.datepicker.SelectEvent::new(Lcom/ait/ext4j/client/ui/DatePicker;Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JavaScriptObject;)(datePicker, date, e);
			handler.@com.ait.ext4j.client.events.datepicker.SelectHandler::onSelect(Lcom/ait/ext4j/client/events/datepicker/SelectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.datepicker.SelectEvent::EVENT_NAME;
