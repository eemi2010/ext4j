...
import com.ait.ext4j.client.core.RegExp;
import com.ait.ext4j.client.events.form.KeyDownHandler;
import com.ait.ext4j.client.events.form.KeyPressHandler;
import com.ait.ext4j.client.events.form.KeyUpHandler;
...
public class TextField extends FieldBase implements HasValue<String>, IsEditor<LeafValueEditor<String>> {
    ...
    private static native void init()/*-{
		...
		@com.ait.ext4j.client.ui.TextField::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void insertAtCaret(String text) /*-{
		...
		if (start != null) {
			...
			this.@com.ait.ext4j.client.ui.TextField::setCaretPosition(II)(textend,textend);
		} else {
			el.value += text;
		}
    }-*/;
     ...
     */
    public native HandlerRegistration addAutoSizeHandler(com.ait.ext4j.client.events.form.AutoSizeHandler handler)/*-{
		...
		var fn = function(t, width, e) {
			...
			var event = @com.ait.ext4j.client.events.form.AutoSizeEvent::new(Lcom/ait/ext4j/client/ui/TextField;DLcom/google/gwt/core/client/JavaScriptObject;)(tf,width,e);
			handler.@com.ait.ext4j.client.events.form.AutoSizeHandler::onAutoSize(Lcom/ait/ext4j/client/events/form/AutoSizeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.AutoSizeEvent::EVENT_NAME;
    ...
    public native HandlerRegistration AddKeyUpHandler(KeyUpHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tf = @com.ait.ext4j.client.ui.TextField::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.ext4j.client.events.form.KeyUpEvent::new(Lcom/ait/ext4j/client/ui/TextField;Lcom/google/gwt/core/client/JavaScriptObject;)(tf,e);
			handler.@com.ait.ext4j.client.events.form.KeyUpHandler::onKeyUp(Lcom/ait/ext4j/client/events/form/KeyUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.KeyUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
