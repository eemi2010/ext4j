...
import com.ait.ext4j.client.events.form.SpinDownHandler;
import com.ait.ext4j.client.events.form.SpinHandler;
import com.ait.ext4j.client.events.form.SpinUpHandler;
...
public class Spinner extends TriggerField {
    ...
    private static native void init()/*-{
		...
		@com.ait.ext4j.client.ui.Spinner::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void setSpinUpEnabled(boolean value) /*-{
		var sp = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addSpinHandler(SpinHandler handler)/*-{
		...
		var fn = function(sp, direction, e) {
			var spinner = @com.ait.ext4j.client.ui.Spinner::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.form.SpinEvent::new(Lcom/ait/ext4j/client/ui/Spinner;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(spinner, direction,e);
			handler.@com.ait.ext4j.client.events.form.SpinHandler::onSpin(Lcom/ait/ext4j/client/events/form/SpinEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.SpinEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addSpinDownHandler(SpinDownHandler handler)/*-{
		...
		var fn = function(sp, e) {
			var spinner = @com.ait.ext4j.client.ui.Spinner::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.form.SpinDownEvent::new(Lcom/ait/ext4j/client/ui/Spinner;Lcom/google/gwt/core/client/JavaScriptObject;)(spinner,e);
			handler.@com.ait.ext4j.client.events.form.SpinDownHandler::onSpinDown(Lcom/ait/ext4j/client/events/form/SpinDownEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.SpinDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSpinUpHandler(SpinUpHandler handler)/*-{
		...
		var fn = function(sp, e) {
			var spinner = @com.ait.ext4j.client.ui.Spinner::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.form.SpinUpEvent::new(Lcom/ait/ext4j/client/ui/Spinner;Lcom/google/gwt/core/client/JavaScriptObject;)(spinner,e);
			handler.@com.ait.ext4j.client.events.form.SpinUpHandler::onSpinUp(Lcom/ait/ext4j/client/events/form/SpinUpEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.SpinUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
