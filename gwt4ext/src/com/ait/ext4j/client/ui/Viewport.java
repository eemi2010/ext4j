...
public class Viewport extends Container implements AcceptsOneWidget {
    ...
    public native void attach() /*-{
		@com.ait.ext4j.client.ui.Viewport::viewPort.@com.google.gwt.user.client.ui.Widget::onAttach()();
    }-*/;
    ...
    private native static Viewport initViewPort(String l, int padding) /*-{
		...
		var container = @com.ait.ext4j.client.ui.Viewport::new(Lcom/google/gwt/core/client/JavaScriptObject;)(viewport);
		return container;
    }-*/;
