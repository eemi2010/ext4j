...
import com.ait.ext4j.client.events.panel.ToolClickHandler;
import com.ait.ext4j.client.events.panel.ToolHandler;
...
public class Tool extends Component {
    ...
    public native HandlerRegistration addToolClickHandler(ToolClickHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tool = @com.ait.ext4j.client.ui.Tool::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.ext4j.client.events.panel.ToolClickEvent::new(Lcom/ait/ext4j/client/ui/Tool;Lcom/google/gwt/core/client/JavaScriptObject;)(tool,e);
			handler.@com.ait.ext4j.client.events.panel.ToolClickHandler::onToolClick(Lcom/ait/ext4j/client/events/panel/ToolClickEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.panel.ToolClickEvent::EVENT_NAME;
