...
import com.ait.ext4j.client.events.window.MaximizeHandler;
import com.ait.ext4j.client.events.window.MinimizeHandler;
import com.ait.ext4j.client.events.window.ResizeHandler;
import com.ait.ext4j.client.events.window.RestoreHandler;
...
public class Window extends Panel {
    ...
    public native void show() /*-{
		var window = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		window.show();
    }-*/;
    ...
    public native HandlerRegistration addMaximizeHandler(MaximizeHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.ait.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.ait.ext4j.client.events.window.MaximizeEvent::new(Lcom/ait/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.ait.ext4j.client.events.window.MaximizeHandler::onMaximize(Lcom/ait/ext4j/client/events/window/MaximizeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.window.MaximizeEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addMinimizeHandler(MinimizeHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.ait.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.ait.ext4j.client.events.window.MinimizeEvent::new(Lcom/ait/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.ait.ext4j.client.events.window.MinimizeHandler::onMinimize(Lcom/ait/ext4j/client/events/window/MinimizeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.window.MinimizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addRestoreHandler(RestoreHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.ait.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.ait.ext4j.client.events.window.RestoreEvent::new(Lcom/ait/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.ait.ext4j.client.events.window.RestoreHandler::onRestore(Lcom/ait/ext4j/client/events/window/RestoreEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.window.RestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addResizeHandler(ResizeHandler handler)/*-{
		...
		var fn = function(c, w, h, e) {
			var win = @com.ait.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.window.ResizeEvent::new(Lcom/ait/ext4j/client/ui/Window;DDLcom/google/gwt/core/client/JavaScriptObject;)(c,w, h, e);
			handler.@com.ait.ext4j.client.events.window.ResizeHandler::onResize(Lcom/ait/ext4j/client/events/window/ResizeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.window.ResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
