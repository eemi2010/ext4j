...
import com.ait.ext4j.client.core.ComponentTraversalCallback;
import com.ait.ext4j.client.core.DefaultsHandler;
import com.ait.ext4j.client.core.DomUtil;
...
import com.ait.ext4j.client.core.WidgetComponent;
...
import com.ait.ext4j.client.events.container.AddHandler;
import com.ait.ext4j.client.events.container.AfterLayoutHandler;
import com.ait.ext4j.client.events.container.BeforeAddHandler;
import com.ait.ext4j.client.events.container.BeforeRemoveHandler;
import com.ait.ext4j.client.events.container.ContainerBeforeRemoveHandler;
import com.ait.ext4j.client.events.container.ContainerContentChangeHandler;
import com.ait.ext4j.client.layout.AbsoluteLayout;
import com.ait.ext4j.client.layout.AccordionLayout;
import com.ait.ext4j.client.layout.AnchorLayout;
import com.ait.ext4j.client.layout.AutoLayout;
import com.ait.ext4j.client.layout.BorderLayout;
import com.ait.ext4j.client.layout.BorderRegion;
import com.ait.ext4j.client.layout.CardLayout;
import com.ait.ext4j.client.layout.ColumnLayout;
import com.ait.ext4j.client.layout.ContainerLayout;
import com.ait.ext4j.client.layout.FitLayout;
import com.ait.ext4j.client.layout.FormLayout;
import com.ait.ext4j.client.layout.HBoxLayout;
import com.ait.ext4j.client.layout.Layout;
import com.ait.ext4j.client.layout.LayoutData;
import com.ait.ext4j.client.layout.TableLayout;
import com.ait.ext4j.client.layout.VBoxLayout;
...
public class Container extends Component implements HasWidgets {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.Container::configPrototype = c.initialConfig;
    }-*/;
    ...
    private native void addPreCreate(JavaScriptObject componentJS) /*-{
		...
		if (!config.items) {
			config.items = @com.ait.ext4j.client.core.JsoHelper::createJavaScriptArray()();
		}
		config.items.push(componentJS);
    }-*/;

    private native void addPostCreate(JavaScriptObject componentJS) /*-{
		var container = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native Component findByID(String id) /*-{
		...
		return comp == null || comp === undefined ? null
				: @com.ait.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(comp);
    }-*/;
    ...
    public native Component[] findByType(String xtype) /*-{
		...
		return comps == null || comps === undefined ? null
				: @com.ait.ext4j.client.core.JsoHelper::convertToJavaComponentArray(Lcom/google/gwt/core/client/JavaScriptObject;)(comps);
    }-*/;
    ...
    public native Component[] getComponents()/*-{
		...
		return @com.ait.ext4j.client.core.JsoHelper::convertToJavaComponentArray(Lcom/google/gwt/core/client/JavaScriptObject;)(items);
    }-*/;
    ...
    public native void remove(Component component, boolean autoDestroy) /*-{
		var container = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var componentJS = component.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native Component[] findBy(ComponentTraversalCallback cb)/*-{
		...
		var comps = container
				.findBy(function(comp) {
					var compJ = @com.ait.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(comp);
					return cb.@com.ait.ext4j.client.core.ComponentTraversalCallback::execute(Lcom/ait/ext4j/client/core/Component;)(compJ);
				});
		return @com.ait.ext4j.client.core.JsoHelper::convertToJavaComponentArray(Lcom/google/gwt/core/client/JavaScriptObject;)(comps);
    }-*/;
     ...
     * {@link com.ait.ext4j.client.core.layout.AccordionLayout} ,
     * {@link com.ait.ext4j.client.core.layout.CardLayout} and
     * {@link com.ait.ext4j.client.core.layout.FitLayout} ).
     * 
     * @param activeItem
     *            the active Item ID
     */
     ...
     * {@link com.ait.ext4j.client.core.layout.AccordionLayout} ,
     * {@link com.ait.ext4j.client.core.layout.CardLayout} and
     * {@link com.ait.ext4j.client.layout.FitLayout} ).
     * 
     * 
     * @param activeItem
     *            the active Item ID
    ...
    public native HandlerRegistration addAddHandler(AddHandler handler)/*-{
		...
		var fn = function(ct, cmp, index, e) {
			...
			var component = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.container.AddEvent::new(Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(container, component, index,e);
			handler.@com.ait.ext4j.client.events.container.AddHandler::onAdd(Lcom/ait/ext4j/client/events/container/AddEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.container.AddEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addAfterLayoutHandler(AfterLayoutHandler handler)/*-{
		...
		var fn = function(ct, l, e) {
			var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var layout = @com.ait.ext4j.client.layout.ContainerLayout::new(Lcom/google/gwt/core/client/JavaScriptObject;)(l);
			var event = @com.ait.ext4j.client.events.container.AfterLayoutEvent::new(Lcom/ait/ext4j/client/ui/Container;Lcom/ait/ext4j/client/layout/ContainerLayout;Lcom/google/gwt/core/client/JavaScriptObject;)(container, layout, e);
			handler.@com.ait.ext4j.client.events.container.AfterLayoutHandler::onAfterLayout(Lcom/ait/ext4j/client/events/container/AfterLayoutEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.container.AfterLayoutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addBeforeAddHandler(BeforeAddHandler handler)/*-{
		...
		var fn = function(ct, cmp, index, e) {
			var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.container.BeforeAddEvent::new(Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(container, component, index,e);
			handler.@com.ait.ext4j.client.events.container.BeforeAddHandler::onBeforeAdd(Lcom/ait/ext4j/client/events/container/BeforeAddEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.container.BeforeAddEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native void addBeforeRemoveHandler(ContainerBeforeRemoveHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.ext4j.client.events.Event::BEFORE_REMOVE,
							$entry(function(ct, c) {
								var comp = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
								return handler.@com.ait.ext4j.client.events.container.ContainerBeforeRemoveHandler::onEvent(Lcom/ait/ext4j/client/ui/Container;Lcom/ait/ext4j/client/core/Component;)(container,comp);
							}));
		}
    }-*/;
    ...
    public native HandlerRegistration addBeforeRemoveHandler(BeforeRemoveHandler handler)/*-{
		...
		var fn = function(ct, cmp, e) {
			var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.container.BeforeRemoveEvent::new(Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(container,component,e);
			handler.@com.ait.ext4j.client.events.container.BeforeRemoveHandler::onBeforeRemove(Lcom/ait/ext4j/client/events/container/BeforeRemoveEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.container.BeforeRemoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
     ...
     *            , the handler that will handle the event
     */
    public native HandlerRegistration addRemoveHandler(com.ait.ext4j.client.events.container.RemoveHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(ct, cmp, e) {
			var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.ext4j.client.events.container.RemoveEvent::new(Lcom/ait/ext4j/client/core/Component;Lcom/ait/ext4j/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(container,component,e);
			handler.@com.ait.ext4j.client.events.container.RemoveHandler::onRemove(Lcom/ait/ext4j/client/events/container/RemoveEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.container.RemoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
			...
			component
					.addListener(
							...
							$entry(function(ct, c, index) {
								var comp = @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								var container = @com.ait.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
								handler.@com.ait.ext4j.client.events.container.ContainerContentChangeHandler::onEvent(Lcom/ait/ext4j/client/ui/Container;Lcom/ait/ext4j/client/core/Component;I)(container,comp,index);
							}));
		}
