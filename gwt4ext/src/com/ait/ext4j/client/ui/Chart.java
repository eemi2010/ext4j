...
import com.ait.ext4j.client.chart.Legend;
import com.ait.ext4j.client.chart.axis.AbstractAxis;
import com.ait.ext4j.client.chart.laf.Gradient;
import com.ait.ext4j.client.chart.saving.ImageExport;
import com.ait.ext4j.client.chart.series.AbstractSerie;
import com.ait.ext4j.client.chart.theme.Theme;
...
import com.ait.ext4j.client.draw.engine.ImageExporter;
import com.ait.ext4j.client.events.Event;
import com.ait.ext4j.client.events.HandlerRegistration;
import com.ait.ext4j.client.events.chart.BeforeRefreshHandler;
import com.ait.ext4j.client.events.chart.ChartEventHandler;
import com.ait.ext4j.client.events.chart.RefreshHandler;
...
public class Chart extends DrawComponent {
    ...
    private native void init()/*-{
		...
		@com.ait.ext4j.client.ui.Chart::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void refresh() /*-{
		var chart = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		chart.refresh();
    }-*/;
    ...
    public native HandlerRegistration addBeforeReshHandler(BeforeRefreshHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, e) {
			var chart = @com.ait.ext4j.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.chart.BeforeRefreshEvent::new(Lcom/ait/ext4j/client/ui/Chart;Lcom/google/gwt/core/client/JavaScriptObject;)(chart, event);
			handler.@com.ait.ext4j.client.events.chart.BeforeRefreshHandler::onBeforeRefresh(Lcom/ait/ext4j/client/events/chart/BeforeRefreshEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.chart.BeforeRefreshEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addReshHandler(RefreshHandler handler)/*-{
		...
		var fn = function(c, e) {
			var chart = @com.ait.ext4j.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.ext4j.client.events.chart.RefreshEvent::new(Lcom/ait/ext4j/client/ui/Chart;Lcom/google/gwt/core/client/JavaScriptObject;)(chart, event);
			handler.@com.ait.ext4j.client.events.chart.RefreshHandler::onRefresh(Lcom/ait/ext4j/client/events/chart/RefreshEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.chart.RefreshEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
		...
		if (component) {
			component
					.addListener(
							...
							$entry(function(c) {
								var chart = @com.ait.ext4j.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								return handler.@com.ait.ext4j.client.events.chart.ChartEventHandler::onEvent(Lcom/ait/ext4j/client/ui/Chart;)(chart);
							}));
		}
