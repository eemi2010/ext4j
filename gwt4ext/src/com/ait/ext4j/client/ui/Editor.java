...
import com.ait.ext4j.client.events.editor.BeforeCompleteHandler;
import com.ait.ext4j.client.events.editor.BeforeStartEditHandler;
import com.ait.ext4j.client.events.editor.CancelEditHandler;
import com.ait.ext4j.client.events.editor.CompleteHandler;
import com.ait.ext4j.client.events.editor.EditorBeforeCompleteHandler;
import com.ait.ext4j.client.events.editor.EditorBeforeStartEditHandler;
import com.ait.ext4j.client.events.editor.SpecialKeyHandler;
import com.ait.ext4j.client.events.editor.StartEditHandler;
import com.ait.ext4j.client.field.Field;
...
public class Editor extends Container {
    ...
    private static native void init()/*-{
		...
		@com.ait.ext4j.client.ui.Editor::configPrototype = c.initialConfig;
    }-*/;
    ...
    protected native JavaScriptObject create(JavaScriptObject config) /*-{
		var field = this.@com.ait.ext4j.client.ui.Editor::field;
		var fieldJS = field.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var ed = new $wnd.Ext.Editor(fieldJS, config);
		var id = ed.getId();
		this.@com.ait.ext4j.client.core.Component::id = id;
		return ed;
    }-*/;
    ...
    public native void cancelEdit(boolean remainVisible) /*-{
		var editor = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		editor.cancelEdit();
    }-*/;
    ...
    public native void setValueRendered(Date value)/*-{
		var millis = @com.ait.ext4j.client.util.DateUtil::getTime(Ljava/util/Date;)(value);
    ...
    public native HandlerRegistration addBeforeCompleteHandler(BeforeCompleteHandler handler)/*-{
		...
		var fn = function(editor, value, olValue, e) {
			var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.ait.ext4j.client.events.editor.BeforeCompleteEvent::new(Lcom/ait/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm,value, oldValue,e)
			handler.@com.ait.ext4j.client.events.editor.BeforeCompleteHandler::onBeforeCompete(Lcom/ait/ext4j/client/events/editor/BeforeCompleteEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.BeforeCompleteEvent::EVENT_NAME;
    ...
    public native void addBeforeCompleteHandler(EditorBeforeCompleteHandler handler)/*-{
		...
		compoenent
				.addListener(
						@com.ait.ext4j.client.events.Event::BEFORE_COMPLETE,
						$entry(function(editor, value, olValue) {
							var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
							return handler.@com.ait.ext4j.client.events.editor.EditorBeforeCompleteHandler::onEvent(Lcom/ait/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;)(cpm,value,OldValue);
						}));
    ...
    public native HandlerRegistration addBeforeStartEditHandler(BeforeStartEditHandler handler)/*-{
		...
		var fn = function(editor, el, value, e) {
			...
			var event = @com.ait.ext4j.client.events.editor.BeforeStartEditEvent::new(Lcom/ait/ext4j/client/ui/Editor;Lcom/ait/ext4j/client/core/ExtElement;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm, element, value, e);
			handler.@com.ait.ext4j.client.events.editor.BeforeStartEditHandler::onBeforeStartEdit(Lcom/ait/ext4j/client/events/editor/BeforeStartEditEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.BeforeStartEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeStartEditHandler(EditorBeforeStartEditHandler handler)/*-{
		...
		compoenent
				.addListener(
						@com.ait.ext4j.client.events.Event::BEFORE_START_EDIT,
						$entry(function(editor, el, value) {
							var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
							var element = @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
							handler.@com.ait.ext4j.client.events.editor.EditorBeforeStartEditHandler::onEvent(Lcom/ait/ext4j/client/ui/Editor;Lcom/ait/ext4j/client/core/ExtElement;Ljava/lang/Object;)(cmp,element,value);
						}));
    }-*/;
    ...
    public native HandlerRegistration addCancelEditHandler(CancelEditHandler handler)/*-{
		...
		var fn = function(editor, value, startValue, e) {
			var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.ait.ext4j.client.events.editor.CancelEditEvent::new(Lcom/ait/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp, value, startValue, e);
			handler.@com.ait.ext4j.client.events.editor.CancelEditHandler::onCancelEdit(Lcom/ait/ext4j/client/events/editor/CancelEditEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.CancelEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCompleteEditHandler(CompleteHandler handler)/*-{
		...
		var fn = function(editor, value, startValue, e) {
			var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.ait.ext4j.client.events.editor.CompleteEvent::new(Lcom/ait/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp, value, startValue, e);
			handler.@com.ait.ext4j.client.events.editor.CompleteHandler::onComplete(Lcom/ait/ext4j/client/events/editor/CompleteEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.CompleteEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSpecialKeyHandler(SpecialKeyHandler handler)/*-{
		...
		var fn = function(editor, f, e) {
			var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var field = @com.ait.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.editor.SpecialKeyEvent::new(Lcom/ait/ext4j/client/ui/Editor;Lcom/ait/ext4j/client/field/FieldBase;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp,field,e);
			handler.@com.ait.ext4j.client.events.editor.SpecialKeyHandler::onSpecialKey(Lcom/ait/ext4j/client/events/editor/SpecialKeyEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.SpecialKeyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addStartEditHandler(StartEditHandler handler)/*-{
		...
		var fn = function(editor, el, value, e) {
			var cmp = @com.ait.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var element = @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var event = @com.ait.ext4j.client.events.editor.StartEditEvent::new(Lcom/ait/ext4j/client/ui/Editor;Lcom/ait/ext4j/client/core/ExtElement;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm, element, value, e);
			handler.@com.ait.ext4j.client.events.editor.StartEditHandler::onStartEdit(Lcom/ait/ext4j/client/events/editor/StartEditEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.editor.StartEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
