...
public class ItemClickEvent extends EventObject {
    ...
    public static String EVENT_NAME = Event.ITEM_CLICK;
    ...
    public ItemClickEvent(TableView source, BaseModel record, Element item, int index, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
        this.item = item;
        this.record = record;
