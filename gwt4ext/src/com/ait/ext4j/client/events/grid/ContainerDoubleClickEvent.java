...
public class ContainerDoubleClickEvent extends EventObject {
    ...
    public ContainerDoubleClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public ContainerDoubleClickEvent(DataView source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
