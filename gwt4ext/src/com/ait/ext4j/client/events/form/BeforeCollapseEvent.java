...
import com.ait.ext4j.client.ui.FieldSet;
import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.event.dom.client.DomEvent.Type;

public class BeforeCollapseEvent extends EventObject {
    ...
    public BeforeCollapseEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public BeforeCollapseEvent(FieldSet source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
    }
