...
import com.ait.ext4j.client.ui.Spinner;
import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.event.dom.client.DomEvent.Type;

public class SpinDownEvent extends EventObject {

    public static String EVENT_NAME = Event.SPIN_DOWN;
    ...
    public SpinDownEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public SpinDownEvent(Spinner source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
    }
