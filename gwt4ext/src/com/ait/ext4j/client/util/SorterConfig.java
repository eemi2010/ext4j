...
public class SorterConfig extends BaseConfig {
    ...
    public native void setSorterFn(SorterFunction fn)/*-{
		...
		f.filterFn = $entry(function(item1, item2) {
			var model1 = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(item1);
			var model2 = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(item2);
			return fn.@com.ait.ext4j.client.util.SorterFunction::onSort(Lcom/ait/ext4j/client/data/BaseModel;Lcom/ait/ext4j/client/data/BaseModel;)(model1,model2);
		});
    }-*/;
