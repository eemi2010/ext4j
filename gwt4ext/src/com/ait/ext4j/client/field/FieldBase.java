...
import com.ait.ext4j.client.events.form.ChangeHandler;
import com.ait.ext4j.client.events.form.DirtyChangeHandler;
import com.ait.ext4j.client.events.form.SpecialKeyHandler;
import com.ait.ext4j.client.events.form.ValidityChangeHandler;
import com.ait.ext4j.client.events.form.WritableChangeHandler;
...
public class FieldBase extends Field {
    ...
    public native ExtElement getInputElement()/*-{
		...
		return @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addSpecialKeyHandler(SpecialKeyHandler handler)/*-{
		...
		var fn = function(f, e) {
			...
			var event = @com.ait.ext4j.client.events.form.SpecialKeyEvent::new(Lcom/ait/ext4j/client/field/FieldBase;Lcom/google/gwt/core/client/JavaScriptObject;)(field,e);
			handler.@com.ait.ext4j.client.events.form.SpecialKeyHandler::onSpecialKey(Lcom/ait/ext4j/client/events/form/SpecialKeyEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.SpecialKeyEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addWritableChangeHandler(WritableChangeHandler handler)/*-{
		...
		var fn = function(f, read, e) {
			var field = @com.ait.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.form.WritableChangeEvent::new(Lcom/ait/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field, read, e);
			handler.@com.ait.ext4j.client.events.form.WritableChangeHandler::onWritableChange(Lcom/ait/ext4j/client/events/form/WritableChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.WritableChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(f, newValue, oldValue, e) {
			...
			var field = @com.ait.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.form.ChangeEvent::new(Lcom/ait/ext4j/client/field/FieldBase;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(field,nV,oV,e);
			handler.@com.ait.ext4j.client.events.form.ChangeHandler::onChange(Lcom/ait/ext4j/client/events/form/ChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDirtyChangeHandler(DirtyChangeHandler handler)/*-{
		...
		var fn = function(f, isDirty, e) {
			var field = @com.ait.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.form.DirtyChangeEvent::new(Lcom/ait/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isDirty,e);
			handler.@com.ait.ext4j.client.events.form.DirtyChangeHandler::onDirtyChange(Lcom/ait/ext4j/client/events/form/DirtyChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.DirtyChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addValidityChangeHandler(ValidityChangeHandler handler)/*-{
		...
		var fn = function(f, isValid, e) {
			var field = @com.ait.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.ext4j.client.events.form.ValidityChangeEvent::new(Lcom/ait/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isValid,e);
			handler.@com.ait.ext4j.client.events.form.ValidityChangeHandler::onValidityChange(Lcom/ait/ext4j/client/events/form/ValidityChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.form.ValidityChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.HandlerRegistration::new(Lcom/ait/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
