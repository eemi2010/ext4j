...
public class AnchorLayout extends ContainerLayout {
    ...
    public native JavaScriptObject getContainerAttributes() /*-{
		if (this.@com.ait.ext4j.client.layout.AnchorLayout::width != -1) {
			return {
				anchorSize : {
					width : this.@com.ait.ext4j.client.layout.AnchorLayout::width,
					height : this.@com.ait.ext4j.client.layout.AnchorLayout::height
				}
			};
		} else {
			return {};
