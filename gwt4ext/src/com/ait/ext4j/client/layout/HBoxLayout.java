...
public class HBoxLayout extends BoxLayout {
    ...
    public HBoxLayout(Align align) {
        setAlign(align);
    }

    protected HBoxLayout(JavaScriptObject obj) {
        jsObj = obj;
    }
    ...
    public static HBoxLayout cast(ContainerLayout layout) {
        return new HBoxLayout(layout.getJsObj());
    }
