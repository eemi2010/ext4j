...
import com.ait.ext4j.client.core.SimpleComponent;
...
public class CardLayout extends FitLayout {
    ...
    public native void setActiveItem(int index) /*-{
		var layout = this.@com.ait.ext4j.client.layout.ContainerLayout::getJsObj()();
    ...
    public native void setActiveItem(Component comp) /*-{
		...
		if (layout.setActiveItem) {
			layout
					.setActiveItem(comp.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()());
		}
    }-*/;
    ...
    public native SimpleComponent getActiveItem() /*-{
		...
		if (obj.getActiveItem) {
			...
			return @com.ait.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		}
		return null;
