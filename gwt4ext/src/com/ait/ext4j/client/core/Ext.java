...
public class Ext {
    ...
    public static native String id(ExtElement element) /*-{
		return $wnd.Ext
				.id(element.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native void destroy(ExtElement element) /*-{
		var el = element.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		$wnd.Ext.destroy(el);
    }-*/;
    ...
    public static native void destroy(Component component) /*-{
		var comp = component.@com.ait.ext4j.client.core.Component::getJsObj()();
    ...
    public static native Size getScrollbarSize()/*-{
		...
		return @com.ait.ext4j.client.core.Size::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public static native void onReady(Function cb) /*-{
		$wnd.Ext.onReady(function() {
			cb.@com.ait.ext4j.client.core.Function::execute()();
		});
    }-*/;
    ...
    public static native void apply(Component component, BaseConfig config)/*-{
		var c = component.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
		var conf = config.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public static native void apply(JsObject src, JsObject target)/*-{
		var s = src.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var t = config.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		$wnd.Ext.apply(s, t);
    }-*/;
    ...
    public static native ExtElement cloneNode(ExtElement el)/*-{
		var node = $wnd.Ext
				.clone(el.@com.ait.ext4j.client.core.JsObject::getJsObj()());
		return @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(node);
    }-*/;
