...
import com.ait.ext4j.client.core.config.StyleConfig;
import com.ait.ext4j.client.events.ElementHandlerRegistration;
import com.ait.ext4j.client.events.element.EventHandler;
import com.ait.ext4j.client.fx.anim.Animation;
import com.ait.ext4j.client.fx.anim.FadeIn;
import com.ait.ext4j.client.fx.anim.FadeOut;
import com.ait.ext4j.client.fx.anim.HighLight;
...
public class ExtElement extends DomElement {
    ...
    public static native ExtElement fly(String id)/*-{
		...
		return elem == null || elem === undefined ? null
				: @com.ait.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
    }-*/;
    ...
    public native ExtElement puff(FadeOut config)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		elem.puff(config.@com.ait.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native ExtElement setWidth(String value, Animation animation)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		elem.setWidth(value,
				animation.@com.ait.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native ElementHandlerRegistration addHandler(String event, EventHandler handler)/*-{
		var component = this.@com.ait.ext4j.client.core.ExtElement::getJsObj()();
		var fn = function(event, el) {
			var eventObject = @com.ait.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			handler.@com.ait.ext4j.client.events.element.EventHandler::onEvent(Lcom/ait/ext4j/client/core/EventObject;Lcom/google/gwt/dom/client/Element;)(eventObject,el);
		};
		component.addListener(event, fn);
		var toReturn = @com.ait.ext4j.client.events.ElementHandlerRegistration::new(Lcom/ait/ext4j/client/core/ExtElement;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,event,fn);
		return toReturn;
