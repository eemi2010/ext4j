...
/**
 * {@link com.ait.ext4j.client.ui.MessageBox} configuration class.
 * 
 * @see com.ait.ext4j.client.ui.MessageBox#show(MessageBoxConfig)
 */
public class MessageBoxConfig extends BaseConfig {
    ...
    public native void setCallback(PromptCallback cb)/*-{
		var config = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native void setCallback(ConfirmCallback callback)/*-{
		...
		jso.fn = function(btn) {
			callback.@com.ait.ext4j.client.events.messagebox.ConfirmCallback::execute(Ljava/lang/String;)(btn);
		}
    }-*/;
    ...
    public native void setButtonText(ButtonText value)/*-{
		var jso = this.@com.ait.ext4j.client.core.config.BaseConfig::getJsObj()();
		jso.buttonText = value.@com.ait.ext4j.client.core.config.ButtonText::getJsObj()();
    }-*/;
