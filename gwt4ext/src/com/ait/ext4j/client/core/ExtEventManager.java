...
import com.ait.ext4j.client.core.handlers.WindowResizeHandler;
    ...
    public static native void addWindowResizeHandler(WindowResizeHandler handler)/*-{
		$wnd.Ext.EventManager
				.onWindowResize(function(w, h) {
					var event = @com.ait.ext4j.client.events.WindowResizeEvent::new(II)(w,h);
					handler.@com.ait.ext4j.client.core.handlers.WindowResizeHandler::onWindowResize(Lcom/ait/ext4j/client/events/WindowResizeEvent;)(event);
				});
    }-*/;
