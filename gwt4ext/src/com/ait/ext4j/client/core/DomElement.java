...
import com.ait.ext4j.client.core.config.AnimationConfig;
import com.ait.ext4j.client.core.config.BaseConfig;
import com.ait.ext4j.client.core.handlers.EventCallback;
import com.ait.ext4j.client.events.KeyListener;
import com.ait.ext4j.client.fx.Fx;
import com.ait.ext4j.client.fx.FxConfig;
import com.ait.ext4j.client.fx.easing.Easing;
import com.ait.ext4j.client.util.KeyMap;
import com.ait.ext4j.client.util.KeyMapConfig;
...
public class DomElement extends JsObject implements Fx {
    ...
    public native DomElement addCls(String... classNames)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		elem
				.addCls(@com.ait.ext4j.client.core.JsoHelper::convertToJavaScriptArray([Ljava/lang/Object;)(classNames));
		return this;
    }-*/;
    ...
    public native KeyMap addKeyListener(int keyCode, KeyListener listener)/*-{
		...
		var km = elem
				.addKeyListener(
						keyCode,
						function(key, event) {
							var e = @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
							listener.@com.ait.ext4j.client.events.KeyListener::onKey(ILcom/ait/ext4j/client/core/EventObject;)(key,e);
						});
		return @com.ait.ext4j.client.util.KeyMap::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(km);
    }-*/;
    ...
    public native KeyMap addKeyListener(int[] keyCodes, KeyListener listener)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var keyCodesJS = @com.ait.ext4j.client.core.JsoHelper::convertToJavaScriptArray([I)(keyCodes);
		var km = elem
				.addKeyListener(
						keyCodesJS,
						function(key, event) {
    ...
    public native KeyMap addKeyMap(KeyMapConfig config)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var configJS = config.@com.ait.ext4j.client.core.JsObject::getJsObj()();
				...
				.addListener(
						...
						function(event) {
							var e = (event === undefined || event == null) ? null
									: @com.ait.ext4j.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
							cb.@com.ait.ext4j.client.core.handlers.EventCallback::execute(Lcom/ait/ext4j/client/core/EventObject;)(e);
						});
    }-*/;
    ...
    public native void addListener(String eventName, EventCallback cb, ListenerConfig config) /*-{
		...
		el
				.addListener(
						...
						config.@com.ait.ext4j.client.core.JsObject::jsObj);
    }-*/;
    ...
    public native DomElement alignTo(String id, String anchorPosition, int[] offsetXY, boolean animate)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var offsetJS = @com.ait.ext4j.client.core.JsoHelper::convertToJavaScriptArray([I)(offsetXY);
    ...
    public native DomElement animate(BaseConfig args)/*-{
		...
		var argsJS = args == null ? null
				: args.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		elem.animate(argsJS);
		return this;
    }-*/;
    ...
    public native DomElement animate(BaseConfig args, float duration, Function onComplete, Easing easing,
		...
		var argsJS = args == null ? null
				: args.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var easingJS = easing.@com.ait.ext4j.client.fx.easing.Easing::getValue()();
		elem.animate(argsJS, duration, onComplete == null ? null : function() {
			onComplete.@com.ait.ext4j.client.core.Function::execute()();
		}, easingJS, animType);
		return this;
    }-*/;
    ...
    public native DomElement hide(AnimationConfig animateConfig)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var animateConfigJS = animateConfig.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native DomElement move(Direction direction, int distance)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var directionJS = direction.@com.ait.ext4j.client.core.Direction::getDirection()();
    ...
    public native DomElement radioCls(String[] classNames)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var classNamesJS = @com.ait.ext4j.client.core.JsoHelper::convertToJavaScriptArray([Ljava/lang/Object;)(classNames);
    ...
    public native DomElement setRegion(Region region, boolean animate)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var regionJS = region.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native DomElement setStyles(BaseConfig styles)/*-{
		var elem = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var stylesJS = styles.@com.ait.ext4j.client.core.JsObject::getJsObj()();
