...
public class CompositeElement extends JsObject {
    ...
    public native CompositeElement add(String selector) /*-{
		var ce = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		ce.add(selector);
		return this;
    }-*/;
    ...
    public native void contains(ExtElement element) /*-{
		var ce = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var elJS = element.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native CompositeElement replaceElement(int index, ExtElement replacement) /*-{
		var ce = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var replacementJS = replacement.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native ExtElement item(int index)/*-{
		...
		return obj ? @com.ait.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj)
				: null;
    }-*/;
}
