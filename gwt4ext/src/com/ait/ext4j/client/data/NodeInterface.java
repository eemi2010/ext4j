...
import com.ait.ext4j.client.data.handlers.BubbleHandler;
import com.ait.ext4j.client.data.handlers.NodeQueryHandler;
		...
		if (jso) {
			jso
					.bubble($entry(function(node) {
						var nodeObject = @com.ait.ext4j.client.data.NodeInterface::new(Lcom/google/gwt/core/client/JavaScriptObject;)(node);
						handler.@com.ait.ext4j.client.data.handlers.BubbleHandler::onNodeTraverse(Lcom/ait/ext4j/client/data/NodeInterface;)(nodeObject);
					}));
		}
		...
		var obj = jso
				.findChildBy(
						$entry(function(node) {
							...
							var nodeObject = @com.ait.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(node);
							return handler.@com.ait.ext4j.client.data.handlers.NodeQueryHandler::onNodeTraversal(Lcom/ait/ext4j/client/data/TableItem;)(nodeObject);
						}), this, true);
