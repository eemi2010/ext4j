...
public class BaseModel extends JsObject {
    ...
    public native String getId() /*-{
		var record = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var id = record.id;
    ...
    public native BaseModel copy() /*-{
		...
		return @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(record2);
    }-*/;
     ...
     * {@link com.ait.ext4j.client.data.event.StoreListener#onUpdate(Store, BaseModel, com.ait.ext4j.client.data.BaseModel.Operation)}
    ...
    public native Date getAsDate(String field) /*-{
        ...
        if(val == null || val === undefined || val == '') {
            ...
            return @com.ait.ext4j.client.util.DateUtil::create(D)(val.getTime());
        }
    }-*/;
    ...
    private native JavaScriptObject getFields(JavaScriptObject record)/*-{
		var fields = @com.ait.ext4j.client.core.JsoHelper::createJavaScriptArray()();
