...
import com.ait.ext4j.client.data.handlers.BatchCallback;
...
public class Batch extends JsObject {
    ...
    public native Batch add(Operation opertion)/*-{
		var batch = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		batch.add(opertion.@com.ait.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    private native void addCallback(String event, BatchCallback cb)/*-{
		...
		batch
				.addEventListener(
						event,
						$entry(function(b, op) {
							var batch = @com.ait.ext4j.client.data.Batch::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
							var operation = @com.ait.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
							cb.@com.ait.ext4j.client.data.handlers.BatchCallback::onEvent(Lcom/ait/ext4j/client/data/Batch;Lcom/ait/ext4j/client/data/Operation;)(batch,operation);
						}));
    }-*/;
