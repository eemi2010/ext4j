...
import com.ait.ext4j.client.data.Operation;
import com.ait.ext4j.client.data.reader.Reader;
import com.ait.ext4j.client.data.writer.Writer;
...
public abstract class Proxy extends JsObject {
    ...
    public native void create(Operation operation, ActionCallback callback)/*-{
		...
		proxy
				.create(
						operation.@com.ait.ext4j.client.core.JsObject::getJsObj()(),
						$entry(function(op) {
							var operation = @com.ait.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
							callback.@com.ait.ext4j.client.data.proxy.ActionCallback::onAction(Lcom/ait/ext4j/client/data/Operation;)(operation);
						}));
    }-*/;
    ...
    public native Reader getReader()/*-{
		...
		return @com.ait.ext4j.client.data.reader.Reader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;

    public native Writer getWriter()/*-{
		var proxy = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var obj = proxy.getReader();
		return @com.ait.ext4j.client.data.writer.Writer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setReader(Reader reader)/*-{
		var proxy = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		proxy
				.setReader(reader.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;

    public native void setWriter(Writer writer)/*-{
		var proxy = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		proxy
				.setReader(writer.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
