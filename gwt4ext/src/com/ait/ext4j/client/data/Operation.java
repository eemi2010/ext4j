...
public class Operation extends JsObject {
    ...
    public native boolean commitRecords(List<BaseModel> records)/*-{
		var obj = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var data = @com.ait.ext4j.client.data.BaseModel::fromList(Ljava/util/List;)(records);
    ...
    public native List<BaseModel> getRecords()/*-{
		...
		return @com.ait.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
    }-*/;

    public native ResutSet getResultSet()/*-{
		var obj = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		var r = obj.getResultSet();
		return @com.ait.ext4j.client.data.ResutSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
    }-*/;
