...
import com.ait.ext4j.client.data.handlers.BeforeLoadHandler;
import com.ait.ext4j.client.data.handlers.BeforePrefetchHandler;
import com.ait.ext4j.client.data.handlers.ClearHandler;
import com.ait.ext4j.client.data.handlers.DataAddedHandler;
import com.ait.ext4j.client.data.handlers.DataChangedHandler;
import com.ait.ext4j.client.data.handlers.EachCallBack;
import com.ait.ext4j.client.data.handlers.GroupingHandler;
import com.ait.ext4j.client.data.handlers.LoadCallback;
import com.ait.ext4j.client.data.handlers.RemoveHandler;
import com.ait.ext4j.client.data.handlers.UpdateHandler;
import com.ait.ext4j.client.data.proxy.ProxyConfig;
import com.ait.ext4j.client.util.Direction;
import com.ait.ext4j.client.util.FilterConfig;
import com.ait.ext4j.client.util.FilterFunction;
import com.ait.ext4j.client.util.Grouper;
import com.ait.ext4j.client.util.GrouperConfig;
...
public class Store extends JsObject {
    ...
    public native void filterBy(FilterFunction filterFunction) /*-{
		...
		jso
				.filter($entry(function(item) {
					...
					return filterFunction.@com.ait.ext4j.client.util.FilterFunction::onFilter(Lcom/ait/ext4j/client/data/BaseModel;)(model);
				}));
    }-*/;
    ...
    public native void addGrouper(Grouper grouper)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::getJsObj()();
		jso.groupers
				.add(grouper.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void each(EachCallBack callback)/*-{
		...
		jso
				.each(function(record) {
					var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
					callback.@com.ait.ext4j.client.data.handlers.EachCallBack::onEach(Lcom/ait/ext4j/client/data/BaseModel;)(model);
				});
    }-*/;
    ...
    public native String addGroupingHandler(GroupingHandler handler)/*-{
		...
		jso.getGroupString = function(record) {
			var model = @com.ait.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
			return handler.@com.ait.ext4j.client.data.handlers.GroupingHandler::forEach(Lcom/ait/ext4j/client/data/BaseModel;)(model);
		};
    }-*/;
    ...
    public native void load(LoadCallback handler)/*-{
		...
		jso
				.load($entry(function(recs, op, success) {
					var data = @com.ait.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(recs);
					var operation = @com.ait.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
					handler.@com.ait.ext4j.client.data.handlers.LoadCallback::onLoad(Ljava/util/List;Lcom/ait/ext4j/client/data/Operation;Z)(data,operation,success);
				}));
    }-*/;
    ...
    public native void addDataAddedHandler(DataAddedHandler handler)/*-{
		...
		jso
				.addListener(
						"add",
						function(store, data) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.DataAddedHandler::onAdd(Lcom/ait/ext4j/client/data/Store;Lcom/google/gwt/core/client/JavaScriptObject;)(s, data);
						});
    }-*/;
    ...
    public native void addBeforeLoadHandler(BeforeLoadHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.BeforeLoadHandler::onBeforeLoad(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addBeforePrefetch(BeforePrefetchHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.BeforePrefetchHandler::onBeforePrefetch(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addClearHandler(ClearHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.ClearHandler::onClear(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addDataChangedHandler(DataChangedHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.DataChangedHandler::onDataChanged(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addRemoveHandler(RemoveHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.RemoveHandler::onRemove(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addUpdateHandler(UpdateHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.ait.ext4j.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.ait.ext4j.client.data.handlers.UpdateHandler::onUpdate(Lcom/ait/ext4j/client/data/Store;)(s);
						});
    }-*/;
    ...
    private native void create(String modelName, JavaScriptObject values)/*-{
		this.@com.ait.ext4j.client.core.JsObject::jsObj = new $wnd.Ext.data.Store(
				{
					model : modelName,
					data : values
				});
