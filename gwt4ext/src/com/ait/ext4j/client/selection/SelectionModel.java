 ...
 */
package com.ait.ext4j.client.selection;
...
import com.ait.ext4j.client.events.CallbackRegistration;
import com.ait.ext4j.client.events.selection.DeselectHandler;
import com.ait.ext4j.client.events.selection.FocusChangeHandler;
import com.ait.ext4j.client.events.selection.SelectHandler;
import com.ait.ext4j.client.events.selection.SelectionChangeHandler;
import com.ait.ext4j.client.util.MixedCollection;
...
public class SelectionModel extends ObservableJso {
    ...
    public native MixedCollection getSelected()/*-{
		...
		return @com.ait.ext4j.client.util.MixedCollection::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native CellPosition getCurrentPosition()/*-{
		...
		return @com.ait.ext4j.client.selection.CellPosition::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void bindStore(Store store)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		jso.bindStore(store.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void deselect(List<BaseModel> elements)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		var peers = @com.ait.ext4j.client.data.BaseModel::fromList(Ljava/util/List;)(elements);
		jso.deselect(peers);
    }-*/;
    ...
    public native List<BaseModel> getSelection()/*-{
		...
		return @com.ait.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Store getStore()/*-{
		...
		return @com.ait.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native boolean isFocused(BaseModel model)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		return jso
				.isFocused(model.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native boolean isSelected(BaseModel model)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		return jso
				.isSelected(model.@com.ait.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void setLastFocused(BaseModel record)/*-{
		...
		if (jso) {
			jso
					.setLastFocused(record.@com.ait.ext4j.client.core.JsObject::jsObj);
		}
    }-*/;
    ...
    public native CallbackRegistration addFocusChangeHandler(FocusChangeHandler handler)/*-{
		...
		var fn = function(model, os, ns, e) {
			var sm = @com.ait.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var oldSelected = @com.ait.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(os);
			var newSelected = @com.ait.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ns);

			var event = @com.ait.ext4j.client.events.selection.FocusChangeEvent::new(Lcom/ait/ext4j/client/selection/SelectionModel;Lcom/ait/ext4j/client/data/TableItem;Lcom/ait/ext4j/client/data/TableItem;Lcom/google/gwt/core/client/JavaScriptObject;)(sm, oldFocused, newFocused);
			handler.@com.ait.ext4j.client.events.selection.FocusChangeHandler::onFocusChange(Lcom/ait/ext4j/client/events/selection/FocusChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.selection.FocusChangeEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.CallbackRegistration::new(Lcom/ait/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    public native CallbackRegistration addSelectionChangeHandler(SelectionChangeHandler handler)/*-{
		...
		var fn = function(model, selection, e) {
			var sm = @com.ait.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var items = @com.ait.ext4j.client.data.TableItem::fromArray(Lcom/google/gwt/core/client/JavaScriptObject;)(selection);

			var event = @com.ait.ext4j.client.events.selection.SelectionChangeEvent::new(Lcom/ait/ext4j/client/selection/SelectionModel;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(sm,item,e);
			handler.@com.ait.ext4j.client.events.selection.SelectionChangeHandler::onSelectionChange(Lcom/ait/ext4j/client/events/selection/SelectionChangeEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.selection.SelectionChangeEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.CallbackRegistration::new(Lcom/ait/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    public native CallbackRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(model, record, row, column, e) {
			var sm = @com.ait.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var model = @com.ait.ext4j.client.data.BaseModel::from(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
			var event = @com.ait.ext4j.client.events.selection.SelectEvent::new(Lcom/ait/ext4j/client/selection/SelectionModel;Lcom/ait/ext4j/client/data/BaseModel;IILcom/google/gwt/core/client/JavaScriptObject;)(sm,model,row,column,e);
			handler.@com.ait.ext4j.client.events.selection.SelectHandler::onSelect(Lcom/ait/ext4j/client/events/selection/SelectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.selection.SelectEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.CallbackRegistration::new(Lcom/ait/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    public native CallbackRegistration addDeselectHandler(DeselectHandler handler)/*-{
		...
		var fn = function(model, record, row, column, e) {
			var sm = @com.ait.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var model = @com.ait.ext4j.client.data.BaseModel::from(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
			var event = @com.ait.ext4j.client.events.selection.DeselectEvent::new(Lcom/ait/ext4j/client/selection/SelectionModel;Lcom/ait/ext4j/client/data/BaseModel;IILcom/google/gwt/core/client/JavaScriptObject;)(sm,model,row,column,e);
			handler.@com.ait.ext4j.client.events.selection.DeselectHandler::onDeselect(Lcom/ait/ext4j/client/events/selection/DeselectEvent;)(event);
		};
		var eventName = @com.ait.ext4j.client.events.selection.DeselectEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ait.ext4j.client.events.CallbackRegistration::new(Lcom/ait/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    private native void _select(NodeInterface record)/*-{
		var jso = this.@com.ait.ext4j.client.core.JsObject::jsObj;
		var obj = record.@com.ait.ext4j.client.core.JsObject::jsObj;
		if (jso && obj) {
			jso.select(obj);
		}
    }-*/;
