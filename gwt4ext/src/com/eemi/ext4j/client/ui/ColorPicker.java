...
import com.eemi.ext4j.client.events.colorpicker.SelectHandler;
...
public class ColorPicker extends Component {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.ColorPicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(cmp, color, e) {
			var picker = @com.eemi.ext4j.client.ui.ColorPicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.eemi.ext4j.client.events.colorpicker.SelectEvent::new(Lcom/eemi/ext4j/client/ui/ColorPicker;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,color,e);
			handler.@com.eemi.ext4j.client.events.colorpicker.SelectHandler::onSelect(Lcom/eemi/ext4j/client/events/colorpicker/SelectEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.colorpicker.SelectEvent::EVENT_NAME;
