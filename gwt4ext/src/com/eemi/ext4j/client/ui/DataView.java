...
import com.eemi.ext4j.client.events.view.FocusChangeHandler;
import com.eemi.ext4j.client.events.view.HighlightItemHandler;
...
import com.eemi.ext4j.client.events.view.UnHighlightItemHandler;
...
public class DataView extends Component {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.DataView::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void bindStore(Store store) /*-{
		var view = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		view
				.bindStore(store.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void deselect(List<BaseModel> records) /*-{
		var peers = @com.eemi.ext4j.client.data.BaseModel::fromList(Ljava/util/List;)(peers);
		var view = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		view.deselect(peers);
    }-*/;
    ...
    public native BaseModel getRecord(ExtElement node) /*-{
		var view = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		var obj = view
				.getRecord(node.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    ...
    public native int indexOf(BaseModel node) /*-{
		var view = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		return view
				.indexOf(node.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native boolean isSelected(BaseModel node) /*-{
		var view = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		return view
				.isSelected(node.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native HandlerRegistration addFocusChangeHandler(FocusChangeHandler handler)/*-{
		...
		var fn = function(sm, o, n, e) {
			var sm = @com.eemi.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sm);
			var oldFocused = @com.eemi.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oldFocused);
			var newFocused = @com.eemi.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(n);
			var event = @com.eemi.ext4j.client.events.view.FocusChangeEvent::new(Lcom/eemi/ext4j/client/selection/SelectionModel;Lcom/eemi/ext4j/client/data/BaseModel;Lcom/eemi/ext4j/client/data/BaseModel;Lcom/google/gwt/core/client/JavaScriptObject;)(sm,oldFocused,newFocused,e);
			handler.@com.eemi.ext4j.client.events.view.FocusChangeHandler::onFocusChange(Lcom/eemi/ext4j/client/events/view/FocusChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.view.FocusChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHighlightItemHandler(HighlightItemHandler handler)/*-{
		...
		var fn = function(v, el, e) {
			...
			var event = @com.eemi.ext4j.client.events.view.HighlightItemEvent::new(Lcom/eemi/ext4j/client/ui/DataView;Lcom/eemi/ext4j/client/core/ExtElement;Lcom/google/gwt/core/client/JavaScriptObject;)(view,element,e);
			handler.@com.eemi.ext4j.client.events.view.HighlightItemHandler::onHighligthItem(Lcom/eemi/ext4j/client/events/view/HighlightItemEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.view.HighlightItemEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addUnHighlightItemHandler(UnHighlightItemHandler handler)/*-{
		...
		var fn = function(v, el, e) {
			var view = @com.eemi.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var element = @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var event = @com.eemi.ext4j.client.events.view.UnHighlightItemEvent::new(Lcom/eemi/ext4j/client/ui/DataView;Lcom/eemi/ext4j/client/core/ExtElement;Lcom/google/gwt/core/client/JavaScriptObject;)(view,element,e);
			handler.@com.eemi.ext4j.client.events.view.UnHighlightItemHandler::onUnHighligthItem(Lcom/eemi/ext4j/client/events/view/UnHighlightItemEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.view.UnHighlightItemEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
