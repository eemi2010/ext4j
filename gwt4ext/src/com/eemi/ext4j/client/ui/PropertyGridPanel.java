...
public class PropertyGridPanel extends GridPanel {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.PropertyGridPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    private native void _setSource(BaseModel source)/*-{
		var jso = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		jso
				.setSource(source.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
