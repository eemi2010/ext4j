...
import com.eemi.ext4j.client.events.button.GlyphChangeHandler;
import com.eemi.ext4j.client.events.button.IconChangeHandler;
import com.eemi.ext4j.client.events.button.MenuHideHandler;
import com.eemi.ext4j.client.events.button.MenuShowHandler;
import com.eemi.ext4j.client.events.button.MenuTriggerOutHandler;
import com.eemi.ext4j.client.events.button.MenuTriggerOverHandler;
import com.eemi.ext4j.client.events.button.MouseOverHandler;
import com.eemi.ext4j.client.events.button.TextChangeHandler;
import com.eemi.ext4j.client.events.button.ToggleHandler;
...
public class Button extends Component {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.Button::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native Element getButtonElement() /*-{
		var button = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native boolean hasVisibleMenu() /*-{
		var button = this.@com.eemi.ext4j.client.core.Component::getJsObj()();
		if (button == null)
			return false;
    ...
    public native void setTooltip(Tip tip) /*-{
		var button = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		button
				.setTooltip(tip.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()());
    }-*/;
    ...
    public native HandlerRegistration addClickHandler(ClickHandler handler)/*-{
		...
		var fn = function(b, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var clickEvent = @com.eemi.ext4j.client.events.button.ClickEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.eemi.ext4j.client.events.button.ClickHandler::onClick(Lcom/eemi/ext4j/client/events/button/ClickEvent;)(clickEvent);
		};
		var eventName = @com.eemi.ext4j.client.events.button.ClickEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addIconChangeHandler(IconChangeHandler handler)/*-{
		...
		var fn = function(b, oldIcon, newIcon, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.IconChangeEvent::new(Lcom/eemi/ext4j/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,oldIcon,newIcon, e);
			handler.@com.eemi.ext4j.client.events.button.IconChangeHandler::onIconChange(Lcom/eemi/ext4j/client/events/button/IconChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.IconChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addGlyphChangeHandler(GlyphChangeHandler handler)/*-{
		...
		var fn = function(b, oldG, newG, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.GlyphChangeEvent::new(Lcom/eemi/ext4j/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,oldG,newG, e);
			handler.@com.eemi.ext4j.client.events.button.GlyphChangeHandler::onGlyphChange(Lcom/eemi/ext4j/client/events/button/GlyphChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.GlyphChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addMenuHideHandler(MenuHideHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			...
			var event = @com.eemi.ext4j.client.events.button.MenuHideEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.eemi.ext4j.client.events.button.MenuHideHandler::onMenuHide(Lcom/eemi/ext4j/client/events/button/MenuHideEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MenuHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMenuShowHandler(MenuShowHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.button.MenuShowEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.eemi.ext4j.client.events.button.MenuShowHandler::onMenuShow(Lcom/eemi/ext4j/client/events/button/MenuShowEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MenuShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMenuTriggerOutHandler(MenuTriggerOutHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.button.MenuTriggerOutEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.eemi.ext4j.client.events.button.MenuTriggerOutHandler::onMenuTriggerOut(Lcom/eemi/ext4j/client/events/button/MenuTriggerOutEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MenuTriggerOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMenuTriggerOverHandler(MenuTriggerOverHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.button.MenuTriggerOverEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.eemi.ext4j.client.events.button.MenuTriggerOverHandler::onMenuTriggerOver(Lcom/eemi/ext4j/client/events/button/MenuTriggerOverEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MenuTriggerOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMouseOutHandler(MouseOutHandler handler)/*-{
		...
		var fn = function(b, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.MouseOutEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.eemi.ext4j.client.events.button.MouseOutHandler::onMouseOut(Lcom/eemi/ext4j/client/events/button/MouseOutEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MouseOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addMouseOverHandler(MouseOverHandler handler)/*-{
		...
		var fn = function(b, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.MouseOverEvent::new(Lcom/eemi/ext4j/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.eemi.ext4j.client.events.button.MouseOverHandler::onMouseOver(Lcom/google/gwt/event/dom/client/MouseOverEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.MouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addTextChangeHandler(TextChangeHandler handler)/*-{
		...
		var fn = function(b, ot, nt, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.TextChangeEvent::new(Lcom/eemi/ext4j/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,ot,nt,e);
			handler.@com.eemi.ext4j.client.events.button.TextChangeHandler::onTextChange(Lcom/eemi/ext4j/client/events/button/TextChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.TextChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addToggleHandler(ToggleHandler handler)/*-{
		...
		var fn = function(b, pressed, e) {
			var button = @com.eemi.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.eemi.ext4j.client.events.button.ToggleEvent::new(Lcom/eemi/ext4j/client/ui/Button;ZLcom/google/gwt/core/client/JavaScriptObject;)(button,pressed, e);
			handler.@com.eemi.ext4j.client.events.button.ToggleHandler::onToggle(Lcom/eemi/ext4j/client/events/button/ToggleEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.ToggleEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
