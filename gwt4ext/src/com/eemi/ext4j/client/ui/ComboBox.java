...
import com.eemi.ext4j.client.core.DomQuery;
...
import com.eemi.ext4j.client.core.XTemplate;
...
import com.eemi.ext4j.client.events.form.BeforeDeselectHandler;
...
public class ComboBox extends Picker {
    ...
    private static native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.ComboBox::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void clearValue() /*-{
		var cb = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		cb.clearValue();
    }-*/;
    ...
    public native void select(BaseModel record) /*-{
		var cb = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		cb.select(record.@com.eemi.ext4j.client.data.BaseModel::getJsObj());
    }-*/;
    ...
    /**
     * Set to {@link com.eemi.ext4j.client.ui.ComboBox#LOCAL} if the ComboBox
     * loads local data. (defaults to
     * {@link com.eemi.ext4j.client.ui.ComboBox#REMOTE} which loads from the
     * server)
     * 
     * @param mode
     ...
     * @param pageSize
     *            the page size
     * @see #setMode(com.eemi.ext4j.client.ui.ComboBox.Mode)
     * @throws IllegalStateException
     *             this property cannot be changed after the Component has been
     *             rendered
     */
    ...
    public native HandlerRegistration addBeforeDeselectHandler(BeforeDeselectHandler handler)/*-{
		...
		var fn = function(c, r, i, e) {
			var combo = @com.eemi.ext4j.client.ui.ComboBox::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var model = @com.eemi.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			var event = @com.eemi.ext4j.client.events.form.BeforeDeselectEvent::new(Lcom/eemi/ext4j/client/ui/ComboBox;Lcom/eemi/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(cmp,model,index,e);
			handler.@com.eemi.ext4j.client.events.form.BeforeDeselectHandler::onBeforeDeselect(Lcom/eemi/ext4j/client/events/form/BeforeDeselectEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.BeforeDeselectEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addBeforeSelectHandler(BeforeSelectHandler handler)/*-{
		...
		var fn = function(c, r, i, e) {
			var combo = @com.eemi.ext4j.client.ui.ComboBox::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var model = @com.eemi.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			var event = @com.eemi.ext4j.client.events.form.BeforeSelectEvent::new(Lcom/eemi/ext4j/client/ui/ComboBox;Lcom/eemi/ext4j/client/data/BaseModel;ILcom/google/gwt/core/client/JavaScriptObject;)(cmp,model,index,e);
			handler.@com.eemi.ext4j.client.events.form.BeforeSelectHandler::onBeforeSelect(Lcom/eemi/ext4j/client/events/form/BeforeSelectEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.BeforeSelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
     ...
     */
    public native HandlerRegistration addBeforeQueryHandler(com.eemi.ext4j.client.events.form.BeforeQueryHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(queryPlan, e) {
			var event = @com.eemi.ext4j.client.events.form.BeforeQueryEvent::new(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(queryPlan, e);
			handler.@com.eemi.ext4j.client.events.form.BeforeQueryHandler::onBeforeQuery(Lcom/eemi/ext4j/client/events/form/BeforeQueryEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.BeforeQueryEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
     ...
     */
    public native HandlerRegistration addSelectHandler(com.eemi.ext4j.client.events.form.SelectHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, rec, e) {
			var combo = @com.eemi.ext4j.client.ui.ComboBox::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var selection = @com.eemi.ext4j.client.data.BaseModel::from(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.eemi.ext4j.client.events.form.SelectEvent::new(Lcom/eemi/ext4j/client/ui/ComboBox;Lcom/eemi/ext4j/client/data/BaseModel;Lcom/google/gwt/core/client/JavaScriptObject;)(combo,selection,e);
			handler.@com.eemi.ext4j.client.events.form.SelectHandler::onSelect(Lcom/eemi/ext4j/client/events/form/SelectEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.SelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
