...
import com.eemi.ext4j.client.core.CompositeElement;
...
public abstract class TriggerField extends TextField {
    ...
    private native void setup(TriggerField triggerField, JavaScriptObject jsObj) /*-{
		jsObj.onTriggerClick = function(event) {
			...
			triggerField.@com.eemi.ext4j.client.ui.TriggerField::onTriggerClick(Lcom/eemi/ext4j/client/core/EventObject;)(e);
		}
    }-*/;
    ...
    public native CompositeElement getTriggerEl() /*-{
		...
		return @com.eemi.ext4j.client.core.CompositeElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
