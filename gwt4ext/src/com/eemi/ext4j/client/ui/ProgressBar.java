...
import com.eemi.ext4j.client.core.config.WaitConfig;
...
public class ProgressBar extends Component {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.ProgressBar::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native boolean isWaiting() /*-{
		var progressBar = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
     ...
     */
    public native HandlerRegistration addUpdateHandler(com.eemi.ext4j.client.events.progressbar.UpdateHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, value, text, e) {
			var pgr = @com.eemi.ext4j.client.ui.ProgressBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.eemi.ext4j.client.events.progressbar.UpdateEvent::new(Lcom/eemi/ext4j/client/ui/ProgressBar;DLjava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(pgr,value,text,e);
			handler.@com.eemi.ext4j.client.events.progressbar.UpdateHandler::onUpdate(Lcom/eemi/ext4j/client/events/progressbar/UpdateEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.progressbar.UpdateEvent::EVENT_NAME;
