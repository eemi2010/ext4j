...
import com.eemi.ext4j.client.events.window.MaximizeHandler;
import com.eemi.ext4j.client.events.window.MinimizeHandler;
import com.eemi.ext4j.client.events.window.ResizeHandler;
import com.eemi.ext4j.client.events.window.RestoreHandler;
...
public class Window extends Panel {
    ...
    public native void show() /*-{
		var window = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		window.show();
    }-*/;
    ...
    public native HandlerRegistration addMaximizeHandler(MaximizeHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.eemi.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.eemi.ext4j.client.events.window.MaximizeEvent::new(Lcom/eemi/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.eemi.ext4j.client.events.window.MaximizeHandler::onMaximize(Lcom/eemi/ext4j/client/events/window/MaximizeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.window.MaximizeEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addMinimizeHandler(MinimizeHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.eemi.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.eemi.ext4j.client.events.window.MinimizeEvent::new(Lcom/eemi/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.eemi.ext4j.client.events.window.MinimizeHandler::onMinimize(Lcom/eemi/ext4j/client/events/window/MinimizeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.window.MinimizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addRestoreHandler(RestoreHandler handler)/*-{
		...
		var fn = function(w, e) {
			var win = @com.eemi.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(w);
			var event = @com.eemi.ext4j.client.events.window.RestoreEvent::new(Lcom/eemi/ext4j/client/ui/Window;Lcom/google/gwt/core/client/JavaScriptObject;)(win,e);
			handler.@com.eemi.ext4j.client.events.window.RestoreHandler::onRestore(Lcom/eemi/ext4j/client/events/window/RestoreEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.window.RestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addResizeHandler(ResizeHandler handler)/*-{
		...
		var fn = function(c, w, h, e) {
			var win = @com.eemi.ext4j.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.eemi.ext4j.client.events.window.ResizeEvent::new(Lcom/eemi/ext4j/client/ui/Window;DDLcom/google/gwt/core/client/JavaScriptObject;)(c,w, h, e);
			handler.@com.eemi.ext4j.client.events.window.ResizeHandler::onResize(Lcom/eemi/ext4j/client/events/window/ResizeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.window.ResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public static Window wrap(JavaScriptObject peer) {
        return new Window(peer);
    }
