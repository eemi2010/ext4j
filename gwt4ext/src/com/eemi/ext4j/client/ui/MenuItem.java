...
import com.eemi.ext4j.client.events.menu.ItemActivateHandler;
import com.eemi.ext4j.client.events.menu.ItemClickHandler;
import com.eemi.ext4j.client.events.menu.ItemDeactivateHandler;
import com.eemi.ext4j.client.events.menu.ItemIconChangeHandler;
import com.eemi.ext4j.client.events.menu.ItemTextChangeHandler;
...
public class MenuItem extends Component {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.MenuItem::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native Menu getMenu() /*-{
		...
		return @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addItemActivateHandler(ItemActivateHandler handler)/*-{
		...
		var fn = function(m, e) {
			...
			var event = @com.eemi.ext4j.client.events.menu.ItemActivateEvent::new(Lcom/eemi/ext4j/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.eemi.ext4j.client.events.menu.ItemActivateHandler::onItemActivate(Lcom/eemi/ext4j/client/events/menu/ItemActivateEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ItemActivateEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addItemDeactivateHandler(ItemDeactivateHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.ItemDeactivateEvent::new(Lcom/eemi/ext4j/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.eemi.ext4j.client.events.menu.ItemDeactivateHandler::onItemDeactivate(Lcom/eemi/ext4j/client/events/menu/ItemDeactivateEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ItemDeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemClickHandler(ItemClickHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(m, e) {
			var menu = @com.eemi.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.ItemClickEvent::new(Lcom/eemi/ext4j/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.eemi.ext4j.client.events.menu.ItemClickHandler::onItemClick(Lcom/eemi/ext4j/client/events/menu/ItemClickEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ItemClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemIconChangeHandler(ItemIconChangeHandler handler)/*-{
		...
		var fn = function(m, oldIcon, newIcon, e) {
			var menu = @com.eemi.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.ItemIconChangeEvent::new(Lcom/eemi/ext4j/client/ui/MenuItem;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,oldIcon,newIcon,e);
			handler.@com.eemi.ext4j.client.events.menu.ItemIconChangeHandler::onItemIconChange(Lcom/eemi/ext4j/client/events/menu/ItemIconChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ItemIconChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemTextChangeHandler(ItemTextChangeHandler handler)/*-{
		...
		var fn = function(m, oldText, newText, e) {
			var menu = @com.eemi.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.ItemTextChangeEvent::new(Lcom/eemi/ext4j/client/ui/MenuItem;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,oldText,newText,e);
			handler.@com.eemi.ext4j.client.events.menu.ItemTextChangeHandler::onItemTextChange(Lcom/eemi/ext4j/client/events/menu/ItemTextChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ItemTextChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
