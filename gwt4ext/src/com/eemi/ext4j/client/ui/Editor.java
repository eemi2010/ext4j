...
import com.eemi.ext4j.client.events.editor.BeforeCompleteHandler;
import com.eemi.ext4j.client.events.editor.BeforeStartEditHandler;
import com.eemi.ext4j.client.events.editor.CancelEditHandler;
import com.eemi.ext4j.client.events.editor.CompleteHandler;
import com.eemi.ext4j.client.events.editor.EditorBeforeCompleteHandler;
import com.eemi.ext4j.client.events.editor.EditorBeforeStartEditHandler;
import com.eemi.ext4j.client.events.editor.SpecialKeyHandler;
...
public class Editor extends Container {
    ...
    private static native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.Editor::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void cancelEdit(boolean remainVisible) /*-{
		var editor = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		editor.cancelEdit();
    }-*/;
    ...
    public native HandlerRegistration addBeforeCompleteHandler(BeforeCompleteHandler handler)/*-{
		...
		var fn = function(editor, value, olValue, e) {
			var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.eemi.ext4j.client.events.editor.BeforeCompleteEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm,value, oldValue,e)
			handler.@com.eemi.ext4j.client.events.editor.BeforeCompleteHandler::onBeforeCompete(Lcom/eemi/ext4j/client/events/editor/BeforeCompleteEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.BeforeCompleteEvent::EVENT_NAME;
    ...
    public native void addBeforeCompleteHandler(EditorBeforeCompleteHandler handler)/*-{
		...
		compoenent
				.addListener(
						@com.eemi.ext4j.client.events.Event::BEFORE_COMPLETE,
						$entry(function(editor, value, olValue) {
							var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
							return handler.@com.eemi.ext4j.client.events.editor.EditorBeforeCompleteHandler::onEvent(Lcom/eemi/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;)(cpm,value,OldValue);
						}));
    ...
    public native HandlerRegistration addBeforeStartEditHandler(BeforeStartEditHandler handler)/*-{
		...
		var fn = function(editor, el, value, e) {
			var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var element = @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var event = @com.eemi.ext4j.client.events.editor.BeforeStartEditEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Lcom/eemi/ext4j/client/core/ExtElement;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm, element, value, e);
			handler.@com.eemi.ext4j.client.events.editor.BeforeStartEditHandler::onBeforeStartEdit(Lcom/eemi/ext4j/client/events/editor/BeforeStartEditEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.BeforeStartEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeStartEditHandler(EditorBeforeStartEditHandler handler)/*-{
		...
		compoenent
				.addListener(
						@com.eemi.ext4j.client.events.Event::BEFORE_START_EDIT,
						$entry(function(editor, el, value) {
							var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
							var element = @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
							handler.@com.eemi.ext4j.client.events.editor.EditorBeforeStartEditHandler::onEvent(Lcom/eemi/ext4j/client/ui/Editor;Lcom/eemi/ext4j/client/core/ExtElement;Ljava/lang/Object;)(cmp,element,value);
						}));
    }-*/;
    ...
    public native HandlerRegistration addCancelEditHandler(CancelEditHandler handler)/*-{
		...
		var fn = function(editor, value, startValue, e) {
			var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.eemi.ext4j.client.events.editor.CancelEditEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp, value, startValue, e);
			handler.@com.eemi.ext4j.client.events.editor.CancelEditHandler::onCancelEdit(Lcom/eemi/ext4j/client/events/editor/CancelEditEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.CancelEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCompleteEditHandler(CompleteHandler handler)/*-{
		...
		var fn = function(editor, value, startValue, e) {
			var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var event = @com.eemi.ext4j.client.events.editor.CompleteEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Ljava/lang/Object;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp, value, startValue, e);
			handler.@com.eemi.ext4j.client.events.editor.CompleteHandler::onComplete(Lcom/eemi/ext4j/client/events/editor/CompleteEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.CompleteEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSpecialKeyHandler(SpecialKeyHandler handler)/*-{
		...
		var fn = function(editor, f, e) {
			...
			var event = @com.eemi.ext4j.client.events.editor.SpecialKeyEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Lcom/eemi/ext4j/client/field/FieldBase;Lcom/google/gwt/core/client/JavaScriptObject;)(cmp,field,e);
			handler.@com.eemi.ext4j.client.events.editor.SpecialKeyHandler::onSpecialKey(Lcom/eemi/ext4j/client/events/editor/SpecialKeyEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.SpecialKeyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addStartEditHandler(StartEditHandler handler)/*-{
		...
		var fn = function(editor, el, value, e) {
			var cmp = @com.eemi.ext4j.client.ui.Editor::new(Lcom/google/gwt/core/client/JavaScriptObject;)(editor);
			var element = @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var event = @com.eemi.ext4j.client.events.editor.StartEditEvent::new(Lcom/eemi/ext4j/client/ui/Editor;Lcom/eemi/ext4j/client/core/ExtElement;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(cpm, element, value, e);
			handler.@com.eemi.ext4j.client.events.editor.StartEditHandler::onStartEdit(Lcom/eemi/ext4j/client/events/editor/StartEditEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.editor.StartEditEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
