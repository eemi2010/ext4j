...
public class CycleButton extends SplitButton {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.CycleButton::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void toggleSelected() /*-{
		var cycleButton = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native void setMenu(Menu value) /*-{
		...
		button.menu = value.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
    }-*/;
    ...
    public native MenuItem getActiveItem() /*-{
		...
		return @com.eemi.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setActiveItem(MenuItem item) /*-{
		var button = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		button
				.setActiveItem(item.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()());
    }-*/;
     ...
     */
    public native HandlerRegistration addChangeHandler(com.eemi.ext4j.client.events.button.ChangeHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(b, m, e) {
			var button = @com.eemi.ext4j.client.ui.CycleButton::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menuItem = @com.eemi.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.button.ChangeEvent::new(Lcom/eemi/ext4j/client/ui/CycleButton;Lcom/eemi/ext4j/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(button, menuItem, e);
			handler.@com.eemi.ext4j.client.events.button.ChangeHandler::onChange(Lcom/eemi/ext4j/client/events/button/ChangeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.button.ChangeEvent::EVENT_NAME;
