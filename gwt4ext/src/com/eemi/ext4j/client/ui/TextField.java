...
import com.eemi.ext4j.client.events.form.KeyDownHandler;
import com.eemi.ext4j.client.events.form.KeyPressHandler;
import com.eemi.ext4j.client.events.form.KeyUpHandler;
...
public class TextField extends FieldBase implements HasValue<String>, IsEditor<LeafValueEditor<String>> {
    ...
    private static native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.TextField::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void insertAtCaret(String text) /*-{
		...
		if (start != null) {
			...
			this.@com.eemi.ext4j.client.ui.TextField::setCaretPosition(II)(textend,textend);
		} else {
			el.value += text;
		}
    }-*/;
     ...
     */
    public native HandlerRegistration addAutoSizeHandler(com.eemi.ext4j.client.events.form.AutoSizeHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(t, width, e) {
			var tf = @com.eemi.ext4j.client.ui.TextField::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.eemi.ext4j.client.events.form.AutoSizeEvent::new(Lcom/eemi/ext4j/client/ui/TextField;DLcom/google/gwt/core/client/JavaScriptObject;)(tf,width,e);
			handler.@com.eemi.ext4j.client.events.form.AutoSizeHandler::onAutoSize(Lcom/eemi/ext4j/client/events/form/AutoSizeEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.AutoSizeEvent::EVENT_NAME;
    ...
    public native HandlerRegistration AddKeyUpHandler(KeyUpHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tf = @com.eemi.ext4j.client.ui.TextField::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.eemi.ext4j.client.events.form.KeyUpEvent::new(Lcom/eemi/ext4j/client/ui/TextField;Lcom/google/gwt/core/client/JavaScriptObject;)(tf,e);
			handler.@com.eemi.ext4j.client.events.form.KeyUpHandler::onKeyUp(Lcom/eemi/ext4j/client/events/form/KeyUpEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.KeyUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration AddKeyPressHandler(KeyPressHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tf = @com.eemi.ext4j.client.ui.TextField::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.eemi.ext4j.client.events.form.KeyPressEvent::new(Lcom/eemi/ext4j/client/ui/TextField;Lcom/google/gwt/core/client/JavaScriptObject;)(tf,e);
			handler.@com.eemi.ext4j.client.events.form.KeyPressHandler::onKeyPress(Lcom/eemi/ext4j/client/events/form/KeyPressEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.KeyPressEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration AddKeyDownHandler(KeyDownHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tf = @com.eemi.ext4j.client.ui.TextField::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.eemi.ext4j.client.events.form.KeyDownEvent::new(Lcom/eemi/ext4j/client/ui/TextField;Lcom/google/gwt/core/client/JavaScriptObject;)(tf,e);
			handler.@com.eemi.ext4j.client.events.form.KeyDownHandler::onKeyDown(Lcom/eemi/ext4j/client/events/form/KeyDownEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.form.KeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
