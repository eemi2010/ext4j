...
public class LoadMask extends Component {
    ...
    public native void hide(ExtElement animateTarget) /*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		component
				.hide(animateTarget.@com.eemi.ext4j.client.core.ExtElement::getJsObj()());
    }-*/;
    ...
    public native void hide(ExtElement animateTarget, Function callback) /*-{
		...
		component
				.hide(
						animateTarget.@com.eemi.ext4j.client.core.ExtElement::getJsObj()(),
						$entry(function() {
							callback.@com.eemi.ext4j.client.core.Function::execute()();
						}));
    }-*/;
    ...
    public native void show(ExtElement animateTarget) /*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		component
				.show(animateTarget.@com.eemi.ext4j.client.core.ExtElement::getJsObj()());
    }-*/;
