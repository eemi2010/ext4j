...
import com.eemi.ext4j.client.events.menu.ClickHandler;
import com.eemi.ext4j.client.events.menu.MouseEnterHandler;
import com.eemi.ext4j.client.events.menu.MouseLeaveHandler;
import com.eemi.ext4j.client.events.menu.MouseOverHandler;
...
public class Menu extends Panel {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.Menu::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native Menu getParentMenu() /*-{
		var menu = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native void showBy(Component component) /*-{
		var menu = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var target = component.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		menu.showBy(target);
    }-*/;
    ...
    public native void doConstrain(ExtElement element) /*-{
		var menu = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		menu
				.doConstrain(element.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void doConstrain(Component element) /*-{
		var menu = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		menu
				.doConstrain(element.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()());
    }-*/;
    ...
    public native HandlerRegistration AddClickHandler(ClickHandler handler)/*-{
		...
		var fn = function(m, c, e) {
			...
			var comp = @com.eemi.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.eemi.ext4j.client.events.menu.ClickEvent::new(Lcom/eemi/ext4j/client/ui/Menu;Lcom/eemi/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,comp,e);
			handler.@com.eemi.ext4j.client.events.menu.ClickHandler::onClick(Lcom/eemi/ext4j/client/events/menu/ClickEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.ClickEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addMouseleaveHandler(MouseLeaveHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.MouseLeaveEvent::new(Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.eemi.ext4j.client.events.menu.MouseLeaveHandler::onMouseLeave(Lcom/eemi/ext4j/client/events/menu/MouseLeaveEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.MouseLeaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMouseEnterHandler(MouseEnterHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.eemi.ext4j.client.events.menu.MouseEnterEvent::new(Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.eemi.ext4j.client.events.menu.MouseEnterHandler::onMouseEnter(Lcom/eemi/ext4j/client/events/menu/MouseEnterEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.MouseEnterEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMouseOverHandler(MouseOverHandler handler)/*-{
		...
		var fn = function(m, c, e) {
			var menu = @com.eemi.ext4j.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var comp = @com.eemi.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.eemi.ext4j.client.events.menu.MouseOverEvent::new(Lcom/eemi/ext4j/client/ui/Menu;Lcom/eemi/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,comp,e);
			handler.@com.eemi.ext4j.client.events.menu.MouseOverHandler::onMouseOver(Lcom/eemi/ext4j/client/events/menu/MouseOverEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.MouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.eemi.ext4j.client.events.HandlerRegistration::new(Lcom/eemi/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
