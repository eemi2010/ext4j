...
import com.eemi.ext4j.client.events.messagebox.AlertCallback;
...
public class MessageBox {
    ...
    public static native void alert(String title, String message, AlertCallback cb) /*-{
		$wnd.Ext.MessageBox
				.alert(
						...
						message,
						function() {
							cb.@com.eemi.ext4j.client.events.messagebox.AlertCallback::execute()();
						});
    }-*/;
    ...
    public static native void confirm(String title, String message, ConfirmCallback cb) /*-{
		$wnd.Ext.Msg
				.confirm(
						...
						message,
						function(btnID) {
							cb.@com.eemi.ext4j.client.events.messagebox.ConfirmCallback::execute(Ljava/lang/String;)(btnID);
						});
    }-*/;
    ...
    public static native void show(MessageBoxConfig config) /*-{
		$wnd.Ext.Msg.show(config.@com.eemi.ext4j.client.core.JsObject::jsObj);
    }-*/;
