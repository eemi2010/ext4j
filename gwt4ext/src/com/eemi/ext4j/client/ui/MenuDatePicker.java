...
import com.eemi.ext4j.client.events.menu.DateSelectHandler;
...
public class MenuDatePicker extends Menu {
    ...
    private native void init()/*-{
		...
		@com.eemi.ext4j.client.ui.MenuDatePicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native DatePicker getPicker() /*-{
		...
		return @com.eemi.ext4j.client.ui.DatePicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addDateSelectHandler(DateSelectHandler handler)/*-{
		...
		var fn = function(m, date, e) {
			...
			var event = @com.eemi.ext4j.client.events.menu.DateSelectEvent::new(Lcom/eemi/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,date,e);
			handler.@com.eemi.ext4j.client.events.menu.DateSelectHandler::onDateSelect(Lcom/eemi/ext4j/client/events/menu/DateSelectEvent;)(event);
		};
		var eventName = @com.eemi.ext4j.client.events.menu.DateSelectEvent::EVENT_NAME;
