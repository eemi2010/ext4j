    ...
    private static native void init() /*-{
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyDrop = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var sourceJ = @com.eemi.ext4j.client.dd.DragSource::dragSourceInstance(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
				var dataJ = data == null || data == undefined ? null
						: @com.eemi.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.eemi.ext4j.client.dd.DropTarget::notifyDrop(Lcom/eemi/ext4j/client/dd/DragSource;Lcom/eemi/ext4j/client/core/EventObject;Lcom/eemi/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyEnter = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.eemi.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.eemi.ext4j.client.dd.DropTarget::notifyEnter(Lcom/eemi/ext4j/client/dd/DragSource;Lcom/eemi/ext4j/client/core/EventObject;Lcom/eemi/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyOut = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.eemi.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				ddJ.@com.eemi.ext4j.client.dd.DropTarget::notifyOut(Lcom/eemi/ext4j/client/dd/DragSource;Lcom/eemi/ext4j/client/core/EventObject;Lcom/eemi/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyOver = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.eemi.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.eemi.ext4j.client.dd.DropTarget::notifyOver(Lcom/eemi/ext4j/client/dd/DragSource;Lcom/eemi/ext4j/client/core/EventObject;Lcom/eemi/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
