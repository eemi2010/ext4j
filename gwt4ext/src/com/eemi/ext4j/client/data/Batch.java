...
import com.eemi.ext4j.client.data.handlers.BatchCallback;
import com.eemi.ext4j.client.data.proxy.Proxy;
...
public class Batch extends JsObject {
    ...
    public native Batch add(Operation opertion)/*-{
		var batch = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		batch.add(opertion.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    private native void addCallback(String event, BatchCallback cb)/*-{
		...
		batch
				.addEventListener(
						event,
						$entry(function(b, op) {
							var batch = @com.eemi.ext4j.client.data.Batch::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
							var operation = @com.eemi.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
							cb.@com.eemi.ext4j.client.data.handlers.BatchCallback::onEvent(Lcom/eemi/ext4j/client/data/Batch;Lcom/eemi/ext4j/client/data/Operation;)(batch,operation);
						}));
    }-*/;
