...
import com.eemi.ext4j.client.data.Operation;
...
public abstract class Proxy extends JsObject {
    ...
    public native void create(Operation operation, ActionCallback callback)/*-{
		var proxy = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		proxy
				.create(
						operation.@com.eemi.ext4j.client.core.JsObject::getJsObj()(),
						$entry(function(op) {
							var operation = @com.eemi.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
							callback.@com.eemi.ext4j.client.data.proxy.ActionCallback::onAction(Lcom/eemi/ext4j/client/data/Operation;)(operation);
						}));
    }-*/;
    ...
    public native Reader getReader()/*-{
		...
		return @com.eemi.ext4j.client.data.reader.Reader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;

    public native Writer getWriter()/*-{
		var proxy = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var obj = proxy.getReader();
		return @com.eemi.ext4j.client.data.writer.Writer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setReader(Reader reader)/*-{
		var proxy = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		proxy
				.setReader(reader.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;

    public native void setWriter(Writer writer)/*-{
		var proxy = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		proxy
				.setReader(writer.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
