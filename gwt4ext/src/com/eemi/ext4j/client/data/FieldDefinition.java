...
public abstract class FieldDefinition extends JsObject {

    static native void setConverter(JavaScriptObject config, Converter converter)/*-{
        config['convert'] = function(s) {
            return converter.@com.eemi.ext4j.client.data.Converter::format(Ljava/lang/String;)(s.toString());
        }
   }-*/;
    ...
    public String getName() {
        return JsoHelper.getAttribute(getJsObj(), "name");
    }
