 ...
 * the License.
 */
package com.eemi.ext4j.client.resizer;
...
import com.eemi.ext4j.client.events.resizer.BeforeResizeHandler;
import com.eemi.ext4j.client.events.resizer.ResizeHandler;
...
public class Resizer extends ObservableJso {
    ...
    public native ExtElement getEl()/*-{
		...
		var peer = obj.getEl();
		return @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(peer);
    }-*/;
    ...
    public native Component getTarget()/*-{
		var obj = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var peer = obj.getTarget();
		return @com.eemi.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(peer);
    }-*/;
		...
		obj
				.addListener(
						...
						$entry(function(r, w, h, e) {
							var resizer = @com.eemi.ext4j.client.resizer.Resizer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
							var event = @com.eemi.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.eemi.ext4j.client.events.resizer.ResizeHandler::onEvent(Lcom/eemi/ext4j/client/resizer/Resizer;DDLcom/eemi/ext4j/client/core/EventObject;)(resizer,w,h,event);
						}));
    }-*/;
    ...
    public native void addBeforeResizeHandler(BeforeResizeHandler handler)/*-{
		...
		obj
				.addListener(
						@com.eemi.ext4j.client.events.Event::BEFORE_RESIZE,
						$entry(function(r, w, h, e) {
							var resizer = @com.eemi.ext4j.client.resizer.Resizer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
							var event = @com.eemi.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.eemi.ext4j.client.events.resizer.BeforeResizeHandler::onEvent(Lcom/eemi/ext4j/client/resizer/Resizer;DDLcom/eemi/ext4j/client/core/EventObject;)(resizer,w,h,event);
						}));
    }-*/;
