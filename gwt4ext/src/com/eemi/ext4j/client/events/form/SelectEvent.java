...
import com.eemi.ext4j.client.ui.ComboBox;
...
public class SelectEvent extends EventObject {
    ...
    public SelectEvent(ComboBox source, BaseModel selection, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
