...
public class HandlerRegistration implements com.google.gwt.event.shared.HandlerRegistration {
    ...
    public native void unregister()/*-{
		var widget = this.@com.eemi.ext4j.client.events.HandlerRegistration::getWidget()();
		var widgetPeer = widget.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
		var event = this.@com.eemi.ext4j.client.events.HandlerRegistration::getEventName()();
		var fn = this.@com.eemi.ext4j.client.events.HandlerRegistration::getCallback()();
