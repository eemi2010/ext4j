...
public class DragStartEvent extends EventObject {
    ...
    public static String EVENT_NAME = Event.DRAG_START;
    ...
    public DragStartEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public DragStartEvent(MultiSlider source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
    }
