...
public class CallbackRegistration implements com.google.gwt.event.shared.HandlerRegistration {
    ...
    public native void unregister()/*-{
		var target = this.@com.eemi.ext4j.client.events.CallbackRegistration::getTarget()();
		var peer = target.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var event = this.@com.eemi.ext4j.client.events.CallbackRegistration::getEventName()();
		var fn = this.@com.eemi.ext4j.client.events.CallbackRegistration::getCallback()();
