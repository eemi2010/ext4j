...
public class CellMouseUpEvent extends EventObject {

    public static String EVENT_NAME = Event.CELL_MOUSE_UP;
    private Element td;
     ...
     */
    private static Type<CellMouseUpHandler> TYPE = new Type<CellMouseUpHandler>(EVENT_NAME, null);

    public static Type<CellMouseUpHandler> getType() {
        return TYPE;
    }

    public static Type<CellMouseUpHandler> getAssociatedType() {
        return TYPE;
    }
    ...
    public CellMouseUpEvent(TableView source, Element td, int cellIndex, BaseModel record, Element tr, int rowIndex,
