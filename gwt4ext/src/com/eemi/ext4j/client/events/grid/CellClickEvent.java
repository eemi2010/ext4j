...
public class CellClickEvent extends EventObject {
    ...
    public static String EVENT_NAME = Event.CELL_CLICK;
    private Element td;
     ...
     */
    private static Type<CellClickHandler> TYPE = new Type<CellClickHandler>(EVENT_NAME, null);

    public static Type<CellClickHandler> getType() {
        return TYPE;
    }

    public static Type<CellClickHandler> getAssociatedType() {
        return TYPE;
    }
    ...
    public CellClickEvent(TableView source, Element td, int cellIndex, BaseModel record, Element tr, int rowIndex,
