...
public abstract class ToolHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ToolHandler listener) /*-{
		return function(e, el, o, t) {
			...
			var extElement = @com.eemi.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var header = @com.eemi.ext4j.client.ui.PanelHeader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
			var tool = @com.eemi.ext4j.client.ui.Tool::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
			listener.@com.eemi.ext4j.client.events.panel.ToolHandler::onClick(Lcom/eemi/ext4j/client/core/EventObject;Lcom/eemi/ext4j/client/core/ExtElement;Lcom/eemi/ext4j/client/ui/PanelHeader;Lcom/eemi/ext4j/client/ui/Tool;)(eventObject,extElement,header,tool);
		};
    }-*/;
