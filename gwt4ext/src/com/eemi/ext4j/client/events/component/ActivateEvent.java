...
public class ActivateEvent extends EventObject {
    ...
    public ActivateEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public ActivateEvent(Component source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
