...
public class DestroyEvent extends EventObject {

    public static String EVENT_NAME = Event.DESTROY;
    ...
    public DestroyEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }

    public DestroyEvent(Component source, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
