 ...
 */
package com.eemi.ext4j.client.panel;
...
public class PanelProxy extends JsObject {
    ...
    public native ExtElement getGhost() /*-{
		...
		return @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(ghost);
    }-*/;
    ...
    public native Panel getPanel() /*-{
		...
		return panel == null || panel === undefined ? null
				: @com.eemi.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(panel);
    }-*/;

    public native ExtElement getProxy() /*-{
		var proxy = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var proxy = proxy.getProxy();
		return @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(proxy);
    }-*/;
