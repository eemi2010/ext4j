...
public class CSSRule extends JsObject {
    ...
    public native String getCssText() /*-{
		var rule = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		return rule.cssText;
    }-*/;
    ...
    public native CSSRule getParentRule()/*-{
		...
		if (parentRule == null || parentRule === undefined) {
			...
			return @com.eemi.ext4j.client.util.CSSRule::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(parentRule);
		}
    }-*/;
}
