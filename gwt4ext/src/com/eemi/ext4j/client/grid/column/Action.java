...
import com.eemi.ext4j.client.events.grid.ActionHandler;
import com.eemi.ext4j.client.tip.QuickTipManager;
...
public class Action extends JsObject {
    ...
    private native JavaScriptObject createHandler(ActionHandler handler)/*-{
		return function(grid, rowIndex, colIndex) {
			var gridPanel = @com.eemi.ext4j.client.ui.GridPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(grid);
			return renderer.@com.eemi.ext4j.client.events.grid.ActionHandler::onAction(Lcom/eemi/ext4j/client/ui/GridPanel;II)(grindPanel,rowIndex,colIndex);
		};
    }-*/;
