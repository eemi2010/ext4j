...
import com.eemi.ext4j.client.events.grid.BeforeEditHandler;
import com.eemi.ext4j.client.events.grid.EditHandler;
...
public class Editing extends AbstractPlugin {
    ...
    public native void addBeforeEditHandler(BeforeEditHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.eemi.ext4j.client.events.Event::BEFORE_EDIT,
						$entry(function(p, e) {
							var editing = @com.eemi.ext4j.client.grid.plugin.Editing::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
							var event = @com.eemi.ext4j.client.events.grid.GridEditEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.eemi.ext4j.client.events.grid.BeforeEditHandler::onEvent(Lcom/eemi/ext4j/client/grid/plugin/Editing;Lcom/eemi/ext4j/client/events/grid/GridEditEvent;)(editing,event);
						}));
    }-*/;
    ...
    public native void startEdit(BaseModel model, GridColumn column)/*-{
		var peer = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		peer.startEdit(
				model.@com.eemi.ext4j.client.core.JsObject::getJsObj()(),
				column.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
		...
		peer
				.addEventListener(
						...
						$entry(function(p, e) {
							var editing = @com.eemi.ext4j.client.grid.plugin.Editing::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
							var event = @com.eemi.ext4j.client.events.grid.GridEditEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.eemi.ext4j.client.events.grid.EditHandler::onEvent(Lcom/eemi/ext4j/client/grid/plugin/Editing;Lcom/eemi/ext4j/client/events/grid/GridEditEvent;)(editing,event);
						}));
    }-*/;
