 ...
 * the License.
 */
package com.eemi.ext4j.client.draw;
...
import com.eemi.ext4j.client.dd.DragSource;
...
public class Sprite extends JsObject {
    ...
    public native DragSource getDragSource()/*-{
		...
		var dd = jso.dd;
		return @com.eemi.ext4j.client.dd.DragSource::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dd);
    }-*/;
