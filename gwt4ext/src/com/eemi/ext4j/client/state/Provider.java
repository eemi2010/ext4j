 ...
 */
package com.eemi.ext4j.client.state;

import com.eemi.ext4j.client.core.JsObject;
import com.eemi.ext4j.client.events.state.StateChangeHandler;
...
public abstract class Provider extends JsObject {
    ...
    public native void clear(String name) /*-{
		var provider = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		provider.clear(name);
    }-*/;
			...
			component
					.addListener(
							...
							$entry(function(p, k, v) {
								var provider = @com.eemi.ext4j.client.state.CookieProvider::new(Lcom/eemi/ext4j/client/state/CookieProviderConfig;)(provider);
								handler.@com.eemi.ext4j.client.events.state.StateChangeHandler::onEvent(Lcom/eemi/ext4j/client/state/Provider;Ljava/lang/String;Ljava/lang/Object;)(providre,k,v);
							}));
		}
