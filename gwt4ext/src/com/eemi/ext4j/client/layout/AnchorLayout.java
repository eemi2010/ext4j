...
public class AnchorLayout extends ContainerLayout {
    ...
    public native JavaScriptObject getContainerAttributes() /*-{
		if (this.@com.eemi.ext4j.client.layout.AnchorLayout::width != -1) {
			return {
				anchorSize : {
					width : this.@com.eemi.ext4j.client.layout.AnchorLayout::width,
					height : this.@com.eemi.ext4j.client.layout.AnchorLayout::height
				}
			};
		} else {
			return {};
