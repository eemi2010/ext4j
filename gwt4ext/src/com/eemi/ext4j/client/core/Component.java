...
public abstract class Component extends AbstractComponent implements Observable {
     ...
     */
    public native HandlerRegistration addAddedHandler(com.eemi.ext4j.client.events.component.AddedHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
     ...
     * at its initial size.
     */
    public native HandlerRegistration addBoxReadyHandler(com.eemi.ext4j.client.events.component.BoxReadyHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.Component::getOrCreateJsObj()();
