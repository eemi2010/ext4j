...
import com.eemi.ext4j.client.events.ElementHandlerRegistration;
import com.eemi.ext4j.client.events.element.EventHandler;
import com.eemi.ext4j.client.fx.anim.Animation;
import com.eemi.ext4j.client.fx.anim.FadeIn;
import com.eemi.ext4j.client.fx.anim.FadeOut;
import com.eemi.ext4j.client.fx.anim.HighLight;
...
public class ExtElement extends DomElement {
    ...
    public static native ExtElement fly(String id)/*-{
		...
		return elem == null || elem === undefined ? null
				: @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
    }-*/;
    ...
    public native ExtElement appendChild(ExtElement child) /*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem
				.appendChild(child.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native ExtElement boxWrap() /*-{
		...
		return @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(wrap);
    }-*/;
    ...
    public native ExtElement createChild(DomConfig config) /*-{
		...
		var childJ = @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
		return childJ;
    }-*/;
    ...
    public native ExtElement createProxy(DomConfig config) /*-{
		...
		var proxyJ = @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(proxy);
		return proxyJ;
    }-*/;
    ...
    public native ExtElement createProxy(String cls) /*-{
		...
		var toReturn = @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native Element fadeIn(FadeIn config) /*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem.fadeIn(config.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native Element fadeOut(FadeOut config) /*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem.fadeOut(config.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native int[] getAlignToXY(Element element, String anchorPosition) /*-{
		...
		return @com.eemi.ext4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)(arrJS);
    }-*/;
    ...
    public native int[] getAlignToXY(Element element, String anchorPosition, int[] offesets) /*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var offsetsJS = @com.eemi.ext4j.client.core.JsoHelper::convertToJavaScriptArray([I)(offesets);
    ...
    public native int getBorderWidth(Side side)/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var sideJS = side.@com.eemi.ext4j.client.core.Side::getSide()();
    ...
    public native Box getBox()/*-{
		...
		return @com.eemi.ext4j.client.core.Box::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(boxJS);
    }-*/;
    ...
    public native Element getDom()/*-{
		var element = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var dom = element.dom;
    ...
    public native ExtElement next()/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var obj = elem.next();
		return @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native int[] getScroll()/*-{
		...
		return @com.eemi.ext4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)([scroll.left, scroll.top]);
    }-*/;
    ...
    public native Size getSize()/*-{
		...
		return @com.eemi.ext4j.client.core.Size::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(sizeJS);
    }-*/;
    ...
    public native ExtElement mask()/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		var me = elem.mask();
		return @com.eemi.ext4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(me);
    }-*/;
    ...
    public native ExtElement puff(FadeOut config)/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem.puff(config.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native Element[] query(String selector)/*-{
		...
		return elemsJS == null || elemsJS === undefined ? null
				: @com.eemi.ext4j.client.core.JsoHelper::toElementArray(Lcom/google/gwt/core/client/JavaScriptObject;)(elemsJS);
    }-*/;
    ...
    public native CompositeElement select(String selector, boolean unique)/*-{
		...
		if (unique) {
			...
			return ceJS == null || ceJS === undefined ? null
					: @com.eemi.ext4j.client.core.CompositeElementLite::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(ceJS);
		}
    }-*/;
    ...
    public native int[] translatePoints(int x, int y)/*-{
		...
		return @com.eemi.ext4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)([leftTopJS.left, leftTopJS.top]);
    }-*/;
    ...
    public native ExtElement setStyle(StyleConfig style)/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem.setStyle(style.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native ExtElement setWidth(String value, Animation animation)/*-{
		var elem = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		elem.setWidth(value,
				animation.@com.eemi.ext4j.client.core.JsObject::getJsObj()());
		return this;
    }-*/;
    ...
    public native ElementHandlerRegistration addHandler(String event, EventHandler handler)/*-{
		var component = this.@com.eemi.ext4j.client.core.ExtElement::getJsObj()();
		var fn = function(event, el) {
			var eventObject = @com.eemi.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			handler.@com.eemi.ext4j.client.events.element.EventHandler::onEvent(Lcom/eemi/ext4j/client/core/EventObject;Lcom/google/gwt/dom/client/Element;)(eventObject,el);
		};
		component.addListener(event, fn);
		var toReturn = @com.eemi.ext4j.client.events.ElementHandlerRegistration::new(Lcom/eemi/ext4j/client/core/ExtElement;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,event,fn);
		return toReturn;
