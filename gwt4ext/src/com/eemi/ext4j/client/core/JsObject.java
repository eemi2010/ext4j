...
public abstract class JsObject {
    ...
    public native String[] getProperties() /*-{
		var jsObj = this.@com.eemi.ext4j.client.core.JsObject::getJsObj()();
		return @com.eemi.ext4j.client.core.JsoHelper::getProperties(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
    }-*/;
