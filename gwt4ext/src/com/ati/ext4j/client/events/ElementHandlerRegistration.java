...
public class ElementHandlerRegistration implements
	...
	public native void unregister()/*-{
		var widget = this.@com.ati.ext4j.client.events.ElementHandlerRegistration::getElement()();
		var widgetPeer = widget.@com.ati.ext4j.client.core.ExtElement::getJsObj()();
		var event = this.@com.ati.ext4j.client.events.ElementHandlerRegistration::getEventName()();
		var fn = this.@com.ati.ext4j.client.events.ElementHandlerRegistration::getCallback()();
