...
import com.ati.ext4j.client.ui.TablePanel;
...
public class GridEditEvent extends JsObject {
    ...
    public native TablePanel getGrid() /*-{
		var e = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var grid = e.grid;
		return @com.ati.ext4j.client.ui.GridPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(grid);
    }-*/;

    public native BaseModel getRecord() /*-{
		var e = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var grid = e.record;
		return @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(grid);
    }-*/;
    ...
    public native GridColumn getColumn() /*-{
		var e = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var obj = e.column;
		return @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
