...
public class MouseOverEvent extends EventObject {
    ...
    public static String EVENT_NAME = Event.MOUSE_OVER;
     ...
     */
    private static Type<MouseOverHandler> TYPE = new Type<MouseOverHandler>(EVENT_NAME, null);

    public static Type<MouseOverHandler> getType() {
        return TYPE;
    }

    public static Type<MouseOverHandler> getAssociatedType() {
        return TYPE;
    }
    ...
    public MouseOverEvent(Menu source, Component component, JavaScriptObject nativeEvent) {
        super(nativeEvent);
        this.source = source;
