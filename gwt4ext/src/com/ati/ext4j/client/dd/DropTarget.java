    ...
    private static native void init() /*-{
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyDrop = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var sourceJ = @com.ati.ext4j.client.dd.DragSource::dragSourceInstance(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
				var dataJ = data == null || data == undefined ? null
						: @com.ati.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.ati.ext4j.client.dd.DropTarget::notifyDrop(Lcom/ati/ext4j/client/dd/DragSource;Lcom/ati/ext4j/client/core/EventObject;Lcom/ati/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyEnter = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.ati.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.ati.ext4j.client.dd.DropTarget::notifyEnter(Lcom/ati/ext4j/client/dd/DragSource;Lcom/ati/ext4j/client/core/EventObject;Lcom/ati/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyOut = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.ati.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				ddJ.@com.ati.ext4j.client.dd.DropTarget::notifyOut(Lcom/ati/ext4j/client/dd/DragSource;Lcom/ati/ext4j/client/core/EventObject;Lcom/ati/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
		...
		$wnd.Ext.dd.DropTarget.prototype.notifyOver = function(source, e, data) {
			...
			if (ddJ != null) {
				...
				var dataJ = data == null || data == undefined ? null
						: @com.ati.ext4j.client.dd.DragData::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(data);
				return ddJ.@com.ati.ext4j.client.dd.DropTarget::notifyOver(Lcom/ati/ext4j/client/dd/DragSource;Lcom/ati/ext4j/client/core/EventObject;Lcom/ati/ext4j/client/dd/DragData;)(sourceJ, eJ, dataJ);
			}
		}
