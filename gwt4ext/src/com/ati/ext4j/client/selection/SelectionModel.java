...
import com.ati.ext4j.client.core.ObservableJso;
...
import com.ati.ext4j.client.events.selection.DeselectHandler;
import com.ati.ext4j.client.events.selection.FocusChangeHandler;
import com.ati.ext4j.client.events.selection.SelectHandler;
import com.ati.ext4j.client.events.selection.SelectionChangeHandler;
import com.ati.ext4j.client.util.MixedCollection;
...
public class SelectionModel extends ObservableJso {
    ...
    public native MixedCollection getSelected()/*-{
		...
		return @com.ati.ext4j.client.util.MixedCollection::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native CellPosition getCurrentPosition()/*-{
		...
		return @com.ati.ext4j.client.selection.CellPosition::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void bindStore(Store store)/*-{
		var jso = this.@com.ati.ext4j.client.core.JsObject::jsObj;
		jso.bindStore(store.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void deselect(List<BaseModel> elements)/*-{
		var jso = this.@com.ati.ext4j.client.core.JsObject::jsObj;
		var peers = @com.ati.ext4j.client.data.BaseModel::fromList(Ljava/util/List;)(elements);
		jso.deselect(peers);
    }-*/;
    ...
    public native List<BaseModel> getSelection()/*-{
		...
		return @com.ati.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Store getStore()/*-{
		...
		return @com.ati.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native boolean isFocused(BaseModel model)/*-{
		var jso = this.@com.ati.ext4j.client.core.JsObject::jsObj;
		return jso
				.isFocused(model.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native boolean isSelected(BaseModel model)/*-{
		var jso = this.@com.ati.ext4j.client.core.JsObject::jsObj;
		return jso
				.isSelected(model.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void setLastFocused(BaseModel record)/*-{
		...
		if (jso) {
			jso
					.setLastFocused(record.@com.ati.ext4j.client.core.JsObject::jsObj);
		}
    }-*/;
    ...
    public native CallbackRegistration addFocusChangeHandler(FocusChangeHandler handler)/*-{
		...
		var fn = function(model, os, ns, e) {
			...
			var oldSelected = @com.ati.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(os);
			var newSelected = @com.ati.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ns);

			var event = @com.ati.ext4j.client.events.selection.FocusChangeEvent::new(Lcom/ati/ext4j/client/selection/SelectionModel;Lcom/ati/ext4j/client/data/TableItem;Lcom/ati/ext4j/client/data/TableItem;Lcom/google/gwt/core/client/JavaScriptObject;)(sm, oldFocused, newFocused);
			handler.@com.ati.ext4j.client.events.selection.FocusChangeHandler::onFocusChange(Lcom/ati/ext4j/client/events/selection/FocusChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.selection.FocusChangeEvent::EVENT_NAME;
    ...
    public native CallbackRegistration addSelectionChangeHandler(SelectionChangeHandler handler)/*-{
		...
		var fn = function(model, selection, e) {
			var sm = @com.ati.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var items = @com.ati.ext4j.client.data.TableItem::fromArray(Lcom/google/gwt/core/client/JavaScriptObject;)(selection);

			var event = @com.ati.ext4j.client.events.selection.SelectionChangeEvent::new(Lcom/ati/ext4j/client/selection/SelectionModel;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(sm,item,e);
			handler.@com.ati.ext4j.client.events.selection.SelectionChangeHandler::onSelectionChange(Lcom/ati/ext4j/client/events/selection/SelectionChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.selection.SelectionChangeEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.CallbackRegistration::new(Lcom/ati/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    public native CallbackRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(model, record, row, column, e) {
			...
			var event = @com.ati.ext4j.client.events.selection.SelectEvent::new(Lcom/ati/ext4j/client/selection/SelectionModel;Lcom/ati/ext4j/client/data/BaseModel;IILcom/google/gwt/core/client/JavaScriptObject;)(sm,model,row,column,e);
			handler.@com.ati.ext4j.client.events.selection.SelectHandler::onSelect(Lcom/ati/ext4j/client/events/selection/SelectEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.selection.SelectEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.CallbackRegistration::new(Lcom/ati/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    public native CallbackRegistration addDeselectHandler(DeselectHandler handler)/*-{
		...
		var fn = function(model, record, row, column, e) {
			var sm = @com.ati.ext4j.client.selection.SelectionModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(model);
			var model = @com.ati.ext4j.client.data.BaseModel::from(Lcom/google/gwt/core/client/JavaScriptObject;)(record);
			var event = @com.ati.ext4j.client.events.selection.DeselectEvent::new(Lcom/ati/ext4j/client/selection/SelectionModel;Lcom/ati/ext4j/client/data/BaseModel;IILcom/google/gwt/core/client/JavaScriptObject;)(sm,model,row,column,e);
			handler.@com.ati.ext4j.client.events.selection.DeselectHandler::onDeselect(Lcom/ati/ext4j/client/events/selection/DeselectEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.selection.DeselectEvent::EVENT_NAME;
		obj.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.CallbackRegistration::new(Lcom/ati/ext4j/client/core/JsObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName, fn);
		return toReturn;
    }-*/;
    ...
    private native void _select(NodeInterface record)/*-{
		var jso = this.@com.ati.ext4j.client.core.JsObject::jsObj;
		var obj = record.@com.ati.ext4j.client.core.JsObject::jsObj;
		if (jso && obj) {
			jso.select(obj);
		}
    }-*/;
