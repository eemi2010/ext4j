...
import com.ati.ext4j.client.events.state.StateChangeHandler;
...
public abstract class Provider extends JsObject {
    ...
    public native void clear(String name) /*-{
		var provider = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		provider.clear(name);
    }-*/;
			...
			component
					.addListener(
							...
							$entry(function(p, k, v) {
								var provider = @com.ati.ext4j.client.state.CookieProvider::new(Lcom/ati/ext4j/client/state/CookieProviderConfig;)(provider);
								handler.@com.ati.ext4j.client.events.state.StateChangeHandler::onEvent(Lcom/ati/ext4j/client/state/Provider;Ljava/lang/String;Ljava/lang/Object;)(providre,k,v);
							}));
		}
