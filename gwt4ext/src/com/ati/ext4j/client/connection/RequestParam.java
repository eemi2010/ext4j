 ...
 * 
 * @see com.ati.ext4j.client.connection.Connection#request(RequestParam)
 */
public class RequestParam extends JsObject {
    ...
    public native void setRequestHandler(RequestHandler callback)/*-{
		...
		obj.success = $entry(function(r) {
			var response = @com.ati.ext4j.client.connection.Response::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			callback.@com.ati.ext4j.client.connection.RequestHandler::onSuccess(Lcom/ati/ext4j/client/connection/Response;)(response);
		});
		obj.failure = $entry(function(r) {
			var response = @com.ati.ext4j.client.connection.Response::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			callback.@com.ati.ext4j.client.connection.RequestHandler::onError(Lcom/ati/ext4j/client/connection/Response;)(response);
		});
    }-*/;
    ...
    public native void setRequestCallback(RequestCallback callback)/*-{
		...
		obj.callback = $entry(function(o, success, r) {
			var response = @com.ati.ext4j.client.connection.Response::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			callback.@com.ati.ext4j.client.connection.RequestCallback::onCallback(Lcom/google/gwt/core/client/JavaScriptObject;ZLcom/ati/ext4j/client/connection/Response;)(o,success,response);
		});
