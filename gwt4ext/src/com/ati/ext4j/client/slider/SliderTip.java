 ...
 */
package com.ati.ext4j.client.slider;
...
public class SliderTip extends Tip {
    ...
    protected SliderTip(JavaScriptObject obj) {
        super(obj);
    }
    ...
    public native void showBy(ExtElement el)/*-{
		...
		if (component) {
			component
					.showBy(el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
		}
     ...
     * 
     */
    public static SliderTip cast(Component component) {
        return new SliderTip(component.getOrCreateJsObj());
    }
