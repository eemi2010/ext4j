...
import com.ati.ext4j.client.data.handlers.OperationCallback;
import com.ati.ext4j.client.util.Filter;
...
public class OperationConfig extends BaseConfig {
    ...
    public native void setFilters(List<Filter> filters)/*-{
		...
		obj.filters = @com.ati.ext4j.client.util.Filter::fromList(Ljava/util/List;)(filters);
    }-*/;
    ...
    public native void setSorters(List<Sorter> sorters)/*-{
		var obj = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		obj.filters = @com.ati.ext4j.client.util.Sorter::fromList(Ljava/util/List;)(sorters);
    }-*/;

    public native void setCallback(OperationCallback cb)/*-{
		var obj = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		obj.callback = $entry(function(r, op, success) {
			var data = @com.ati.ext4j.client.data.BaseModel::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
			var operation = @com.ati.ext4j.client.data.Operation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(op);
			cb.@com.ati.ext4j.client.data.handlers.OperationCallback::onEvent(Ljava/util/List;Lcom/ati/ext4j/client/data/Operation;Z)(data,operation,success);
		});
    }-*/;
