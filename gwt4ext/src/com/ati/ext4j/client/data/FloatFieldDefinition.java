...
public class FloatFieldDefinition extends FieldDefinition {
    ...
    /**
     * Construct a new FloatFieldDefinition.
     * 
     * @param name
     *            the field name
     */
    public FloatFieldDefinition(String name) {
        this(name, null, null);
    }
     ...
     *            reading from XML
     */
    public FloatFieldDefinition(String name, String mapping) {
     ...
     *            reading from XML
     */
    public FloatFieldDefinition(String name, int mapping) {
        this(name, mapping, null);
    }
     ...
     *            the field converter
     */
    public FloatFieldDefinition(String name, String mapping, Converter converter) {
     ...
     *            the field converter
     */
    public FloatFieldDefinition(String name, int mapping, Converter converter) {
    ...
    private static JavaScriptObject create(String name, String mapping, Converter converter) {
        ...
        JsoHelper.setAttribute(jsObj, "type", "float");
        if (mapping != null)
