...
import com.ati.ext4j.client.data.handlers.BubbleHandler;
import com.ati.ext4j.client.data.handlers.NodeQueryHandler;
		...
		if (jso) {
			jso
					.bubble($entry(function(node) {
						var nodeObject = @com.ati.ext4j.client.data.NodeInterface::new(Lcom/google/gwt/core/client/JavaScriptObject;)(node);
						handler.@com.ati.ext4j.client.data.handlers.BubbleHandler::onNodeTraverse(Lcom/ati/ext4j/client/data/NodeInterface;)(nodeObject);
					}));
		}
		...
		var obj = jso
				.findChildBy(
						$entry(function(node) {
							...
							var nodeObject = @com.ati.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(node);
							return handler.@com.ati.ext4j.client.data.handlers.NodeQueryHandler::onNodeTraversal(Lcom/ati/ext4j/client/data/TableItem;)(nodeObject);
						}), this, true);
