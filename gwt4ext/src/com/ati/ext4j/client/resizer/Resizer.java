...
import com.ati.ext4j.client.events.resizer.BeforeResizeHandler;
import com.ati.ext4j.client.events.resizer.ResizeHandler;
...
public class Resizer extends ObservableJso {
    ...
    public native ExtElement getEl()/*-{
		...
		var peer = obj.getEl();
		return @com.ati.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(peer);
    }-*/;
    ...
    public native Component getTarget()/*-{
		var obj = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var peer = obj.getTarget();
		return @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(peer);
    }-*/;
		...
		obj
				.addListener(
						...
						$entry(function(r, w, h, e) {
							var resizer = @com.ati.ext4j.client.resizer.Resizer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
							var event = @com.ati.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.ati.ext4j.client.events.resizer.ResizeHandler::onEvent(Lcom/ati/ext4j/client/resizer/Resizer;DDLcom/ati/ext4j/client/core/EventObject;)(resizer,w,h,event);
						}));
    }-*/;
    ...
    public native void addBeforeResizeHandler(BeforeResizeHandler handler)/*-{
		...
		obj
				.addListener(
						@com.ati.ext4j.client.events.Event::BEFORE_RESIZE,
						$entry(function(r, w, h, e) {
							var resizer = @com.ati.ext4j.client.resizer.Resizer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(r);
							var event = @com.ati.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.ati.ext4j.client.events.resizer.BeforeResizeHandler::onEvent(Lcom/ati/ext4j/client/resizer/Resizer;DDLcom/ati/ext4j/client/core/EventObject;)(resizer,w,h,event);
						}));
    }-*/;
