 ...
 * the License.
 */
package com.ati.ext4j.client.field;
...
import com.ati.ext4j.client.events.form.ChangeHandler;
import com.ati.ext4j.client.events.form.DirtyChangeHandler;
import com.ati.ext4j.client.events.form.SpecialKeyHandler;
import com.ati.ext4j.client.events.form.ValidityChangeHandler;
import com.ati.ext4j.client.events.form.WritableChangeHandler;
...
public class FieldBase extends Field {
    ...
    public native HandlerRegistration addSpecialKeyHandler(SpecialKeyHandler handler)/*-{
		...
		var fn = function(f, e) {
			...
			var event = @com.ati.ext4j.client.events.form.SpecialKeyEvent::new(Lcom/ati/ext4j/client/field/FieldBase;Lcom/google/gwt/core/client/JavaScriptObject;)(field,e);
			handler.@com.ati.ext4j.client.events.form.SpecialKeyHandler::onSpecialKey(Lcom/ati/ext4j/client/events/form/SpecialKeyEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.SpecialKeyEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addWritableChangeHandler(WritableChangeHandler handler)/*-{
		...
		var fn = function(f, read, e) {
			var field = @com.ati.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.form.WritableChangeEvent::new(Lcom/ati/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field, read, e);
			handler.@com.ati.ext4j.client.events.form.WritableChangeHandler::onWritableChange(Lcom/ati/ext4j/client/events/form/WritableChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.WritableChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(f, newValue, oldValue, e) {
			...
			var field = @com.ati.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.form.ChangeEvent::new(Lcom/ati/ext4j/client/field/FieldBase;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(field,nV,oV,e);
			handler.@com.ati.ext4j.client.events.form.ChangeHandler::onChange(Lcom/ati/ext4j/client/events/form/ChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDirtyChangeHandler(DirtyChangeHandler handler)/*-{
		...
		var fn = function(f, isDirty, e) {
			var field = @com.ati.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.form.DirtyChangeEvent::new(Lcom/ati/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isDirty,e);
			handler.@com.ati.ext4j.client.events.form.DirtyChangeHandler::onDirtyChange(Lcom/ati/ext4j/client/events/form/DirtyChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.DirtyChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addValidityChangeHandler(ValidityChangeHandler handler)/*-{
		...
		var fn = function(f, isValid, e) {
			var field = @com.ati.ext4j.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.form.ValidityChangeEvent::new(Lcom/ati/ext4j/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isValid,e);
			handler.@com.ati.ext4j.client.events.form.ValidityChangeHandler::onValidityChange(Lcom/ati/ext4j/client/events/form/ValidityChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.ValidityChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
