...
import com.ati.ext4j.client.chart.HighLighter;
import com.ati.ext4j.client.chart.laf.ChartTooltip;
import com.ati.ext4j.client.chart.laf.Label;
import com.ati.ext4j.client.chart.laf.Style;
import com.ati.ext4j.client.chart.marker.MarkerConfig;
import com.ati.ext4j.client.chart.series.renderers.SeriesRenderer;
...
import com.ati.ext4j.client.ui.ToolTip;
...
public abstract class AbstractSerie extends JsObject {
    ...
    public final native void setRenderer(SeriesRenderer renderer)/*-{
		...
		jso.renderer = function(sprite, record, attr, index, store) {
			...
			var s = @com.ati.ext4j.client.draw.Sprite::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sprite);
			var st = @com.ati.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
			return renderer.@com.ati.ext4j.client.chart.series.renderers.SeriesRenderer::onRender(Lcom/ati/ext4j/client/draw/Sprite;Lcom/ati/ext4j/client/data/BaseModel;Lcom/ati/ext4j/client/chart/laf/BarAttribute;ILcom/ati/ext4j/client/data/Store;)(s,model,attr, index,st);
		};
    }-*/;
