...
import com.ati.ext4j.client.events.grid.BeforeEditHandler;
import com.ati.ext4j.client.events.grid.EditHandler;
...
public class Editing extends AbstractPlugin {
    ...
    public native void addBeforeEditHandler(BeforeEditHandler handler)/*-{
		...
		peer
				.addEventListener(
						@com.ati.ext4j.client.events.Event::BEFORE_EDIT,
						$entry(function(p, e) {
							var editing = @com.ati.ext4j.client.grid.plugin.Editing::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
							var event = @com.ati.ext4j.client.events.grid.GridEditEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							return handler.@com.ati.ext4j.client.events.grid.BeforeEditHandler::onEvent(Lcom/ati/ext4j/client/grid/plugin/Editing;Lcom/ati/ext4j/client/events/grid/GridEditEvent;)(editing,event);
						}));
    }-*/;
    ...
    public native void startEdit(BaseModel model, GridColumn column)/*-{
		...
		peer.startEdit(
				...
				column.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
		...
		peer
				.addEventListener(
						...
						$entry(function(p, e) {
							var editing = @com.ati.ext4j.client.grid.plugin.Editing::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
							var event = @com.ati.ext4j.client.events.grid.GridEditEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.ati.ext4j.client.events.grid.EditHandler::onEvent(Lcom/ati/ext4j/client/grid/plugin/Editing;Lcom/ati/ext4j/client/events/grid/GridEditEvent;)(editing,event);
						}));
    }-*/;
