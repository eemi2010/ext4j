...
import com.ati.ext4j.client.events.grid.ActionColumnHandler;
...
public class ActionGridColumn extends GridColumn {
    ...
    public native void disableAction(ActionGridColumn index)/*-{
		var item = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		item
				.disableAction(index.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public native void disableAction(ActionGridColumn index, boolean silent)/*-{
		var item = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		item.disableAction(
				index.@com.ati.ext4j.client.core.JsObject::getJsObj()(),
				silent);
    }-*/;
    ...
    public native void enableAction(ActionGridColumn index)/*-{
		var item = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		item
				.enableAction(index.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    private native JavaScriptObject createHandler(ActionColumnHandler handler)/*-{
		return function(view, rowIndex, colIndex, item, e, m) {
			var view = @com.ati.ext4j.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(grid);
			var event = @com.ati.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			var model = @com.ati.ext4j.client.data.TableItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			return renderer.@com.ati.ext4j.client.events.grid.ActionColumnHandler::onAction(Lcom/ati/ext4j/client/ui/DataView;IILcom/google/gwt/core/client/JavaScriptObject;Lcom/ati/ext4j/client/core/EventObject;Lcom/ati/ext4j/client/data/TableItem;)(view,rowIndex, colIndex, item, event, model);
		};
    }-*/;
