...
import com.ati.ext4j.client.ui.BoxComponent;
...
public class WidgetComponent extends BoxComponent {
    ...
    private native void init()/*-{
		var widget = this.@com.ati.ext4j.client.core.WidgetComponent::w;
		var divID = this.@com.ati.ext4j.client.core.WidgetComponent::componentId;
		$wnd.Ext
				.define(
						'Ext.ux.WidgetComponent',
						{
							...
							listeners : {
								...
								afterRender : function(component) {
									//var widget = @com.ati.ext4j.client.core.WidgetComponent::get()();
									//alert(this.widget);
    ...
    public native void _setWidget(Widget w)/*-{
		var jso = this.@com.ati.ext4j.client.core.WidgetComponent::getOrCreateJsObj()();
		var id = jso.id;
    }-*/;
