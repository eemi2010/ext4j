...
import com.ati.ext4j.client.events.messagebox.ConfirmCallback;
import com.ati.ext4j.client.events.messagebox.PromptCallback;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * {@link com.ati.ext4j.client.ui.MessageBox} configuration class.
 * 
 * @see com.ati.ext4j.client.ui.MessageBox#show(MessageBoxConfig)
 */
public class MessageBoxConfig extends BaseConfig {
    ...
    public native void setCallback(PromptCallback cb)/*-{
		...
		config['fn'] = function(btnID, text) {
			...
			if (text === undefined || text == '')
				text = null;
			cb.@com.ati.ext4j.client.events.messagebox.PromptCallback::execute(Ljava/lang/String;Ljava/lang/String;)(btnID, text);
		};
    }-*/;
    ...
    public native void setCallback(ConfirmCallback callback)/*-{
		...
		jso.fn = function(btn) {
			callback.@com.ati.ext4j.client.events.messagebox.ConfirmCallback::execute(Ljava/lang/String;)(btn);
		}
    }-*/;
    ...
    public native void setButtonText(ButtonText value)/*-{
		var jso = this.@com.ati.ext4j.client.core.config.BaseConfig::getJsObj()();
		jso.buttonText = value.@com.ati.ext4j.client.core.config.ButtonText::getJsObj()();
    }-*/;
