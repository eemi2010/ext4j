...
import com.ati.ext4j.client.core.config.CallbackConfig;
...
public class EventManager {
    ...
    public static native String getId(ExtElement el)/*-{
		return $wnd.Ext.EventMananger
				.getId(el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native double getPageX(EventObject e)/*-{
		return $wnd.Ext.EventMananger
				.getPageX(e.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native JsArrayNumber getPageXY(EventObject e)/*-{
		return $wnd.Ext.EventMananger
				.getPageXY(e.el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native double getPageY(EventObject e)/*-{
		return $wnd.Ext.EventMananger
				.getPageY(e.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native Element getRelatedTarget(EventObject e)/*-{
		return $wnd.Ext.EventMananger
				.getRelatedTarget(e.el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native Element getTarget(EventObject e)/*-{
		return $wnd.Ext.EventMananger
				.getTarget(e.el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native void preventDefault(EventObject event)/*-{
		$wnd.Ext.EventMananger
				.preventDefault(event.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native void purgeElemet(ExtElement el)/*-{
		$wnd.Ext.EventMananger
				.purgeElemet(el.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
    ...
    public static native void purgeElemet(ExtElement el, String eventName)/*-{
		$wnd.Ext.EventMananger.purgeElemet(
				el.@com.ati.ext4j.client.core.JsObject::getJsObj()(),
				eventName);
    }-*/;
    ...
    public static native void stopPropagation(EventObject event)/*-{
		$wnd.Ext.EventMananger
				.stopPropagation(event.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
