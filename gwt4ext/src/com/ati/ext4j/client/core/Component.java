...
import com.ati.ext4j.client.core.config.ComponentConfig;
import com.ati.ext4j.client.core.config.Dock;
import com.ati.ext4j.client.core.handlers.AbstractHandler;
...
import com.ati.ext4j.client.events.component.ActivateHandler;
import com.ati.ext4j.client.events.component.AfterRenderHandler;
import com.ati.ext4j.client.events.component.BeforeActivateHandler;
import com.ati.ext4j.client.events.component.BeforeDeactivateHandler;
import com.ati.ext4j.client.events.component.BeforeDestroyHandler;
import com.ati.ext4j.client.events.component.BeforeHideHandler;
import com.ati.ext4j.client.events.component.BeforeRenderHandler;
import com.ati.ext4j.client.events.component.BeforeShowHandler;
import com.ati.ext4j.client.events.component.BeforeStateRestoreHandler;
import com.ati.ext4j.client.events.component.BeforeStateSaveHandler;
import com.ati.ext4j.client.events.component.BlurHandler;
import com.ati.ext4j.client.events.component.DeactivateHandler;
import com.ati.ext4j.client.events.component.DestroyHandler;
import com.ati.ext4j.client.events.component.DisableHandler;
import com.ati.ext4j.client.events.component.EnableHandler;
import com.ati.ext4j.client.events.component.EventHandler;
import com.ati.ext4j.client.events.component.FocusHandler;
import com.ati.ext4j.client.events.component.HideHandler;
import com.ati.ext4j.client.events.component.LifeCycleHandler;
import com.ati.ext4j.client.events.component.MoveHandler;
import com.ati.ext4j.client.events.component.RemovedHandler;
import com.ati.ext4j.client.events.component.RenderHandler;
import com.ati.ext4j.client.events.component.ResizeHandler;
import com.ati.ext4j.client.events.component.ShowHandler;
import com.ati.ext4j.client.events.component.StateRestoreHandler;
import com.ati.ext4j.client.events.component.StateSaveHandler;
import com.ati.ext4j.client.events.component.VisualStateChangeHandler;
import com.ati.ext4j.client.fx.anim.Animation;
import com.ati.ext4j.client.grid.plugin.AbstractPlugin;
import com.ati.ext4j.client.ui.ComponentFactory;
import com.ati.ext4j.client.ui.Container;
import com.ati.ext4j.client.ui.LoadMask;
import com.ati.ext4j.client.ui.MessageBox;
import com.ati.ext4j.client.util.Region;
...
public abstract class Component extends AbstractComponent implements Observable {
	...
	public native void relayEvents(Component observable, JsArrayString events) /*-{
		...
		component
				.relayEvents(
						observable.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()(),
						events);
	}-*/;
	...
	public native void relayEvents(JsObject observable, JsArrayString events) /*-{
		...
		component.relayEvents(
				observable.@com.ati.ext4j.client.core.JsObject::getJsObj()(),
				events);
	}-*/;
	...
	public native Container getOwnerContainer() /*-{
		...
		return ct == null || ct === undefined ? null
				: @com.ati.ext4j.client.ui.Container::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
	}-*/;
	...
	public native boolean isRendered() /*-{
		var component = this.@com.ati.ext4j.client.core.Component::getJsObj()();
	...
	public native Container findParentBy(ContainerTraversalCallback cb)/*-{
		...
		var container = component
				.findParentBy(function(container) {
					var containerJ = @com.ati.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(container);
					return cb.@com.ati.ext4j.client.core.ContainerTraversalCallback::execute(Lcom/ati/ext4j/client/ui/Container;)(containerJ);
				});
		return container == null || container === undefined ? null
				: @com.ati.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(container);
	}-*/;
	...
	public native Component alignTo(String element)/*-{
		var elem = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
	...
	public native void hide(ExtElement animateTarget) /*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		component.hide(animateTarget
				.@com.ati.ext4j.client.core.JsObject::getJsObj());
	}-*/;

	public native void hide(Component animateTarget) /*-{
		var component = this
				.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		component.hide(animateTarget
				.@com.ati.ext4j.client.core.Component::getOrCreateJsObj());
	}-*/;
	...
	public native ComponentPosition getLocalXY()/*-{
		...
		return @com.ati.ext4j.client.core.ComponentPosition::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
	}-*/;
	...
	public native void setPosition(double left, double right,
		...
		component
				.setPosition(
						left,
						right,
						animation.@com.ati.ext4j.client.fx.anim.Animation::getJsObj()());
	}-*/;
	 ...
	 * @param cls
	 *            the CSS class
	 * @see com.ati.ext4j.client.core.Component#setCls(String)
	 */
	 ...
	 * @param cls
	 *            the CSS class
	 * @see com.ati.ext4j.client.core.Component#addCls(String)
	 */
	 ...
	 * @param cls
	 *            the CSS class
	 * @see com.ati.ext4j.client.core.Component#removeCls(String)
	 */
	...
	public native LoadMask setLoading(String message) /*-{
		...
		return @com.ati.ext4j.client.ui.LoadMask::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
	}-*/;
	...
	public final native void update(boolean loadScript)/*-{
		var comp = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
	...
	public static native void disableShadow(ExtElement el)/*-{
		var element = el.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		...
		if (component) {
			component
					.addListener(
							event,
							$entry(function(c) {
								var comp = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								handler.@com.ati.ext4j.client.events.component.EventHandler::onEvent(Lcom/ati/ext4j/client/core/Component;)(comp);
							}));
		}
		...
		if (component) {
			component
					.addListener(
							...
							$entry(function(c) {
								var comp = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								return handler.@com.ati.ext4j.client.events.component.LifeCycleHandler::onEvent(Lcom/ati/ext4j/client/core/Component;)(comp);
							}));
		}
		...
		if (component) {
			component
					.addListener(
							...
							$entry(function(c, e) {
								var comp = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								var eventObject = @com.ati.ext4j.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
								handler.@com.ati.ext4j.client.events.component.VisualStateChangeHandler::onEvent(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/EventObject;)(comp,eventObject);
							}));
		}
	...
	private native void setDockedRendered(String dock) /*-{
		var c = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
	...
	public native HandlerRegistration addActivateHandler(ActivateHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var activateEvent = @com.ati.ext4j.client.events.component.ActivateEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.ActivateHandler::onActivate(Lcom/ati/ext4j/client/events/component/ActivateEvent;)(activateEvent);
		};
		var eventName = @com.ati.ext4j.client.events.component.ActivateEvent::EVENT_NAME;
	...
	public native HandlerRegistration addAddedHandler(
			com.ati.ext4j.client.events.component.AddedHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, cont, pos, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var container = @com.ati.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cont);
			var event = @com.ati.ext4j.client.events.component.AddedEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(component,container,pos,event);
			handler.@com.ati.ext4j.client.events.component.AddedHandler::onAdded(Lcom/ati/ext4j/client/events/component/AddedEvent;)(addedEvent);
		};
		var eventName = @com.ati.ext4j.client.events.component.AddedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addAfterRenderHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.AfterRenderEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.AfterRenderHandler::onAfterRender(Lcom/ati/ext4j/client/events/component/AfterRenderEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.AfterRenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeActivateHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeActivateEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeActivateHandler::onBeforeActivate(Lcom/ati/ext4j/client/events/component/BeforeActivateEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeActivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeDeactivateHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeDeactivateEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeDeactivateHandler::onBeforeDeactivate(Lcom/ati/ext4j/client/events/component/BeforeDeactivateEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeDeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeDestroyHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeDestroyEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeDestroyHandler::onBeforeDestroy(Lcom/ati/ext4j/client/events/component/BeforeDestroyEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeDestroyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeHideHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeHideEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeHideHandler::onBeforeHide(Lcom/ati/ext4j/client/events/component/BeforeHideEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeRenderHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeRenderEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeRenderHandler::onBeforeRender(Lcom/ati/ext4j/client/events/component/BeforeRenderEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeRenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeShowHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BeforeShowEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BeforeShowHandler::onBeforeShow(Lcom/ati/ext4j/client/events/component/BeforeShowEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeStateRestoreHandler(
		...
		var fn = function(c, st, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ati.ext4j.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ati.ext4j.client.events.component.BeforeStateRestoreEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e);
			handler.@com.ati.ext4j.client.events.component.BeforeStateRestoreHandler::onBeforeStateRestore(Lcom/ati/ext4j/client/events/component/BeforeStateRestoreEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeStateRestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBeforeStateSaveHandler(
		...
		var fn = function(c, st, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ati.ext4j.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ati.ext4j.client.events.component.BeforeStateSaveEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e);
			handler.@com.ati.ext4j.client.events.component.BeforeStateSaveHandler::onBeforeStateSave(Lcom/ati/ext4j/client/events/component/BeforeStateSaveEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BeforeStateSaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBlurHandler(BlurHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BlurEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.BlurHandler::onBlur(Lcom/ati/ext4j/client/events/component/BlurEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BlurEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addBoxReadyHandler(
			com.ati.ext4j.client.events.component.BoxReadyHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, w, h, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.BoxReadyEvent::new(Lcom/ati/ext4j/client/core/Component;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,h,w,e);
			handler.@com.ati.ext4j.client.events.component.BoxReadyHandler::onBoxReady(Lcom/ati/ext4j/client/events/component/BoxReadyEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.BoxReadyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addDeactivateHandler(
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.DeactivateEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.DeactivateHandler::onDeactivate(Lcom/ati/ext4j/client/events/component/DeactivateEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.DeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addDestroyHandler(DestroyHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.DestroyEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.DestroyHandler::onDestroy(Lcom/ati/ext4j/client/events/component/DestroyEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.DestroyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addDisableHandler(DisableHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.DisableEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.DisableHandler::onDisable(Lcom/ati/ext4j/client/events/component/DisableEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.DisableEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addEnableHandler(EnableHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.EnableEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.EnableHandler::onEnable(Lcom/ati/ext4j/client/events/component/EnableEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.EnableEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addFocusHandler(FocusHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.FocusEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.FocusHandler::onFocus(Lcom/ati/ext4j/client/events/component/FocusEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.FocusEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addHideHandler(HideHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.HideEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ati.ext4j.client.events.component.HideHandler::onHide(Lcom/ati/ext4j/client/events/component/HideEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.HideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addMoveHandler(MoveHandler handler)/*-{
		...
		var fn = function(c, x, y, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.MoveEvent::new(Lcom/ati/ext4j/client/core/Component;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,x,y,e);
			handler.@com.ati.ext4j.client.events.component.MoveHandler::onMove(Lcom/ati/ext4j/client/events/component/MoveEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.MoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addRemovedHandler(RemovedHandler handler)/*-{
		...
		var fn = function(c, ct, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var container = @com.ati.ext4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var event = @com.ati.ext4j.client.events.component.RemovedEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(compoent,container,e);
			handler.@com.ati.ext4j.client.events.component.RemovedHandler::onRemoved(Lcom/ati/ext4j/client/events/component/RemovedEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.RemovedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addRenderHandler(RenderHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.RenderEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.RenderHandler::onRender(Lcom/ati/ext4j/client/events/component/RenderEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.RenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addShowHandler(ShowHandler handler)/*-{
		...
		var fn = function(c, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.ShowEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ati.ext4j.client.events.component.ShowHandler::onShow(Lcom/ati/ext4j/client/events/component/ShowEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.ShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addResizeHandler(ResizeHandler handler)/*-{
		...
		var fn = function(c, w, h, ow, oh, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.component.ResizeEvent::new(Lcom/ati/ext4j/client/core/Component;DDDDLcom/google/gwt/core/client/JavaScriptObject;)(component,w,h,ow,oh,e);
			handler.@com.ati.ext4j.client.events.component.ResizeHandler::onResize(Lcom/ati/ext4j/client/events/component/ResizeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.ResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addStateRestoreHandler(
		...
		var fn = function(c, st, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ati.ext4j.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ati.ext4j.client.events.component.StateRestoreEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e);
			handler.@com.ati.ext4j.client.events.component.StateRestoreHandler::onStateRestore(Lcom/ati/ext4j/client/events/component/StateRestoreEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.StateRestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addStateSaveHandler(
		...
		var fn = function(c, st, e) {
			var component = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ati.ext4j.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ati.ext4j.client.events.component.StateSaveEvent::new(Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e);
			handler.@com.ati.ext4j.client.events.component.StateSaveHandler::onStateSave(Lcom/ati/ext4j/client/events/component/StateSaveEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.component.StateSaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
