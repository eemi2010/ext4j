...
public abstract class JsObject {
    ...
    public native String[] getProperties() /*-{
		var jsObj = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		return @com.ati.ext4j.client.core.JsoHelper::getProperties(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
    }-*/;
