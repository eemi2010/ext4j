...
public class CompositeElement extends JsObject {
    ...
    public native CompositeElement add(String selector) /*-{
		var ce = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		ce.add(selector);
		return this;
    }-*/;
    ...
    public native void contains(ExtElement element) /*-{
		var ce = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var elJS = element.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native CompositeElement replaceElement(int index, ExtElement replacement) /*-{
		var ce = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var replacementJS = replacement.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    public native ExtElement item(int index)/*-{
		...
		return obj ? @com.ati.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj)
				: null;
    }-*/;
}
