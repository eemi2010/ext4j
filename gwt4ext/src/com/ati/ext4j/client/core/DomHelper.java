...
public class DomHelper {
	...
	public static native ExtElement append(ExtElement parent, String rawHtml)/*-{
		var obj = $wnd.Ext.DomHelper.append(
				parent.@com.ati.ext4j.client.core.JsObject::getJsObj()(),
				rawHtml, true);
		return @com.ati.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
	}-*/;
	...
	public static native ExtElement append(ExtElement parent, ExtElement child)/*-{
		var obj = $wnd.Ext.DomHelper.append(
				parent.@com.ati.ext4j.client.core.JsObject::getJsObj()(),
				child.@com.ati.ext4j.client.core.JsObject::getJsObj()(), true);
		return @com.ati.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
	}-*/;
	...
	public static native Template createTemplate(DomConfig config) /*-{
		...
		return @com.ati.ext4j.client.core.Template::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(tpl);
	}-*/;
