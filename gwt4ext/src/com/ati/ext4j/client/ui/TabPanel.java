...
import com.ati.ext4j.client.events.tab.BeforeTabChangeHandler;
import com.ati.ext4j.client.events.tab.TabPanelBeforeTabChangeHandler;
import com.ati.ext4j.client.tab.TabBar;
...
public class TabPanel extends Panel {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.TabPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native TabBar getTabBar() /*-{
		var tabPanel = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var tab = tabPanel.getTabBar();
		if (!tab) {
			return null;
		}
		return @com.ati.ext4j.client.tab.TabBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tab);
    ...
    public native HandlerRegistration addTabChangeHandler(com.ati.ext4j.client.events.tab.TabChangeHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(tp, oc, nc, e) {
			var panel = @com.ati.ext4j.client.ui.TabPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tp);
			var oldCard = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oc);
			var newCard = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(nc);
			var event = @com.ati.ext4j.client.events.tab.TabChangeEvent::new(Lcom/ati/ext4j/client/ui/TabPanel;Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,oldCard,newCard,e);
			handler.@com.ati.ext4j.client.events.tab.TabChangeHandler::onTabChange(Lcom/ati/ext4j/client/events/tab/TabChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.tab.TabChangeEvent::EVENT_NAME;
    ...
    public native void addBeforeTabChangeHandler(TabPanelBeforeTabChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ati.ext4j.client.events.Event::TAB_CHANGE,
							$entry(function(p, newCard, oldCard) {
								var oldComp = null;
								var tabPanel = @com.ati.ext4j.client.ui.TabPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								var newComp = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(newCard);
								if (oldCard) {
									oldComp = @com.ati.ext4j.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(oldCard);
								}
								return handler.@com.ati.ext4j.client.events.tab.TabPanelBeforeTabChangeHandler::onEvent(Lcom/ati/ext4j/client/ui/TabPanel;Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/Component;)(tabPanel,newComp,oldComp);
							}));
		}
    ...
    public native HandlerRegistration addBeforeTabChangeHandler(BeforeTabChangeHandler handler)/*-{
		...
		var fn = function(tp, oc, nc, e) {
			...
			var oldCard = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oc);
			var newCard = @com.ati.ext4j.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(nc);
			var event = @com.ati.ext4j.client.events.tab.BeforeTabChangeEvent::new(Lcom/ati/ext4j/client/ui/TabPanel;Lcom/ati/ext4j/client/core/Component;Lcom/ati/ext4j/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,oldCard,newCard,e);
			handler.@com.ati.ext4j.client.events.tab.BeforeTabChangeHandler::onBeforeTabChange(Lcom/ati/ext4j/client/events/tab/BeforeTabChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.tab.BeforeTabChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
