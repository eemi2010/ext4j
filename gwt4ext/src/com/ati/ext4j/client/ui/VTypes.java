 ...
 * extended.
 * 
 * @see com.ati.ext4j.client.ui.TextField#setVtype(VTypes)
 */
public class VTypes {
    ...
    public static native void setAlphaMask(RegExp alphaMask)/*-{
		var re = alphaMask.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    public static native void setAlphanumMask(RegExp alphanumMask)/*-{
		var re = alphanumMask.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    public static native void setEmailMask(RegExp emailMask)/*-{
		var re = emailMask.@com.ati.ext4j.client.core.JsObject::getJsObj()();
