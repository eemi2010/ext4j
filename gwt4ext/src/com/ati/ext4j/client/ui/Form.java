...
import com.ati.ext4j.client.events.form.SubmitHandler;
...
public class Form extends JsObject {
    ...
    public native void checkDirty() /*-{
		var form = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		form.checkDirty();
    }-*/;
    ...
    public native FieldBase findField(String id)/*-{
		...
		return fieldJS != null ? @com.ati.ext4j.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(fieldJS)
				: null;
    }-*/;
    ...
    public native void loadRecord(BaseModel record) /*-{
		var form = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var recordJS = record.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    private native JavaScriptObject _getSubmitCallback(SubmitHandler handler)/*-{
		return {
			success : function(f, a) {
				var form = @com.ati.ext4j.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ati.ext4j.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ati.ext4j.client.events.form.SubmitHandler::onSuccess(Lcom/ati/ext4j/client/ui/Form;Lcom/ati/ext4j/client/form/Action;)(form,action);
			},
			failure : function(f, a) {
				var form = @com.ati.ext4j.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ati.ext4j.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ati.ext4j.client.events.form.SubmitHandler::onFailure(Lcom/ati/ext4j/client/ui/Form;Lcom/ati/ext4j/client/form/Action;)(form,action);
			}
		};
    }-*/;
