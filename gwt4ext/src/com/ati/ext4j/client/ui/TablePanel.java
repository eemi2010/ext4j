...
import com.ati.ext4j.client.events.grid.BeforeActionHandler;
import com.ati.ext4j.client.events.grid.BeforeCellClickEvent;
import com.ati.ext4j.client.events.grid.BeforeCellClickHandler;
import com.ati.ext4j.client.events.grid.BeforeCellContextMenuEvent;
import com.ati.ext4j.client.events.grid.BeforeCellContextMenuHandler;
import com.ati.ext4j.client.events.grid.BeforeCellDoubleClickEvent;
import com.ati.ext4j.client.events.grid.BeforeCellDoubleClickHandler;
import com.ati.ext4j.client.events.grid.BeforeCellKeyDownEvent;
import com.ati.ext4j.client.events.grid.BeforeCellKeyDownHandler;
import com.ati.ext4j.client.events.grid.BeforeCellMouseDownEvent;
import com.ati.ext4j.client.events.grid.BeforeCellMouseDownHandler;
import com.ati.ext4j.client.events.grid.BeforeCellMouseUpEvent;
import com.ati.ext4j.client.events.grid.BeforeCellMouseUpHandler;
...
import com.ati.ext4j.client.events.grid.CellClickHandler;
import com.ati.ext4j.client.events.grid.CellContextMenuHandler;
import com.ati.ext4j.client.events.grid.CellDoubleClickHandler;
import com.ati.ext4j.client.events.grid.CellKeyDownHandler;
import com.ati.ext4j.client.events.grid.CellMouseDownHandler;
import com.ati.ext4j.client.events.grid.CellMouseUpHandler;
import com.ati.ext4j.client.events.grid.ColumnHideHandler;
import com.ati.ext4j.client.events.grid.ColumnMoveHandler;
import com.ati.ext4j.client.events.grid.ColumnResizeHandler;
import com.ati.ext4j.client.events.grid.ColumnShowHandler;
import com.ati.ext4j.client.events.grid.ColumnsChangedHandler;
...
import com.ati.ext4j.client.events.grid.FilterChangeHandler;
import com.ati.ext4j.client.events.grid.GroupChangeHandler;
import com.ati.ext4j.client.events.grid.HeaderClickHandler;
import com.ati.ext4j.client.events.grid.HeaderContextMenuHandler;
import com.ati.ext4j.client.events.grid.HeaderTriggerClickHandler;
import com.ati.ext4j.client.events.grid.SelectHandler;
import com.ati.ext4j.client.events.grid.SelectionChangeHandler;
import com.ati.ext4j.client.events.grid.SortChangeHandler;
import com.ati.ext4j.client.events.grid.ViewReadyHandler;
...
import com.ati.ext4j.client.grid.VerticalScroller;
import com.ati.ext4j.client.grid.ViewConfig;
import com.ati.ext4j.client.grid.column.GridColumn;
import com.ati.ext4j.client.grid.feature.Feature;
import com.ati.ext4j.client.laf.Scroll;
...
public class TablePanel extends Panel {
    ...
    private native Store _getStore()/*-{
		var grid = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var obj = grid.getStore();
		var store = @com.ati.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return store;
    }-*/;
    ...
    public native HeaderContainer getHeaderContainer()/*-{
		...
		return @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native TableView getView()/*-{
		...
		return @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addBeforeCellClickHandler(BeforeCellClickHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellClickEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellClickHandler::onBeforeCellClick(Lcom/ati/ext4j/client/events/grid/BeforeCellClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellClickEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addBeforeCellContextMenuHandler(BeforeCellContextMenuHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellContextMenuEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellContextMenuHandler::onBeforeCellContextMenu(Lcom/ati/ext4j/client/events/grid/BeforeCellContextMenuEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCellDoubleClickHandler(BeforeCellDoubleClickHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellDoubleClickEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellDoubleClickHandler::onBeforeCellDoubleClick(Lcom/ati/ext4j/client/events/grid/BeforeCellDoubleClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCellKeyDownHandler(BeforeCellKeyDownHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellKeyDownEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellKeyDownHandler::onBeforeCellKeyDown(Lcom/ati/ext4j/client/events/grid/BeforeCellKeyDownEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCellMouseDownHandler(BeforeCellMouseDownHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellMouseDownEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellMouseDownHandler::onBeforeCellMouseDown(Lcom/ati/ext4j/client/events/grid/BeforeCellMouseDownEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCellMouseUpHandler(BeforeCellMouseUpHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.BeforeCellMouseUpEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.BeforeCellMouseUpHandler::onBeforeCellMouseUp(Lcom/ati/ext4j/client/events/grid/BeforeCellMouseUpEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.BeforeCellMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellClickHandler(CellClickHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellClickEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellClickHandler::onCellClick(Lcom/ati/ext4j/client/events/grid/CellClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellContextMenuHandler(CellContextMenuHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellContextMenuEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellContextMenuHandler::onCellContextMenu(Lcom/ati/ext4j/client/events/grid/CellContextMenuEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellDoubleClickHandler(CellDoubleClickHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellDoubleClickEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellDoubleClickHandler::onCellDoubleClick(Lcom/ati/ext4j/client/events/grid/CellDoubleClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellDoubleClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellKeyDownHandler(CellKeyDownHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellKeyDownEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellKeyDownHandler::onCellKeyDown(Lcom/ati/ext4j/client/events/grid/CellKeyDownEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellKeyDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellMouseUpHandler(CellMouseUpHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellMouseUpEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellMouseUpHandler::onCellMouseUp(Lcom/ati/ext4j/client/events/grid/CellMouseUpEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellMouseUpEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addCellMouseDownHandler(CellMouseDownHandler handler)/*-{
		...
		var fn = function(t, td, cellIndex, rec, tr, rowIndex, e) {
			var cmp = @com.ati.ext4j.client.ui.TableView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var record = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var event = @com.ati.ext4j.client.events.grid.CellMouseDownEvent::new(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/google/gwt/core/client/JavaScriptObject;)(cpm,tr, cellIndex, record, tr, rowIndex,e);
			handler.@com.ati.ext4j.client.events.grid.CellMouseDownHandler::onCellMouseDown(Lcom/ati/ext4j/client/events/grid/CellMouseDownEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.CellMouseDownEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnHideHandler(ColumnHideHandler handler)/*-{
		...
		var fn = function(ct, c, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.grid.ColumnHideEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,e);
			handler.@com.ati.ext4j.client.events.grid.ColumnHideHandler::onColumnHide(Lcom/ati/ext4j/client/events/grid/ColumnHideEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ColumnHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnMoveHandler(ColumnMoveHandler handler)/*-{
		...
		var fn = function(ct, c, fromIndex, toIndex, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.grid.ColumnMoveEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;IILcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,fromIndex, toIndex,e);
			handler.@com.ati.ext4j.client.events.grid.ColumnMoveHandler::onColumnMove(Lcom/ati/ext4j/client/events/grid/ColumnMoveEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ColumnMoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnResizeHandler(ColumnResizeHandler handler)/*-{
		...
		var fn = function(ct, c, width, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.grid.ColumnResizeEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;DLcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,width,e);
			handler.@com.ati.ext4j.client.events.grid.ColumnResizeHandler::onColumnResize(Lcom/ati/ext4j/client/events/grid/ColumnResizeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ColumnResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnsChangedHandler(ColumnsChangedHandler handler)/*-{
		...
		var fn = function(ct, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var event = @com.ati.ext4j.client.events.grid.ColumnsChangedEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,e);
			handler.@com.ati.ext4j.client.events.grid.ColumnsChangedHandler::onColumnsChanged(Lcom/ati/ext4j/client/events/grid/ColumnsChangedEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ColumnsChangedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addColumnShowHandler(ColumnShowHandler handler)/*-{
		...
		var fn = function(ct, c, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.grid.ColumnShowEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,e);
			handler.@com.ati.ext4j.client.events.grid.ColumnShowHandler::onColumnShow(Lcom/ati/ext4j/client/events/grid/ColumnShowEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ColumnShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addFilterChangeHandler(FilterChangeHandler handler)/*-{
		...
		var fn = function(st, f, e) {
			var store = @com.ati.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var filters = @com.ati.ext4j.client.util.Filter::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.grid.FilterChangeEvent::new(Lcom/ati/ext4j/client/data/Store;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(store,filters,e);
			handler.@com.ati.ext4j.client.events.grid.FilterChangeHandler::onFilterChange(Lcom/ati/ext4j/client/events/grid/FilterChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.FilterChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addGroupChangeHandler(GroupChangeHandler handler)/*-{
		...
		var fn = function(st, f, e) {
			var store = @com.ati.ext4j.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var groupers = @com.ati.ext4j.client.util.Grouper::fromJsArray(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ati.ext4j.client.events.grid.GroupChangeEvent::new(Lcom/ati/ext4j/client/data/Store;Ljava/util/List;Lcom/google/gwt/core/client/JavaScriptObject;)(store,filters,e);
			handler.@com.ati.ext4j.client.events.grid.GroupChangeHandler::onGroupChange(Lcom/ati/ext4j/client/events/grid/GroupChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.GroupChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
		...
		component
				.addListener(
						...
						$entry(function(t, td, cellIndex, rec, tr, rowIndex, e) {
							...
							return handler.@com.ati.ext4j.client.events.grid.BeforeActionHandler::onAction(Lcom/ati/ext4j/client/ui/TableView;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/data/BaseModel;Lcom/google/gwt/dom/client/Element;ILcom/ati/ext4j/client/core/EventObject;)(cpm,tr, cellIndex, record, tr, rowIndex,event);
						}));
    }-*/;
    ...
    public native HandlerRegistration addHeaderClickHandler(HeaderClickHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ati.ext4j.client.events.grid.HeaderClickEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ati.ext4j.client.events.grid.HeaderClickHandler::onHeaderClick(Lcom/ati/ext4j/client/events/grid/HeaderClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.HeaderClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHeaderContextMenuHandler(HeaderContextMenuHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ati.ext4j.client.events.grid.HeaderContextMenuEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ati.ext4j.client.events.grid.HeaderContextMenuHandler::onHeaderContextMenu(Lcom/ati/ext4j/client/events/grid/HeaderContextMenuEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.HeaderContextMenuEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addHeaderTriggerClickHandler(HeaderTriggerClickHandler handler)/*-{
		...
		var fn = function(ct, col, e, t) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var column = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(col);
			var event = @com.ati.ext4j.client.events.grid.HeaderTriggerClickEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt, column, t, e);
			handler.@com.ati.ext4j.client.events.grid.HeaderTriggerClickHandler::onHeaderTriggerClick(Lcom/ati/ext4j/client/events/grid/HeaderTriggerClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.HeaderTriggerClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addSortChangeHandler(SortChangeHandler handler)/*-{
		...
		var fn = function(ct, c, direction, e) {
			var headerCt = @com.ati.ext4j.client.grid.HeaderContainer::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var col = @com.ati.ext4j.client.grid.column.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ati.ext4j.client.events.grid.SortChangeEvent::new(Lcom/ati/ext4j/client/grid/HeaderContainer;Lcom/ati/ext4j/client/grid/column/GridColumn;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(headerCt,col,direction,e);
			handler.@com.ati.ext4j.client.events.grid.SortChangeHandler::onSortChange(Lcom/ati/ext4j/client/events/grid/SortChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.SortChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addViewReadyHandler(ViewReadyHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var panel = @com.ati.ext4j.client.ui.TablePanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ati.ext4j.client.events.grid.ViewReadyEvent::new(Lcom/ati/ext4j/client/ui/TablePanel;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,e);
			handler.@com.ati.ext4j.client.events.grid.ViewReadyHandler::onViewReady(Lcom/ati/ext4j/client/events/grid/ViewReadyEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.grid.ViewReadyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
