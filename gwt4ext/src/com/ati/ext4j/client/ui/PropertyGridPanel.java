...
import com.ati.ext4j.client.grid.plugin.AbstractViewPlugin;
...
public class PropertyGridPanel extends GridPanel {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.PropertyGridPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    protected native JavaScriptObject create(JavaScriptObject config) /*-{
		var dd = this.@com.ati.ext4j.client.ui.GridPanel::dd;
		if (dd) {
			var peer = dd.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    private native void _setSource(BaseModel source)/*-{
		var jso = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		jso
				.setSource(source.@com.ati.ext4j.client.core.JsObject::getJsObj()());
    }-*/;
