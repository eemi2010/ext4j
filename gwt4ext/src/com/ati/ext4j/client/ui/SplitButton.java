...
import com.ati.ext4j.client.events.button.ArrowClickHandler;
...
public class SplitButton extends Button {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.SplitButton::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void setArrowHandler(Function callBack) /*-{
		var splitButton = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addArrowClickHandler(ArrowClickHandler handler)/*-{
		...
		var fn = function(b, e) {
			var button = @com.ati.ext4j.client.ui.SplitButton::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ati.ext4j.client.events.button.ArrowClickEvent::new(Lcom/ati/ext4j/client/ui/SplitButton;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.ati.ext4j.client.events.button.ArrowClickHandler::onArrowClick(Lcom/ati/ext4j/client/events/button/ArrowClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.button.ArrowClickEvent::EVENT_NAME;
