...
import com.ati.ext4j.client.events.toolbar.BeforeChangeHandler;
import com.ati.ext4j.client.events.toolbar.ChangeHandler;
import com.ati.ext4j.client.events.toolbar.PagingToolbarBeforeChangeHandler;
...
public class PagingToolbar extends ToolBar {
    ...
    public native void updateInfo() /*-{
		var pagingToolbar = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(t, d, e) {
			var pt = @com.ati.ext4j.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var data = @com.ati.ext4j.client.toolbar.PageData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(d);
			var event = @com.ati.ext4j.client.events.toolbar.ChangeEvent::new(Lcom/ati/ext4j/client/ui/PagingToolbar;Lcom/ati/ext4j/client/toolbar/PageData;Lcom/google/gwt/core/client/JavaScriptObject;)(pt,data,e);
			handler.@com.ati.ext4j.client.events.toolbar.ChangeHandler::onChange(Lcom/ati/ext4j/client/events/toolbar/ChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.toolbar.ChangeEvent::EVENT_NAME;
			...
			component
					.addListener(
							...
							$entry(function(p, page) {
								var pt = @com.ati.ext4j.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								handler.@com.ati.ext4j.client.events.toolbar.PagingToolbarBeforeChangeHandler::onEvent(Lcom/ati/ext4j/client/ui/PagingToolbar;I)(pt,index);
							}));
		}
    ...
    public native HandlerRegistration addBeforeChangeHandler(BeforeChangeHandler handler)/*-{
		...
		var fn = function(t, page, e) {
			var pt = @com.ati.ext4j.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ati.ext4j.client.events.toolbar.BeforeChangeEvent::new(Lcom/ati/ext4j/client/ui/PagingToolbar;DLcom/google/gwt/core/client/JavaScriptObject;)(pt,page,e);
			handler.@com.ati.ext4j.client.events.toolbar.BeforeChangeHandler::onBeforeChange(Lcom/ati/ext4j/client/events/toolbar/BeforeChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.toolbar.BeforeChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
