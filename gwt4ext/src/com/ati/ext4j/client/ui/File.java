...
public class File extends TriggerField {
    ...
    private static native void init()/*-{
		...
		@com.ati.ext4j.client.ui.File::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native ExtElement getFileInputEl() /*-{
		...
		return @com.ati.ext4j.client.core.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
    }-*/;
    ...
    public native Button getButton() /*-{
		var field = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var el = field.button;
		return @com.ati.ext4j.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
    }-*/;
    ...
    public native HandlerRegistration addFileChangeHandler(
                    com.ati.ext4j.client.events.form.FileChangeHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(f, value, e) {
			var file = @com.ati.ext4j.client.ui.File::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ati.ext4j.client.events.form.FileChangeEvent::new(Lcom/ati/ext4j/client/ui/File;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(file,value,e);
			handler.@com.ati.ext4j.client.events.form.FileChangeHandler::onFileChange(Lcom/ati/ext4j/client/events/form/FileChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.FileChangeEvent::EVENT_NAME;
