...
import com.ati.ext4j.client.events.menu.SelectHandler;
...
public class MenuColorPicker extends Menu {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.MenuColorPicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native ColorPicker getPicker() /*-{
		...
		return @com.ati.ext4j.client.ui.ColorPicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(m, c, e) {
			...
			var event = @com.ati.ext4j.client.events.menu.SelectEvent::new(Lcom/ati/ext4j/client/ui/Menu;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,color,e);
			handler.@com.ati.ext4j.client.events.menu.SelectHandler::onSelect(Lcom/ati/ext4j/client/events/menu/SelectEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.menu.SelectEvent::EVENT_NAME;
