...
import com.ati.ext4j.client.events.panel.ToolClickHandler;
import com.ati.ext4j.client.events.panel.ToolHandler;
...
public class Tool extends Component {
    ...
    public native HandlerRegistration addToolClickHandler(ToolClickHandler handler)/*-{
		...
		var fn = function(t, e) {
			var tool = @com.ati.ext4j.client.ui.Tool::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ati.ext4j.client.events.panel.ToolClickEvent::new(Lcom/ati/ext4j/client/ui/Tool;Lcom/google/gwt/core/client/JavaScriptObject;)(tool,e);
			handler.@com.ati.ext4j.client.events.panel.ToolClickHandler::onToolClick(Lcom/ati/ext4j/client/events/panel/ToolClickEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.panel.ToolClickEvent::EVENT_NAME;
