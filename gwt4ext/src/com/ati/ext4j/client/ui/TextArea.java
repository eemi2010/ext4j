...
public class TextArea extends TextField {
    ...
    private static native void init()/*-{
		...
		@com.ati.ext4j.client.ui.TextArea::configPrototype = c.initialConfig;
    }-*/;
    ...
    public static TextArea cast(Component component) {
        return new TextArea(component.getOrCreateJsObj());
    }
