...
public class CycleButton extends SplitButton {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.CycleButton::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void toggleSelected() /*-{
		var cycleButton = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
    ...
    public native void setMenu(Menu value) /*-{
		...
		button.menu = value.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
    }-*/;
    ...
    public native MenuItem getActiveItem() /*-{
		...
		return @com.ati.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setActiveItem(MenuItem item) /*-{
		var button = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		button
				.setActiveItem(item.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()());
    }-*/;
     ...
     */
    public native HandlerRegistration addChangeHandler(com.ati.ext4j.client.events.button.ChangeHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(b, m, e) {
			var button = @com.ati.ext4j.client.ui.CycleButton::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menuItem = @com.ati.ext4j.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ati.ext4j.client.events.button.ChangeEvent::new(Lcom/ati/ext4j/client/ui/CycleButton;Lcom/ati/ext4j/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(button, menuItem, e);
			handler.@com.ati.ext4j.client.events.button.ChangeHandler::onChange(Lcom/ati/ext4j/client/events/button/ChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.button.ChangeEvent::EVENT_NAME;
