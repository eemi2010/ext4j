...
import com.ati.ext4j.client.events.view.NodeDragOverHandler;
...
public class TreeView extends TableView {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.TreeView::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addNodeDragOverHandler(NodeDragOverHandler handler)/*-{
		...
		var fn = function(n, position, data, e) {
			var node = @com.ati.ext4j.client.data.NodeInterface::new(Lcom/google/gwt/core/client/JavaScriptObject;)(n);
			var event = @com.ati.ext4j.client.events.view.NodeDragOverEvent::new(Lcom/ati/ext4j/client/data/NodeInterface;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;)(node, position,data,e);
			handler.@com.ati.ext4j.client.events.view.NodeDragOverHandler::onNodeDragOver(Lcom/ati/ext4j/client/events/view/NodeDragOverEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.view.NodeDragOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
