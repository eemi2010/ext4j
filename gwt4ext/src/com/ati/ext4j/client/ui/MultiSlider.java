...
import com.ati.ext4j.client.events.slider.BeforeChangeHandler;
import com.ati.ext4j.client.events.slider.ChangeCompleteHandler;
import com.ati.ext4j.client.events.slider.ChangeHandler;
import com.ati.ext4j.client.events.slider.DragEndHandler;
import com.ati.ext4j.client.events.slider.DragStartHandler;
import com.ati.ext4j.client.events.slider.SliderBeforeChangeHandler;
import com.ati.ext4j.client.field.FieldBase;
import com.ati.ext4j.client.slider.SliderTip;
import com.ati.ext4j.client.slider.Thumb;
import com.ati.ext4j.client.slider.TipTextRenderer;
...
public class MultiSlider extends FieldBase {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.MultiSlider::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addDragStartHandler(DragStartHandler handler)/*-{
		...
		var fn = function(slider, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ati.ext4j.client.events.slider.DragStartEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ati.ext4j.client.events.slider.DragStartHandler::onDragStart(Lcom/ati/ext4j/client/events/slider/DragStartEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.DragStartEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addDragEndHandler(DragEndHandler handler)/*-{
		...
		var fn = function(slider, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ati.ext4j.client.events.slider.DragEndEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ati.ext4j.client.events.slider.DragEndHandler::onDragEnd(Lcom/ati/ext4j/client/events/slider/DragEndEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.DragEndEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDragHandler(com.ati.ext4j.client.events.slider.DragHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(slider, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ati.ext4j.client.events.slider.DragEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ati.ext4j.client.events.slider.DragHandler::onDrag(Lcom/ati/ext4j/client/events/slider/DragEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.DragEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(slider, newValue, t, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var thumb = @com.ati.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.slider.ChangeEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;DLcom/ati/ext4j/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ati.ext4j.client.events.slider.ChangeHandler::onChange(Lcom/ati/ext4j/client/events/slider/ChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addChangeHandler(ChangeCompleteHandler handler)/*-{
		...
		var fn = function(slider, newValue, t, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var thumb = @com.ati.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.slider.ChangeCompleteEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;DLcom/ati/ext4j/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ati.ext4j.client.events.slider.ChangeCompleteHandler::onChangeComplete(Lcom/ati/ext4j/client/events/slider/ChangeCompleteEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.ChangeCompleteEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeChangeHandler(SliderBeforeChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ati.ext4j.client.events.Event::BEFORE_CHANGE,
							$entry(function(m, newValue, oldValue) {
								var mutil = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
								return handler.@com.ati.ext4j.client.events.slider.SliderBeforeChangeHandler::onEvent(Lcom/ati/ext4j/client/ui/MultiSlider;DD)(multi, oldValue, newValue);
							}));
		}
    ...
    public native HandlerRegistration addBeforeChangeHandler(BeforeChangeHandler handler)/*-{
		...
		var fn = function(slider, oldValue, newValue, e) {
			var component = @com.ati.ext4j.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ati.ext4j.client.events.slider.BeforeChangeEvent::new(Lcom/ati/ext4j/client/ui/MultiSlider;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,oldValue,newValue,e);
			handler.@com.ati.ext4j.client.events.slider.BeforeChangeHandler::onBeforeChange(Lcom/ati/ext4j/client/events/slider/BeforeChangeEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.slider.BeforeChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    private native JavaScriptObject _getTipText(TipTextRenderer renderer)/*-{
		return function(t) {
			var thumb = @com.ati.ext4j.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			return renderer.@com.ati.ext4j.client.slider.TipTextRenderer::getValue(Lcom/ati/ext4j/client/slider/Thumb;)(thumb);
		};
    }-*/;
