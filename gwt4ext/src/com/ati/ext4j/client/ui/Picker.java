...
public abstract class Picker extends TriggerField {
    ...
    public native HandlerRegistration addCollapseHandler(
                    com.ati.ext4j.client.events.form.PickerCollapseHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var picker = @com.ati.ext4j.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ati.ext4j.client.events.form.PickerCollapseEvent::new(Lcom/ati/ext4j/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,e);
			handler.@com.ati.ext4j.client.events.form.PickerCollapseHandler::onPickerCollapse(Lcom/ati/ext4j/client/events/form/PickerCollapseEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.PickerCollapseEvent::EVENT_NAME;
     ...
     */
    public native HandlerRegistration addExpandHandler(com.ati.ext4j.client.events.form.PickerExpandHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var picker = @com.ati.ext4j.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ati.ext4j.client.events.form.PickerExpandEvent::new(Lcom/ati/ext4j/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,e);
			handler.@com.ati.ext4j.client.events.form.PickerExpandHandler::onPickerExpand(Lcom/ati/ext4j/client/events/form/PickerExpandEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.PickerExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addFieldSelectHandler(
                    com.ati.ext4j.client.events.form.FieldSelectHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, value, e) {
			var picker = @com.ati.ext4j.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ati.ext4j.client.events.form.FieldSelectEvent::new(Lcom/ati/ext4j/client/field/FieldBase;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,value,e);
			handler.@com.ati.ext4j.client.events.form.FieldSelectHandler::onFieldSelect(Lcom/ati/ext4j/client/events/form/FieldSelectEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.FieldSelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
