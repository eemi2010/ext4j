...
import com.ati.ext4j.client.events.form.BeforeCollapseHandler;
import com.ati.ext4j.client.events.form.BeforeExpandHandler;
import com.ati.ext4j.client.events.form.CollapseHandler;
import com.ati.ext4j.client.events.form.ExpandHandler;
import com.ati.ext4j.client.events.form.FieldSetBeforeCollapseHandler;
import com.ati.ext4j.client.events.form.FieldSetBeforeExpandHandler;
...
public class FieldSet extends Container {
    ...
    private static native void init()/*-{
		...
		@com.ati.ext4j.client.ui.FieldSet::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCollapseHandler(BeforeCollapseHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.form.BeforeCollapseEvent::new(Lcom/ati/ext4j/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ati.ext4j.client.events.form.BeforeCollapseHandler::onBeforeCollapse(Lcom/ati/ext4j/client/events/form/BeforeCollapseEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.BeforeCollapseEvent::EVENT_NAME;
    ...
    public native void addBeforeCollapseHandler(FieldSetBeforeCollapseHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ati.ext4j.client.events.form.BeforeCollapseEvent::EVENT_NAME,
							$entry(function(fs) {
								var fieldSet = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(fs);
								return handler.@com.ati.ext4j.client.events.form.FieldSetBeforeCollapseHandler::onEvent(Lcom/ati/ext4j/client/ui/FieldSet;)(fieldSet);
							}));
		}
    ...
    public native HandlerRegistration addBeforeExpandHandler(BeforeExpandHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.form.BeforeExpandEvent::new(Lcom/ati/ext4j/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ati.ext4j.client.events.form.BeforeExpandHandler::onBeforeExpand(Lcom/ati/ext4j/client/events/form/BeforeExpandEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.BeforeExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeExoandHandler(FieldSetBeforeExpandHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ati.ext4j.client.events.form.BeforeExpandEvent::EVENT_NAME,
							$entry(function(fs) {
								var fieldSet = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(fs);
								return handler.@com.ati.ext4j.client.events.form.FieldSetBeforeExpandHandler::onEvent(Lcom/ati/ext4j/client/ui/FieldSet;)(fieldSet);
							}));
		}
    ...
    public native HandlerRegistration addCollapseHandler(CollapseHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.form.CollapseEvent::new(Lcom/ati/ext4j/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ati.ext4j.client.events.form.CollapseHandler::onCollapse(Lcom/ati/ext4j/client/events/form/CollapseEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.CollapseEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addExpandHandler(ExpandHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ati.ext4j.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ati.ext4j.client.events.form.ExpandEvent::new(Lcom/ati/ext4j/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ati.ext4j.client.events.form.ExpandHandler::onExpand(Lcom/ati/ext4j/client/events/form/ExpandEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.form.ExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ati.ext4j.client.events.HandlerRegistration::new(Lcom/ati/ext4j/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
