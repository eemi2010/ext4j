...
import com.ati.ext4j.client.events.menu.DateSelectHandler;
...
public class MenuDatePicker extends Menu {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.MenuDatePicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native DatePicker getPicker() /*-{
		...
		return @com.ati.ext4j.client.ui.DatePicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addDateSelectHandler(DateSelectHandler handler)/*-{
		...
		var fn = function(m, date, e) {
			...
			var event = @com.ati.ext4j.client.events.menu.DateSelectEvent::new(Lcom/ati/ext4j/client/ui/Menu;Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,date,e);
			handler.@com.ati.ext4j.client.events.menu.DateSelectHandler::onDateSelect(Lcom/ati/ext4j/client/events/menu/DateSelectEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.menu.DateSelectEvent::EVENT_NAME;
