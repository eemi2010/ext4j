...
import com.ati.ext4j.client.core.config.WaitConfig;
...
public class ProgressBar extends Component {
    ...
    private native void init()/*-{
		...
		@com.ati.ext4j.client.ui.ProgressBar::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native boolean isWaiting() /*-{
		var progressBar = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
     ...
     */
    public native HandlerRegistration addUpdateHandler(com.ati.ext4j.client.events.progressbar.UpdateHandler handler)/*-{
		var component = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, value, text, e) {
			var pgr = @com.ati.ext4j.client.ui.ProgressBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ati.ext4j.client.events.progressbar.UpdateEvent::new(Lcom/ati/ext4j/client/ui/ProgressBar;DLjava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(pgr,value,text,e);
			handler.@com.ati.ext4j.client.events.progressbar.UpdateHandler::onUpdate(Lcom/ati/ext4j/client/events/progressbar/UpdateEvent;)(event);
		};
		var eventName = @com.ati.ext4j.client.events.progressbar.UpdateEvent::EVENT_NAME;
