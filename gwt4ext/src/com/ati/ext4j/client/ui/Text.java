...
public class Text extends DrawComponent {
    ...
    public native void setText(String value)/*-{
		var text = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
		text.setText(value);
    }-*/;
    ...
    public static Text cast(Component component) {
        return new Text(component.getOrCreateJsObj());
    }
