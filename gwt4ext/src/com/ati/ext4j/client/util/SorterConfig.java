...
public class SorterConfig extends BaseConfig {
    ...
    public native void setSorterFn(SorterFunction fn)/*-{
		...
		f.filterFn = $entry(function(item1, item2) {
			var model1 = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(item1);
			var model2 = @com.ati.ext4j.client.data.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(item2);
			return fn.@com.ati.ext4j.client.util.SorterFunction::onSort(Lcom/ati/ext4j/client/data/BaseModel;Lcom/ati/ext4j/client/data/BaseModel;)(model1,model2);
		});
    }-*/;
