...
public class ClickRepeater extends JsObject {
    ...
    public native void addListener(ClickRepeaterListener listener)/*-{
		var cr = this.@com.ati.ext4j.client.core.JsObject::getJsObj()();
		var crJ = this;
		...
		cr
				.addListener(
						'click',
						function(source) {
							listener.@com.ati.ext4j.client.util.ClickRepeaterListener::onClick(Lcom/ati/ext4j/client/util/ClickRepeater;)(crJ);
						});
		...
		cr
				.addListener(
						'mousedown',
						function(source) {
							listener.@com.ati.ext4j.client.util.ClickRepeaterListener::onMouseDown(Lcom/ati/ext4j/client/util/ClickRepeater;)(crJ);
						});
		...
		cr
				.addListener(
						'mouseup',
						function(source) {
							listener.@com.ati.ext4j.client.util.ClickRepeaterListener::onMouseUp(Lcom/ati/ext4j/client/util/ClickRepeater;)(crJ);
						});
    }-*/;
}
